...
public abstract class TLReGenWorldgenStructure extends TLRGMasterResourceGenerator implements DataProvider {
	private final CompletableFuture<HolderLookup.Provider> damageTypes = lookupProvider.thenApply(r -> constructRegistries(r, new TLReGenRegistrySetBuilder().add(Registries.STRUCTURE, TLWorldgenStructureGenerator::bootstrap)));
