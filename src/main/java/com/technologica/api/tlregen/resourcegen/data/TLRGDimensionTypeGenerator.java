...
public abstract class TLRGDimensionTypeGenerator extends DatapackBuiltinEntriesProvider {
	public TLRGDimensionTypeGenerator() {
		super(TLRGMasterResourceGenerator.packOutput, TLRGMasterResourceGenerator.lookupProvider, TLRGMasterResourceGenerator.registrySetBuilder.add(Registries.DIMENSION_TYPE, TLDimensionTypeGenerator::bootstrap), Set.of(Technologica.MOD_ID));
	}

	@Override
	public String getName() {
		return "data." + Technologica.MOD_ID + ".dimension_type";
	}
