...
public abstract class TLReGenWorldgenConfiguredFeature extends TLRGMasterResourceGenerator implements DataProvider {
	private final CompletableFuture<HolderLookup.Provider> damageTypes = lookupProvider.thenApply(r -> constructRegistries(r, new TLReGenRegistrySetBuilder().add(Registries.CONFIGURED_FEATURE, (TLReGenRegistrySetBuilder.RegistryBootstrap) TLWorldgenConfiguredFeatureGenerator::bootstrap)));
