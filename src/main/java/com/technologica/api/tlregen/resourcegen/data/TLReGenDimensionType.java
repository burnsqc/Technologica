...
public abstract class TLReGenDimensionType extends TLRGMasterResourceGenerator implements DataProvider {
	private final CompletableFuture<HolderLookup.Provider> damageTypes = lookupProvider.thenApply(r -> constructRegistries(r, new TLReGenRegistrySetBuilder().add(Registries.DIMENSION_TYPE, TLDimensionTypes::bootstrap)));
