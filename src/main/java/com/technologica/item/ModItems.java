...
public class ModItems {
    ...
    public static final RegistryObject<Item> BANANA_LOG_ITEM = ITEMS.register("banana_log", () -> new BlockItem(ModBlocks.BANANA_LOG.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> CHERRY_LOG_ITEM = ITEMS.register("cherry_log", () -> new BlockItem(ModBlocks.CHERRY_LOG.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> COCONUT_LOG_ITEM = ITEMS.register("coconut_log", () -> new BlockItem(ModBlocks.COCONUT_LOG.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> KIWI_LOG_ITEM = ITEMS.register("kiwi_log", () -> new BlockItem(ModBlocks.KIWI_LOG.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> LEMON_LOG_ITEM = ITEMS.register("lemon_log", () -> new BlockItem(ModBlocks.LEMON_LOG.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> LIME_LOG_ITEM = ITEMS.register("lime_log", () -> new BlockItem(ModBlocks.LIME_LOG.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> ORANGE_LOG_ITEM = ITEMS.register("orange_log", () -> new BlockItem(ModBlocks.ORANGE_LOG.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> PEACH_LOG_ITEM = ITEMS.register("peach_log",	() -> new BlockItem(ModBlocks.PEACH_LOG.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> PEAR_LOG_ITEM = ITEMS.register("pear_log", () -> new BlockItem(ModBlocks.PEAR_LOG.get(), new Item.Properties().group(ModItemGroup.FLORA))); 
    ...
    public static final RegistryObject<Item> MALEVOLENT_LOG_ITEM = ITEMS.register("melvolent_log", () -> new BlockItem(ModBlocks.MALEVOLENT_LOG.get(), new Item.Properties().group(ModItemGroup.CRYPTICA)));
    ...
    public static final RegistryObject<Item> BANANA_PLANKS_ITEM = ITEMS.register("banana_planks", () -> new BlockItem(ModBlocks.BANANA_PLANKS.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> CHERRY_PLANKS_ITEM = ITEMS.register("cherry_planks", () -> new BlockItem(ModBlocks.CHERRY_PLANKS.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> COCONUT_PLANKS_ITEM = ITEMS.register("coconut_planks", () -> new BlockItem(ModBlocks.COCONUT_PLANKS.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> KIWI_PLANKS_ITEM = ITEMS.register("kiwi_planks", () -> new BlockItem(ModBlocks.KIWI_PLANKS.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> LEMON_PLANKS_ITEM = ITEMS.register("lemon_planks", () -> new BlockItem(ModBlocks.LEMON_PLANKS.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> LIME_PLANKS_ITEM = ITEMS.register("lime_planks", () -> new BlockItem(ModBlocks.LIME_PLANKS.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> ORANGE_PLANKS_ITEM = ITEMS.register("orange_planks", () -> new BlockItem(ModBlocks.ORANGE_PLANKS.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> PEACH_PLANKS_ITEM = ITEMS.register("peach_planks", () -> new BlockItem(ModBlocks.PEACH_PLANKS.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> PEAR_PLANKS_ITEM = ITEMS.register("pear_planks", () -> new BlockItem(ModBlocks.PEAR_PLANKS.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    
    public static final RegistryObject<Item> BANANA_SLAB_ITEM = ITEMS.register("banana_slab", () -> new BlockItem(ModBlocks.BANANA_SLAB.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> CHERRY_SLAB_ITEM = ITEMS.register("cherry_slab", () -> new BlockItem(ModBlocks.CHERRY_SLAB.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> COCONUT_SLAB_ITEM = ITEMS.register("coconut_slab", () -> new BlockItem(ModBlocks.COCONUT_SLAB.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> KIWI_SLAB_ITEM = ITEMS.register("kiwi_slab", () -> new BlockItem(ModBlocks.KIWI_SLAB.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> LEMON_SLAB_ITEM = ITEMS.register("lemon_slab", () -> new BlockItem(ModBlocks.LEMON_SLAB.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> LIME_SLAB_ITEM = ITEMS.register("lime_slab", () -> new BlockItem(ModBlocks.LIME_SLAB.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> ORANGE_SLAB_ITEM = ITEMS.register("orange_slab", () -> new BlockItem(ModBlocks.ORANGE_SLAB.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> PEACH_SLAB_ITEM = ITEMS.register("peach_slab", () -> new BlockItem(ModBlocks.PEACH_SLAB.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> PEAR_SLAB_ITEM = ITEMS.register("pear_slab", () -> new BlockItem(ModBlocks.PEAR_SLAB.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    
    public static final RegistryObject<Item> BANANA_STAIRS_ITEM = ITEMS.register("banana_stairs", () -> new BlockItem(ModBlocks.BANANA_STAIRS.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> CHERRY_STAIRS_ITEM = ITEMS.register("cherry_stairs", () -> new BlockItem(ModBlocks.CHERRY_STAIRS.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> COCONUT_STAIRS_ITEM = ITEMS.register("coconut_stairs", () -> new BlockItem(ModBlocks.COCONUT_STAIRS.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> KIWI_STAIRS_ITEM = ITEMS.register("kiwi_stairs", () -> new BlockItem(ModBlocks.KIWI_STAIRS.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> LEMON_STAIRS_ITEM = ITEMS.register("lemon_stairs", () -> new BlockItem(ModBlocks.LEMON_STAIRS.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> LIME_STAIRS_ITEM = ITEMS.register("lime_stairs", () -> new BlockItem(ModBlocks.LIME_STAIRS.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> ORANGE_STAIRS_ITEM = ITEMS.register("orange_stairs", () -> new BlockItem(ModBlocks.ORANGE_STAIRS.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> PEACH_STAIRS_ITEM = ITEMS.register("peach_stairs", () -> new BlockItem(ModBlocks.PEACH_STAIRS.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> PEAR_STAIRS_ITEM = ITEMS.register("pear_stairs", () -> new BlockItem(ModBlocks.PEAR_STAIRS.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    
    public static final RegistryObject<Item> BANANA_BOOKSHELF_ITEM = ITEMS.register("banana_bookshelf", () -> new BlockItem(ModBlocks.BANANA_BOOKSHELF.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> CHERRY_BOOKSHELF_ITEM = ITEMS.register("cherry_bookshelf", () -> new BlockItem(ModBlocks.CHERRY_BOOKSHELF.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> COCONUT_BOOKSHELF_ITEM = ITEMS.register("coconut_bookshelf", () -> new BlockItem(ModBlocks.COCONUT_BOOKSHELF.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> KIWI_BOOKSHELF_ITEM = ITEMS.register("kiwi_bookshelf", () -> new BlockItem(ModBlocks.KIWI_BOOKSHELF.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> LEMON_BOOKSHELF_ITEM = ITEMS.register("lemon_bookshelf", () -> new BlockItem(ModBlocks.LEMON_BOOKSHELF.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> LIME_BOOKSHELF_ITEM = ITEMS.register("lime_bookshelf", () -> new BlockItem(ModBlocks.LIME_BOOKSHELF.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> ORANGE_BOOKSHELF_ITEM = ITEMS.register("orange_bookshelf", () -> new BlockItem(ModBlocks.ORANGE_BOOKSHELF.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> PEACH_BOOKSHELF_ITEM = ITEMS.register("peach_bookshelf",	() -> new BlockItem(ModBlocks.PEACH_BOOKSHELF.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> PEAR_BOOKSHELF_ITEM = ITEMS.register("pear_bookshelf", () -> new BlockItem(ModBlocks.PEAR_BOOKSHELF.get(), new Item.Properties().group(ModItemGroup.FLORA))); 
    
    public static final RegistryObject<Item> BANANA_TRAPDOOR_ITEM = ITEMS.register("banana_trapdoor", () -> new BlockItem(ModBlocks.BANANA_TRAPDOOR.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> CHERRY_TRAPDOOR_ITEM = ITEMS.register("cherry_trapdoor", () -> new BlockItem(ModBlocks.CHERRY_TRAPDOOR.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> COCONUT_TRAPDOOR_ITEM = ITEMS.register("coconut_trapdoor", () -> new BlockItem(ModBlocks.COCONUT_TRAPDOOR.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> KIWI_TRAPDOOR_ITEM = ITEMS.register("kiwi_trapdoor", () -> new BlockItem(ModBlocks.KIWI_TRAPDOOR.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> LEMON_TRAPDOOR_ITEM = ITEMS.register("lemon_trapdoor", () -> new BlockItem(ModBlocks.LEMON_TRAPDOOR.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> LIME_TRAPDOOR_ITEM = ITEMS.register("lime_trapdoor", () -> new BlockItem(ModBlocks.LIME_TRAPDOOR.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> ORANGE_TRAPDOOR_ITEM = ITEMS.register("orange_trapdoor", () -> new BlockItem(ModBlocks.ORANGE_TRAPDOOR.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> PEACH_TRAPDOOR_ITEM = ITEMS.register("peach_trapdoor", () -> new BlockItem(ModBlocks.PEACH_TRAPDOOR.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> PEAR_TRAPDOOR_ITEM = ITEMS.register("pear_trapdoor", () -> new BlockItem(ModBlocks.PEAR_TRAPDOOR.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    
    public static final RegistryObject<Item> BANANA_DOOR_ITEM = ITEMS.register("banana_door", () -> new BlockItem(ModBlocks.BANANA_DOOR.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> CHERRY_DOOR_ITEM = ITEMS.register("cherry_door", () -> new BlockItem(ModBlocks.CHERRY_DOOR.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> COCONUT_DOOR_ITEM = ITEMS.register("coconut_door", () -> new BlockItem(ModBlocks.COCONUT_DOOR.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> KIWI_DOOR_ITEM = ITEMS.register("kiwi_door", () -> new BlockItem(ModBlocks.KIWI_DOOR.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> LEMON_DOOR_ITEM = ITEMS.register("lemon_door", () -> new BlockItem(ModBlocks.LEMON_DOOR.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> LIME_DOOR_ITEM = ITEMS.register("lime_door", () -> new BlockItem(ModBlocks.LIME_DOOR.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> ORANGE_DOOR_ITEM = ITEMS.register("orange_door", () -> new BlockItem(ModBlocks.ORANGE_DOOR.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> PEACH_DOOR_ITEM = ITEMS.register("peach_door", () -> new BlockItem(ModBlocks.PEACH_DOOR.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> PEAR_DOOR_ITEM = ITEMS.register("pear_door", () -> new BlockItem(ModBlocks.PEAR_DOOR.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    
    public static final RegistryObject<Item> BANANA_FENCE_ITEM = ITEMS.register("banana_fence", () -> new BlockItem(ModBlocks.BANANA_FENCE.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> CHERRY_FENCE_ITEM = ITEMS.register("cherry_fence", () -> new BlockItem(ModBlocks.CHERRY_FENCE.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> COCONUT_FENCE_ITEM = ITEMS.register("coconut_fence", () -> new BlockItem(ModBlocks.COCONUT_FENCE.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> KIWI_FENCE_ITEM = ITEMS.register("kiwi_fence", () -> new BlockItem(ModBlocks.KIWI_FENCE.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> LEMON_FENCE_ITEM = ITEMS.register("lemon_fence", () -> new BlockItem(ModBlocks.LEMON_FENCE.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> LIME_FENCE_ITEM = ITEMS.register("lime_fence", () -> new BlockItem(ModBlocks.LIME_FENCE.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> ORANGE_FENCE_ITEM = ITEMS.register("orange_fence", () -> new BlockItem(ModBlocks.ORANGE_FENCE.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> PEACH_FENCE_ITEM = ITEMS.register("peach_fence", () -> new BlockItem(ModBlocks.PEACH_FENCE.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> PEAR_FENCE_ITEM = ITEMS.register("pear_fence", () -> new BlockItem(ModBlocks.PEAR_FENCE.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    
    public static final RegistryObject<Item> BANANA_FENCE_GATE_ITEM = ITEMS.register("banana_fence_gate", () -> new BlockItem(ModBlocks.BANANA_FENCE_GATE.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> CHERRY_FENCE_GATE_ITEM = ITEMS.register("cherry_fence_gate", () -> new BlockItem(ModBlocks.CHERRY_FENCE_GATE.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> COCONUT_FENCE_GATE_ITEM = ITEMS.register("coconut_fence_gate", () -> new BlockItem(ModBlocks.COCONUT_FENCE_GATE.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> KIWI_FENCE_GATE_ITEM = ITEMS.register("kiwi_fence_gate", () -> new BlockItem(ModBlocks.KIWI_FENCE_GATE.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> LEMON_FENCE_GATE_ITEM = ITEMS.register("lemon_fence_gate", () -> new BlockItem(ModBlocks.LEMON_FENCE_GATE.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> LIME_FENCE_GATE_ITEM = ITEMS.register("lime_fence_gate", () -> new BlockItem(ModBlocks.LIME_FENCE_GATE.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> ORANGE_FENCE_GATE_ITEM = ITEMS.register("orange_fence_gate", () -> new BlockItem(ModBlocks.ORANGE_FENCE_GATE.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> PEACH_FENCE_GATE_ITEM = ITEMS.register("peach_fence_gate", () -> new BlockItem(ModBlocks.PEACH_FENCE_GATE.get(), new Item.Properties().group(ModItemGroup.FLORA)));
    public static final RegistryObject<Item> PEAR_FENCE_GATE_ITEM = ITEMS.register("pear_fence_gate", () -> new BlockItem(ModBlocks.PEAR_FENCE_GATE.get(), new Item.Properties().group(ModItemGroup.FLORA)));
