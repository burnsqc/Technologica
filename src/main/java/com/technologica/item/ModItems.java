...
//    public static final RegistryObject<Item> OGANESSON_INGOT = ITEMS.register("oganesson_ingot", () -> new Item(new Item.Properties().group(ModItemGroup.MINERAL)));
    ...
    public static final RegistryObject<Item> APRICOT_SIGN_ITEM = ITEMS.register("apricot_sign", () -> new BlockItem(ModBlocks.APRICOT_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
    public static final RegistryObject<Item> ASPEN_SIGN_ITEM = ITEMS.register("aspen_sign", () -> new BlockItem(ModBlocks.ASPEN_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
    public static final RegistryObject<Item> AVOCADO_SIGN_ITEM = ITEMS.register("avocado_sign", () -> new BlockItem(ModBlocks.AVOCADO_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
    public static final RegistryObject<Item> BANANA_SIGN_ITEM = ITEMS.register("banana_sign", () -> new BlockItem(ModBlocks.BANANA_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
    public static final RegistryObject<Item> CHERRY_SIGN_ITEM = ITEMS.register("cherry_sign", () -> new BlockItem(ModBlocks.CHERRY_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
    public static final RegistryObject<Item> CHESTNUT_SIGN_ITEM = ITEMS.register("chestnut_sign", () -> new BlockItem(ModBlocks.CHESTNUT_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
    public static final RegistryObject<Item> COCONUT_SIGN_ITEM = ITEMS.register("coconut_sign", () -> new BlockItem(ModBlocks.COCONUT_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
    public static final RegistryObject<Item> EBONY_SIGN_ITEM = ITEMS.register("ebony_sign", () -> new BlockItem(ModBlocks.EBONY_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
    public static final RegistryObject<Item> KIWI_SIGN_ITEM = ITEMS.register("kiwi_sign", () -> new BlockItem(ModBlocks.KIWI_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
    public static final RegistryObject<Item> LEMON_SIGN_ITEM = ITEMS.register("lemon_sign", () -> new BlockItem(ModBlocks.LEMON_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
    public static final RegistryObject<Item> LIME_SIGN_ITEM = ITEMS.register("lime_sign", () -> new BlockItem(ModBlocks.LIME_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
    public static final RegistryObject<Item> MAHOGANY_SIGN_ITEM = ITEMS.register("mahogany_sign", () -> new BlockItem(ModBlocks.MAHOGANY_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
    public static final RegistryObject<Item> MAPLE_SIGN_ITEM = ITEMS.register("maple_sign", () -> new BlockItem(ModBlocks.MAPLE_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
    public static final RegistryObject<Item> ORANGE_SIGN_ITEM = ITEMS.register("orange_sign", () -> new BlockItem(ModBlocks.ORANGE_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
    public static final RegistryObject<Item> PEACH_SIGN_ITEM = ITEMS.register("peach_sign", () -> new BlockItem(ModBlocks.PEACH_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
    public static final RegistryObject<Item> PEAR_SIGN_ITEM = ITEMS.register("pear_sign", () -> new BlockItem(ModBlocks.PEAR_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
    public static final RegistryObject<Item> PLUM_SIGN_ITEM = ITEMS.register("plum_sign", () -> new BlockItem(ModBlocks.PLUM_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
    public static final RegistryObject<Item> REDWOOD_SIGN_ITEM = ITEMS.register("redwood_sign", () -> new BlockItem(ModBlocks.REDWOOD_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
    public static final RegistryObject<Item> ROSEWOOD_SIGN_ITEM = ITEMS.register("rosewood_sign", () -> new BlockItem(ModBlocks.ROSEWOOD_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
    public static final RegistryObject<Item> RUBBER_SIGN_ITEM = ITEMS.register("rubber_sign", () -> new BlockItem(ModBlocks.RUBBER_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
    public static final RegistryObject<Item> TEAK_SIGN_ITEM = ITEMS.register("teak_sign", () -> new BlockItem(ModBlocks.TEAK_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
    public static final RegistryObject<Item> WALNUT_SIGN_ITEM = ITEMS.register("walnut_sign", () -> new BlockItem(ModBlocks.WALNUT_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
    public static final RegistryObject<Item> ZEBRAWOOD_SIGN_ITEM = ITEMS.register("zebrawood_sign", () -> new BlockItem(ModBlocks.ZEBRAWOOD_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
    public static final RegistryObject<Item> ALCHEMICAL_SIGN_ITEM = ITEMS.register("alchemical_sign", () -> new BlockItem(ModBlocks.ALCHEMICAL_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
    public static final RegistryObject<Item> BENEVOLENT_SIGN_ITEM = ITEMS.register("benevolent_sign", () -> new BlockItem(ModBlocks.BENEVOLENT_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
    public static final RegistryObject<Item> CONDUCTIVE_SIGN_ITEM = ITEMS.register("conductive_sign", () -> new BlockItem(ModBlocks.CONDUCTIVE_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
    public static final RegistryObject<Item> FROSTBITTEN_SIGN_ITEM = ITEMS.register("frostbitten_sign", () -> new BlockItem(ModBlocks.FROSTBITTEN_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
    public static final RegistryObject<Item> FRUITFUL_SIGN_ITEM = ITEMS.register("fruitful_sign", () -> new BlockItem(ModBlocks.FRUITFUL_SIGN.get(), new Item.Properties().group(ModItemGroup.CONSTRUCTION)));
