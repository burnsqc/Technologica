...
public class ModRecipeProvider extends RecipeProvider {
	...
	protected void registerRecipes(Consumer<IFinishedRecipe> consumer) {
		...
		ShapelessRecipeBuilder.shapelessRecipe(ModItems.BLACKBERRY_SEEDS.get(), 2).addIngredient(ModItems.BLACKBERRY.get()).addCriterion("has_blackberry", hasItem(ModItems.BLACKBERRY.get())).build(consumer, "blackberry_seeds_from_blackberry");
		...
		ShapelessRecipeBuilder.shapelessRecipe(ModItems.RASPBERRY_SEEDS.get(), 2).addIngredient(ModItems.RASPBERRY.get()).addCriterion("has_raspberry", hasItem(ModItems.RASPBERRY.get())).build(consumer, "raspberry_seeds_from_raspberry");
