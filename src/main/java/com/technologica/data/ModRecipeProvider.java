...
public class ModRecipeProvider extends RecipeProvider {
	...
	protected void registerRecipes(Consumer<IFinishedRecipe> consumer) {
		...
		ShapedRecipeBuilder.shapedRecipe(TechnologicaItems.PRIMITIVE_SHOVEL.get()).key('T', Items.STICK).key('F', Items.FLINT).key('S', Items.STRING).patternLine(" F ").patternLine(" TS").patternLine(" T ").addCriterion("has_flint", hasItem(Items.FLINT)).build(consumer, new ResourceLocation(Technologica.MODID, "primitive_shovel"));
		ShapedRecipeBuilder.shapedRecipe(TechnologicaItems.PRIMITIVE_PICKAXE.get()).key('T', Items.STICK).key('F', Items.FLINT).key('S', Items.STRING).patternLine("FFF").patternLine(" TS").patternLine(" T ").addCriterion("has_flint", hasItem(Items.FLINT)).build(consumer, new ResourceLocation(Technologica.MODID, "primitive_pickaxe"));
		ShapedRecipeBuilder.shapedRecipe(TechnologicaItems.PRIMITIVE_HATCHET.get()).key('T', Items.STICK).key('F', Items.FLINT).key('S', Items.STRING).patternLine("FF ").patternLine("FTS").patternLine(" T ").addCriterion("has_flint", hasItem(Items.FLINT)).build(consumer, new ResourceLocation(Technologica.MODID, "primitive_hatchet"));
		ShapedRecipeBuilder.shapedRecipe(TechnologicaItems.PRIMITIVE_HOE.get()).key('T', Items.STICK).key('F', Items.FLINT).key('S', Items.STRING).patternLine("FF ").patternLine(" TS").patternLine(" T ").addCriterion("has_flint", hasItem(Items.FLINT)).build(consumer, new ResourceLocation(Technologica.MODID, "primitive_hoe"));
		ShapedRecipeBuilder.shapedRecipe(TechnologicaItems.PRIMITIVE_DAGGER.get()).key('T', Items.STICK).key('F', Items.FLINT).key('S', Items.STRING).patternLine("F ").patternLine("FS").patternLine("T ").addCriterion("has_flint", hasItem(Items.FLINT)).build(consumer, new ResourceLocation(Technologica.MODID, "primitive_dagger"));
