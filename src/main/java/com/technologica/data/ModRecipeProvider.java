...
public class ModRecipeProvider extends RecipeProvider {
	...
	protected void registerRecipes(Consumer<IFinishedRecipe> consumer) {
		...
		ShapelessRecipeBuilder.shapelessRecipe(TechnologicaItems.TAPENADE.get(), 1).addIngredient(TechnologicaItems.OLIVE.get()).addIngredient(TechnologicaItems.GARLIC.get()).addCriterion("has_olive", hasItem(TechnologicaItems.OLIVE.get())).build(consumer, "tapenade_from_olive");
		ShapelessRecipeBuilder.shapelessRecipe(TechnologicaItems.CINNAMON_ROLL.get(), 1).addIngredient(TechnologicaItems.CINNAMON.get()).addIngredient(Items.EGG).addIngredient(Items.SUGAR).addIngredient(Items.MILK_BUCKET).addCriterion("has_cinnamon", hasItem(TechnologicaItems.CINNAMON.get())).build(consumer, "cinnamon_roll_from_cinnamon");
