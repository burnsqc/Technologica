...
public class TechnologicaBiomes {
	public static void bootstrap(BootstapContext<Biome> p_256344_) {
		...
		p_256344_.register(com.technologica.world.level.biome.TechnologicaBiomes.SILENT_EXPANSE, MoonBiomes.silentExpanse(holdergetter, holdergetter1, false));
		p_256344_.register(com.technologica.world.level.biome.TechnologicaBiomes.CRATER_FIELDS, MoonBiomes.silentExpanse(holdergetter, holdergetter1, false));
	}
}