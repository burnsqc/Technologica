...
public class TechnologicaVegetationPlacements {
	...
	public static final PlacedFeature TREES_MODIFIED_JUNGLE_EDGE = PlacementUtils.register("trees_teak", TechnologicaVegetationFeatures.TREES_MODIFIED_JUNGLE_EDGE.placed(VegetationPlacements.treePlacement(PlacementUtils.countExtra(0, 0.1F, 1))));
	public static final PlacedFeature TREES_MODIFIED_BAMBOO_JUNGLE = PlacementUtils.register("trees_bamboo_jungle", TechnologicaVegetationFeatures.TREES_MODIFIED_BAMBOO_JUNGLE.placed(VegetationPlacements.treePlacement(PlacementUtils.countExtra(50, 0.1F, 1))));
	...
	public static final PlacedFeature TREES_MODIFIED_WOODED_HILLS = PlacementUtils.register("trees_aspen", TechnologicaVegetationFeatures.TREES_MODIFIED_WOODED_HILLS.placed(VegetationPlacements.treePlacement(PlacementUtils.countExtra(0, 0.1F, 1))));
	...
	public static final PlacedFeature TREES_MODIFIED_SNOWY_TAIGA = PlacementUtils.register("trees_snowy_taiga", TechnologicaVegetationFeatures.TREES_MODIFIED_SNOWY_TAIGA.placed(VegetationPlacements.treePlacement(PlacementUtils.countExtra(0, 0.1F, 1))));
