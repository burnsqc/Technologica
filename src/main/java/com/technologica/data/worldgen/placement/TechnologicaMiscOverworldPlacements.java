...
public class TechnologicaMiscOverworldPlacements {
	public static final PlacedFeature BRINE_POOL = PlacementUtils.register("brine_pool", TechnologicaMiscOverworldFeatures.BRINE_POOL.placed(CountPlacement.of(25), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(192)), BiomeFilter.biome()));
