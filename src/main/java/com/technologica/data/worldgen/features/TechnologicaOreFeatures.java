...
public class TechnologicaOreFeatures {
	...
	public static void register() {
		ORE_SPODUMENE = register("ore_spodumene", TechnologicaFeature.AQUAMARINE_DECORATED_ORE.get(), new OreConfiguration(ORE_SPODUMENE_TARGET_LIST, 17));
		ORE_BORAX = register("ore_borax", TechnologicaFeature.ULEXITE_DECORATED_ORE.get(), new OreConfiguration(ORE_BORAX_TARGET_LIST, 17));
		ORE_MAGNESITE = register("ore_magnesite", TechnologicaFeature.DOLOMITE_DECORATED_ORE.get(), new OreConfiguration(ORE_MAGNESITE_TARGET_LIST, 17));
		ORE_BAUXITE = register("ore_bauxite", TechnologicaFeature.VANADANITE_DECORATED_ORE.get(), new OreConfiguration(ORE_BAUXITE_TARGET_LIST, 17));
		ORE_APATITE = register("ore_apatite", TechnologicaFeature.FLUORITE_DECORATED_ORE.get(), new OreConfiguration(ORE_APATITE_TARGET_LIST, 17));
		ORE_PHOSPHORITE = register("ore_phosphorite", TechnologicaFeature.SPHALERITE_DECORATED_ORE.get(), new OreConfiguration(ORE_PHOSPHORITE_TARGET_LIST, 17));
		ORE_GADOLINITE = register("ore_gadolinite", TechnologicaFeature.FLUORITE_DECORATED_ORE.get(), new OreConfiguration(ORE_GADOLINITE_TARGET_LIST, 17));
		ORE_ILMENITE = register("ore_ilmenite", TechnologicaFeature.VANADANITE_DECORATED_ORE.get(), new OreConfiguration(ORE_ILMENITE_TARGET_LIST, 17));
		ORE_CHROMITE = register("ore_chromite", TechnologicaFeature.SPHALERITE_DECORATED_ORE.get(), new OreConfiguration(ORE_CHROMITE_TARGET_LIST, 17));
		ORE_PYROLUSITE = register("ore_pyrolusite", TechnologicaFeature.SPHALERITE_DECORATED_ORE.get(), new OreConfiguration(ORE_PYROLUSITE_TARGET_LIST, 17));
		ORE_COBALTITE = register("ore_cobaltite", TechnologicaFeature.AQUAMARINE_DECORATED_ORE.get(), new OreConfiguration(ORE_COBALTITE_TARGET_LIST, 17));
		ORE_GARNIERITE = register("ore_garnierite", TechnologicaFeature.DOLOMITE_DECORATED_ORE.get(), new OreConfiguration(ORE_GARNIERITE_TARGET_LIST, 17));
		ORE_PATRONITE = register("ore_patronite", TechnologicaFeature.VANADANITE_DECORATED_ORE.get(), new OreConfiguration(ORE_PATRONITE_TARGET_LIST, 17));
	}
