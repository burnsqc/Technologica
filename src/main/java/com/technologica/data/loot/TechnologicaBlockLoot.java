...
public class TechnologicaBlockLoot extends BlockLoot {
	...
	protected void addTables() {
		...
		add(TechnologicaBlocks.RICE.get(), createCropDrops(TechnologicaBlocks.RICE.get(), TechnologicaItems.RICE.get(), TechnologicaBlocks.RICE.get().asItem(), LootItemBlockStatePropertyCondition.hasBlockStateProperties(TechnologicaBlocks.RICE.get()).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(CropBlock.AGE, 7))));
