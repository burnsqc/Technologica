...
public class TechnologicaBlockLoot extends BlockLoot {
	...
	protected void addTables() {
		...
		add(TechnologicaBlocks.BLACKBERRY_BUSH.get(), createCropDrops(TechnologicaBlocks.BLACKBERRY_BUSH.get(), TechnologicaItems.BLACKBERRY.get(), TechnologicaBlocks.BLACKBERRY_BUSH.get().asItem(), LootItemBlockStatePropertyCondition.hasBlockStateProperties(TechnologicaBlocks.BLACKBERRY_BUSH.get()).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(CropBlock.AGE, 7))));
		add(TechnologicaBlocks.BLUEBERRY_BUSH.get(), createCropDrops(TechnologicaBlocks.BLUEBERRY_BUSH.get(), TechnologicaItems.BLUEBERRY.get(), TechnologicaBlocks.BLUEBERRY_BUSH.get().asItem(), LootItemBlockStatePropertyCondition.hasBlockStateProperties(TechnologicaBlocks.BLUEBERRY_BUSH.get()).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(CropBlock.AGE, 7))));
		...
		add(TechnologicaBlocks.RASPBERRY_BUSH.get(), createCropDrops(TechnologicaBlocks.RASPBERRY_BUSH.get(), TechnologicaItems.RASPBERRY.get(), TechnologicaBlocks.RASPBERRY_BUSH.get().asItem(), LootItemBlockStatePropertyCondition.hasBlockStateProperties(TechnologicaBlocks.RASPBERRY_BUSH.get()).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(CropBlock.AGE, 7))));
		...
		add(TechnologicaBlocks.STRAWBERRY_BUSH.get(), createCropDrops(TechnologicaBlocks.STRAWBERRY_BUSH.get(), TechnologicaItems.STRAWBERRY.get(), TechnologicaBlocks.STRAWBERRY_BUSH.get().asItem(), LootItemBlockStatePropertyCondition.hasBlockStateProperties(TechnologicaBlocks.STRAWBERRY_BUSH.get()).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(CropBlock.AGE, 7))));
