...
public class TechnologicaBlockStateProvider extends BlockStateProvider {
	...
	public void sawmillBlockState(Block block) {
		ResourceLocation bottomSides = new ResourceLocation("block/anvil");
		getVariantBuilder(block).partialState().with(BlockStateProperties.BOTTOM, true).modelForState().modelFile(models().cubeAll(name(block) + "bottom", bottomSides)).addModel().partialState().with(BlockStateProperties.HORIZONTAL_FACING, Direction.NORTH).with(BlockStateProperties.BOTTOM, false).with(TechnologicaBlockStateProperties.MIDDLE_END, MiddleEnd.MIDDLE).modelForState().modelFile(models().cubeBottomTop(name(block) + "_top_middle_north", new ResourceLocation(Technologica.MODID, "block/" + ForgeRegistries.BLOCKS.getKey(block).getPath() + "_side1"), bottomSides, new ResourceLocation(Technologica.MODID, "block/" + ForgeRegistries.BLOCKS.getKey(block).getPath() + "_top2"))).rotationY(90).addModel().partialState().with(BlockStateProperties.HORIZONTAL_FACING, Direction.EAST).with(BlockStateProperties.BOTTOM, false).with(TechnologicaBlockStateProperties.MIDDLE_END, MiddleEnd.MIDDLE).modelForState().modelFile(models().cubeBottomTop(name(block) + "top_middle_east", new ResourceLocation(Technologica.MODID, "block/" + ForgeRegistries.BLOCKS.getKey(block).getPath() + "_side1"), bottomSides, new ResourceLocation(Technologica.MODID, "block/" + ForgeRegistries.BLOCKS.getKey(block).getPath() + "_top2"))).rotationY(180).addModel().partialState().with(BlockStateProperties.HORIZONTAL_FACING, Direction.SOUTH).with(BlockStateProperties.BOTTOM, false).with(TechnologicaBlockStateProperties.MIDDLE_END, MiddleEnd.MIDDLE).modelForState().modelFile(models().cubeBottomTop(name(block) + "top_middle_south", new ResourceLocation(Technologica.MODID, "block/" + ForgeRegistries.BLOCKS.getKey(block).getPath() + "_side1"), bottomSides, new ResourceLocation(Technologica.MODID, "block/" + ForgeRegistries.BLOCKS.getKey(block).getPath() + "_top2"))).rotationY(270).addModel().partialState().with(BlockStateProperties.HORIZONTAL_FACING, Direction.WEST).with(BlockStateProperties.BOTTOM, false).with(TechnologicaBlockStateProperties.MIDDLE_END, MiddleEnd.MIDDLE).modelForState().modelFile(models().cubeBottomTop(name(block) + "top_middle_west", new ResourceLocation(Technologica.MODID, "block/" + ForgeRegistries.BLOCKS.getKey(block).getPath() + "_side1"), bottomSides, new ResourceLocation(Technologica.MODID, "block/" + ForgeRegistries.BLOCKS.getKey(block).getPath() + "_top2"))).addModel().partialState().with(BlockStateProperties.HORIZONTAL_FACING, Direction.NORTH).with(BlockStateProperties.BOTTOM, false).with(TechnologicaBlockStateProperties.MIDDLE_END, MiddleEnd.LEFT).modelForState().modelFile(models().cubeBottomTop(name(block) + "top_left_end_north", new ResourceLocation(Technologica.MODID, "block/" + ForgeRegistries.BLOCKS.getKey(block).getPath() + "_side1"), bottomSides, new ResourceLocation(Technologica.MODID, "block/" + ForgeRegistries.BLOCKS.getKey(block).getPath() + "_top3"))).rotationY(90).addModel().partialState().with(BlockStateProperties.HORIZONTAL_FACING, Direction.EAST).with(BlockStateProperties.BOTTOM, false).with(TechnologicaBlockStateProperties.MIDDLE_END, MiddleEnd.LEFT).modelForState().modelFile(models().cubeBottomTop(name(block) + "top_left_end_east", new ResourceLocation(Technologica.MODID, "block/" + ForgeRegistries.BLOCKS.getKey(block).getPath() + "_side1"), bottomSides, new ResourceLocation(Technologica.MODID, "block/" + ForgeRegistries.BLOCKS.getKey(block).getPath() + "_top3"))).rotationY(180).addModel().partialState().with(BlockStateProperties.HORIZONTAL_FACING, Direction.SOUTH).with(BlockStateProperties.BOTTOM, false).with(TechnologicaBlockStateProperties.MIDDLE_END, MiddleEnd.LEFT).modelForState().modelFile(models().cubeBottomTop(name(block) + "top_left_end_south", new ResourceLocation(Technologica.MODID, "block/" + ForgeRegistries.BLOCKS.getKey(block).getPath() + "_side1"), bottomSides, new ResourceLocation(Technologica.MODID, "block/" + ForgeRegistries.BLOCKS.getKey(block).getPath() + "_top1"))).rotationY(270).addModel().partialState().with(BlockStateProperties.HORIZONTAL_FACING, Direction.WEST).with(BlockStateProperties.BOTTOM, false).with(TechnologicaBlockStateProperties.MIDDLE_END, MiddleEnd.LEFT).modelForState().modelFile(models().cubeBottomTop(name(block) + "top_left_end_west", new ResourceLocation(Technologica.MODID, "block/" + ForgeRegistries.BLOCKS.getKey(block).getPath() + "_side1"), bottomSides, new ResourceLocation(Technologica.MODID, "block/" + ForgeRegistries.BLOCKS.getKey(block).getPath() + "_top1"))).addModel().partialState().with(BlockStateProperties.HORIZONTAL_FACING, Direction.NORTH).with(BlockStateProperties.BOTTOM, false).with(TechnologicaBlockStateProperties.MIDDLE_END, MiddleEnd.RIGHT).modelForState().modelFile(models().cubeBottomTop(name(block) + "top_right_end_north", new ResourceLocation(Technologica.MODID, "block/" + ForgeRegistries.BLOCKS.getKey(block).getPath() + "_side1"), bottomSides, new ResourceLocation(Technologica.MODID, "block/" + ForgeRegistries.BLOCKS.getKey(block).getPath() + "_top1"))).rotationY(90).addModel().partialState().with(BlockStateProperties.HORIZONTAL_FACING, Direction.EAST).with(BlockStateProperties.BOTTOM, false).with(TechnologicaBlockStateProperties.MIDDLE_END, MiddleEnd.RIGHT).modelForState().modelFile(models().cubeBottomTop(name(block) + "top_right_end_east", new ResourceLocation(Technologica.MODID, "block/" + ForgeRegistries.BLOCKS.getKey(block).getPath() + "_side1"), bottomSides, new ResourceLocation(Technologica.MODID, "block/" + ForgeRegistries.BLOCKS.getKey(block).getPath() + "_top1"))).rotationY(180).addModel().partialState().with(BlockStateProperties.HORIZONTAL_FACING, Direction.SOUTH).with(BlockStateProperties.BOTTOM, false).with(TechnologicaBlockStateProperties.MIDDLE_END, MiddleEnd.RIGHT).modelForState().modelFile(models().cubeBottomTop(name(block) + "top_right_end_south", new ResourceLocation(Technologica.MODID, "block/" + ForgeRegistries.BLOCKS.getKey(block).getPath() + "_side1"), bottomSides, new ResourceLocation(Technologica.MODID, "block/" + ForgeRegistries.BLOCKS.getKey(block).getPath() + "_top3"))).rotationY(270).addModel().partialState().with(BlockStateProperties.HORIZONTAL_FACING, Direction.WEST).with(BlockStateProperties.BOTTOM, false).with(TechnologicaBlockStateProperties.MIDDLE_END, MiddleEnd.RIGHT).modelForState().modelFile(models().cubeBottomTop(name(block) + "top_right_end_west", new ResourceLocation(Technologica.MODID, "block/" + ForgeRegistries.BLOCKS.getKey(block).getPath() + "_side1"), bottomSides, new ResourceLocation(Technologica.MODID, "block/" + ForgeRegistries.BLOCKS.getKey(block).getPath() + "_top3"))).addModel();

		this.simpleBlockItem(block, models().orientable(ForgeRegistries.BLOCKS.getKey(block).getPath(), bottomSides, bottomSides, bottomSides));
	}
