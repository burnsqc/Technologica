...
//		doorBlock((DoorBlock) TechnologicaBlocks.SERENDIPITOUS_APOTHECARY_DOOR.get(), ResourceLocationHelper.extend(blockTexture(TechnologicaBlocks.SERENDIPITIOUS_APOTHECARY_DOOR.get()), "_bottom"), ResourceLocationHelper.extend(blockTexture(TechnologicaBlocks.SERENDIPITIOUS_APOTHECARY_DOOR.get()), "_top"));
...
//		trapdoorBlock((TrapDoorBlock) TechnologicaBlocks.ANCIENT_AMBROSIA_TRAPDOOR.get(), blockTexture(TechnologicaBlocks.ANCIENT_AMBROSIA_TRAPDOOR.get()), true);
//		trapdoorBlock((TrapDoorBlock) TechnologicaBlocks.CRYOGENIC_SPIRE_TRAPDOOR.get(), blockTexture(TechnologicaBlocks.CRYOGENIC_SPIRE_TRAPDOOR.get()), true);
//		trapdoorBlock((TrapDoorBlock) TechnologicaBlocks.THUNDEROUS_CONDUCTOR_TRAPDOOR.get(), blockTexture(TechnologicaBlocks.THUNDEROUS_CONDUCTOR_TRAPDOOR.get()), true);
//		trapdoorBlock((TrapDoorBlock) TechnologicaBlocks.TOWERING_INFERNO_TRAPDOOR.get(), blockTexture(TechnologicaBlocks.TOWERING_INFERNO_TRAPDOOR.get()), true);
//		trapdoorBlock((TrapDoorBlock) TechnologicaBlocks.SERENDIPITOUS_APOTHECARY_TRAPDOOR.get(), blockTexture(TechnologicaBlocks.SERENDIPITOUS_APOTHECARY_TRAPDOOR.get()), true);
//		trapdoorBlock((TrapDoorBlock) TechnologicaBlocks.BENEVOLENT_APOTHECARY_TRAPDOOR.get(), blockTexture(TechnologicaBlocks.BENEVOLENT_APOTHECARY_TRAPDOOR.get()), true);
//		trapdoorBlock((TrapDoorBlock) TechnologicaBlocks.MALEVOLENT_APOTHECARY_TRAPDOOR.get(), blockTexture(TechnologicaBlocks.MALEVOLENT_APOTHECARY_TRAPDOOR.get()), true);
...
//		pressurePlateBlockState(TechnologicaBlocks.ANCIENT_AMBROSIA_PRESSURE_PLATE.get(), pressurePlateModel(TechnologicaBlocks.ANCIENT_AMBROSIA_PRESSURE_PLATE.get()), pressurePlateDownModel(TechnologicaBlocks.ANCIENT_AMBROSIA_PRESSURE_PLATE.get()));
//		pressurePlateBlockState(TechnologicaBlocks.CRYOGENIC_SPIRE_PRESSURE_PLATE.get(), pressurePlateModel(TechnologicaBlocks.CRYOGENIC_SPIRE_PRESSURE_PLATE.get()), pressurePlateDownModel(TechnologicaBlocks.CRYOGENIC_SPIRE_PRESSURE_PLATE.get()));
//		pressurePlateBlockState(TechnologicaBlocks.THUNDEROUS_CONDUCTOR_PRESSURE_PLATE.get(), pressurePlateModel(TechnologicaBlocks.THUNDEROUS_CONDUCTOR_PRESSURE_PLATE.get()), pressurePlateDownModel(TechnologicaBlocks.THUNDEROUS_CONDUCTOR_PRESSURE_PLATE.get()));
//		pressurePlateBlockState(TechnologicaBlocks.TOWERING_INFERNO_PRESSURE_PLATE.get(), pressurePlateModel(TechnologicaBlocks.TOWERING_INFERNO_PRESSURE_PLATE.get()), pressurePlateDownModel(TechnologicaBlocks.TOWERING_INFERNO_PRESSURE_PLATE.get()));
//		pressurePlateBlockState(TechnologicaBlocks.SERENDIPITOUS_APOTHECARY_PRESSURE_PLATE.get(), pressurePlateModel(TechnologicaBlocks.SERENDIPITOUS_APOTHECARY_PRESSURE_PLATE.get()), pressurePlateDownModel(TechnologicaBlocks.SERENDIPITOUS_APOTHECARY_PRESSURE_PLATE.get()));
//		pressurePlateBlockState(TechnologicaBlocks.BENEVOLENT_APOTHECARY_PRESSURE_PLATE.get(), pressurePlateModel(TechnologicaBlocks.BENEVOLENT_APOTHECARY_PRESSURE_PLATE.get()), pressurePlateDownModel(TechnologicaBlocks.BENEVOLENT_APOTHECARY_PRESSURE_PLATE.get()));
//		pressurePlateBlockState(TechnologicaBlocks.MALEVOLENT_APOTHECARY_PRESSURE_PLATE.get(), pressurePlateModel(TechnologicaBlocks.MALEVOLENT_APOTHECARY_PRESSURE_PLATE.get()), pressurePlateDownModel(TechnologicaBlocks.MALEVOLENT_APOTHECARY_PRESSURE_PLATE.get()));
...
//		buttonBlockState(TechnologicaBlocks.ANCIENT_AMBROSIA_BUTTON.get(), buttonModel(TechnologicaBlocks.ANCIENT_AMBROSIA_BUTTON.get()), buttonPressedModel(TechnologicaBlocks.ANCIENT_AMBROSIA_BUTTON.get()), buttonInventoryModel(TechnologicaBlocks.ANCIENT_AMBROSIA_BUTTON.get()));
//		buttonBlockState(TechnologicaBlocks.CRYOGENIC_SPIRE_BUTTON.get(), buttonModel(TechnologicaBlocks.CRYOGENIC_SPIRE_BUTTON.get()), buttonPressedModel(TechnologicaBlocks.CRYOGENIC_SPIRE_BUTTON.get()), buttonInventoryModel(TechnologicaBlocks.CRYOGENIC_SPIRE_BUTTON.get()));
//		buttonBlockState(TechnologicaBlocks.THUNDEROUS_CONDUCTOR_BUTTON.get(), buttonModel(TechnologicaBlocks.THUNDEROUS_CONDUCTOR_BUTTON.get()), buttonPressedModel(TechnologicaBlocks.THUNDEROUS_CONDUCTOR_BUTTON.get()), buttonInventoryModel(TechnologicaBlocks.THUNDEROUS_CONDUCTOR_BUTTON.get()));
//		buttonBlockState(TechnologicaBlocks.TOWERING_INFERNO_BUTTON.get(), buttonModel(TechnologicaBlocks.TOWERING_INFERNO_BUTTON.get()), buttonPressedModel(TechnologicaBlocks.TOWERING_INFERNO_BUTTON.get()), buttonInventoryModel(TechnologicaBlocks.TOWERING_INFERNO_BUTTON.get()));
//		buttonBlockState(TechnologicaBlocks.SERENDIPITOUS_APOTHECARY_BUTTON.get(), buttonModel(TechnologicaBlocks.SERENDIPITOUS_APOTHECARY_BUTTON.get()), buttonPressedModel(TechnologicaBlocks.SERENDIPITOUS_APOTHECARY_BUTTON.get()), buttonInventoryModel(TechnologicaBlocks.SERENDIPITOUS_APOTHECARY_BUTTON.get()));
//		buttonBlockState(TechnologicaBlocks.BENEVOLENT_APOTHECARY_BUTTON.get(), buttonModel(TechnologicaBlocks.BENEVOLENT_APOTHECARY_BUTTON.get()), buttonPressedModel(TechnologicaBlocks.BENEVOLENT_APOTHECARY_BUTTON.get()), buttonInventoryModel(TechnologicaBlocks.BENEVOLENT_APOTHECARY_BUTTON.get()));
//		buttonBlockState(TechnologicaBlocks.MALEVOLENT_APOTHECARY_BUTTON.get(), buttonModel(TechnologicaBlocks.MALEVOLENT_APOTHECARY_BUTTON.get()), buttonPressedModel(TechnologicaBlocks.MALEVOLENT_APOTHECARY_BUTTON.get()), buttonInventoryModel(TechnologicaBlocks.MALEVOLENT_APOTHECARY_BUTTON.get()));
...
//		simpleBlockItem(TechnologicaBlocks.ANCIENT_AMBROSIA_LEAVES.get(), cubeAll(TechnologicaBlocks.ANCIENT_AMBROSIA_LEAVES.get()));
//		simpleBlockItem(TechnologicaBlocks.CRYOGENIC_SPIRE_LEAVES.get(), cubeAll(TechnologicaBlocks.CRYOGENIC_SPIRE_LEAVES.get()));
//		simpleBlockItem(TechnologicaBlocks.THUNDEROUS_CONDUCTOR_LEAVES.get(), cubeAll(TechnologicaBlocks.THUNDEROUS_CONDUCTOR_LEAVES.get()));
//		simpleBlockItem(TechnologicaBlocks.TOWERING_INFERNO_LEAVES.get(), cubeAll(TechnologicaBlocks.TOWERING_INFERNO_LEAVES.get()));
//		simpleBlockItem(TechnologicaBlocks.SERENDIPITOUS_APOTHECARY_LEAVES.get(), cubeAll(TechnologicaBlocks.SERENDIPITOUS_APOTHECARY_LEAVES.get()));
//		simpleBlockItem(TechnologicaBlocks.BENEVOLENT_APOTHECARY_LEAVES.get(), cubeAll(TechnologicaBlocks.BENEVOLENT_APOTHECARY_LEAVES.get()));
//		simpleBlockItem(TechnologicaBlocks.MALEVOLENT_APOTHECARY_LEAVES.get(), cubeAll(TechnologicaBlocks.MALEVOLENT_APOTHECARY_LEAVES.get()));
//		simpleBlockItem(TechnologicaBlocks.NECROTIC_LEAVES.get(), cubeAll(TechnologicaBlocks.NECROTIC_LEAVES.get()));
...
//		simpleBlockItem(TechnologicaBlocks.ANCIENT_AMBROSIA_LOG.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.ANCIENT_AMBROSIA_LOG.get()), blockTexture(TechnologicaBlocks.ANCIENT_AMBROSIA_LOG.get()), new ResourceLocation(blockTexture(TechnologicaBlocks.ANCIENT_AMBROSIA_LOG.get()) + "_top")));
//		simpleBlockItem(TechnologicaBlocks.CRYOGENIC_SPIRE_LOG.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.CRYOGENIC_SPIRE_LOG.get()), blockTexture(TechnologicaBlocks.CRYOGENIC_SPIRE_LOG.get()), new ResourceLocation(blockTexture(TechnologicaBlocks.CRYOGENIC_SPIRE_LOG.get()) + "_top")));
//		simpleBlockItem(TechnologicaBlocks.THUNDEROUS_CONDUCTOR_LOG.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.THUNDEROUS_CONDUCTOR_LOG.get()), blockTexture(TechnologicaBlocks.THUNDEROUS_CONDUCTOR_LOG.get()), new ResourceLocation(blockTexture(TechnologicaBlocks.THUNDEROUS_CONDUCTOR_LOG.get()) + "_top")));
//		simpleBlockItem(TechnologicaBlocks.TOWERING_INFERNO_LOG.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.TOWERING_INFERNO_LOG.get()), blockTexture(TechnologicaBlocks.TOWERING_INFERNO_LOG.get()), new ResourceLocation(blockTexture(TechnologicaBlocks.TOWERING_INFERNO_LOG.get()) + "_top")));
//		simpleBlockItem(TechnologicaBlocks.SERENDIPITOUS_APOTHECARY_LOG.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.SERENDIPITOUS_APOTHECARY_LOG.get()), blockTexture(TechnologicaBlocks.SERENDIPITOUS_APOTHECARY_LOG.get()), new ResourceLocation(blockTexture(TechnologicaBlocks.SERENDIPITOUS_APOTHECARY_LOG.get()) + "_top")));
//		simpleBlockItem(TechnologicaBlocks.BENEVOLENT_APOTHECARY_LOG.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.BENEVOLENT_APOTHECARY_LOG.get()), blockTexture(TechnologicaBlocks.BENEVOLENT_APOTHECARY_LOG.get()), new ResourceLocation(blockTexture(TechnologicaBlocks.BENEVOLENT_APOTHECARY_LOG.get()) + "_top")));
//		simpleBlockItem(TechnologicaBlocks.MALEVOLENT_APOTHECARY_LOG.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.MALEVOLENT_APOTHECARY_LOG.get()), blockTexture(TechnologicaBlocks.MALEVOLENT_APOTHECARY_LOG.get()), new ResourceLocation(blockTexture(TechnologicaBlocks.MALEVOLENT_APOTHECARY_LOG.get()) + "_top")));
	...
	//	simpleBlockItem(TechnologicaBlocks.STRIPPED_ANCIENT_AMBROSIA_LOG.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.STRIPPED_ANCIENT_AMBROSIA_LOG.get()), blockTexture(TechnologicaBlocks.STRIPPED_ANCIENT_AMBROSIA_LOG.get()), new ResourceLocation(blockTexture(TechnologicaBlocks.STRIPPED_ANCIENT_AMBROSIA_LOG.get()) + "_top")));
	//	simpleBlockItem(TechnologicaBlocks.STRIPPED_CRYOGENIC_SPIRE_LOG.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.STRIPPED_CRYOGENIC_SPIRE_LOG.get()), blockTexture(TechnologicaBlocks.STRIPPED_CRYOGENIC_SPIRE_LOG.get()), new ResourceLocation(blockTexture(TechnologicaBlocks.STRIPPED_CRYOGENIC_SPIRE_LOG.get()) + "_top")));
	//	simpleBlockItem(TechnologicaBlocks.STRIPPED_THUNDEROUS_CONDUCTOR_LOG.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.STRIPPED_THUNDEROUS_CONDUCTOR_LOG.get()), blockTexture(TechnologicaBlocks.STRIPPED_THUNDEROUS_CONDUCTOR_LOG.get()), new ResourceLocation(blockTexture(TechnologicaBlocks.STRIPPED_THUNDEROUS_CONDUCTOR_LOG.get()) + "_top")));
	//	simpleBlockItem(TechnologicaBlocks.STRIPPED_TOWERING_INFERNO_LOG.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.STRIPPED_TOWERING_INFERNO_LOG.get()), blockTexture(TechnologicaBlocks.STRIPPED_TOWERING_INFERNO_LOG.get()), new ResourceLocation(blockTexture(TechnologicaBlocks.STRIPPED_TOWERING_INFERNO_LOG.get()) + "_top")));
	//	simpleBlockItem(TechnologicaBlocks.STRIPPED_SERENDIPITOUS_APOTHECARY_LOG.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.STRIPPED_SERENDIPITOUS_APOTHECARY_LOG.get()), blockTexture(TechnologicaBlocks.STRIPPED_SERENDIPITOUS_APOTHECARY_LOG.get()), new ResourceLocation(blockTexture(TechnologicaBlocks.STRIPPED_SERENDIPITOUS_APOTHECARY_LOG.get()) + "_top")));
	//	simpleBlockItem(TechnologicaBlocks.STRIPPED_BENEVOLENT_APOTHECARY_LOG.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.STRIPPED_BENEVOLENT_APOTHECARY_LOG.get()), blockTexture(TechnologicaBlocks.STRIPPED_BENEVOLENT_APOTHECARY_LOG.get()), new ResourceLocation(blockTexture(TechnologicaBlocks.STRIPPED_BENEVOLENT_APOTHECARY_LOG.get()) + "_top")));
	//	simpleBlockItem(TechnologicaBlocks.STRIPPED_MALEVOLENT_APOTHECARY_LOG.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.STRIPPED_MALEVOLENT_APOTHECARY_LOG.get()), blockTexture(TechnologicaBlocks.STRIPPED_MALEVOLENT_APOTHECARY_LOG.get()), new ResourceLocation(blockTexture(TechnologicaBlocks.STRIPPED_MALEVOLENT_APOTHECARY_LOG.get()) + "_top")));
...
//		simpleBlockItem(TechnologicaBlocks.ANCIENT_AMBROSIA_WOOD.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.ANCIENT_AMBROSIA_WOOD.get()), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.ANCIENT_AMBROSIA_WOOD.get()), "_wood", "_log"), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.ANCIENT_AMBROSIA_WOOD.get()), "_wood", "_log")));
//		simpleBlockItem(TechnologicaBlocks.CRYOGENIC_SPIRE_WOOD.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.CRYOGENIC_SPIRE_WOOD.get()), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.CRYOGENIC_SPIRE_WOOD.get()), "_wood", "_log"), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.CRYOGENIC_SPIRE_WOOD.get()), "_wood", "_log")));
//		simpleBlockItem(TechnologicaBlocks.THUNDEROUS_CONDUCTOR_WOOD.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.THUNDEROUS_CONDUCTOR_WOOD.get()), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.THUNDEROUS_CONDUCTOR_WOOD.get()), "_wood", "_log"), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.THUNDEROUS_CONDUCTOR_WOOD.get()), "_wood", "_log")));
//		simpleBlockItem(TechnologicaBlocks.TOWERING_INFERNO_WOOD.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.TOWERING_INFERNO_WOOD.get()), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.TOWERING_INFERNO_WOOD.get()), "_wood", "_log"), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.TOWERING_INFERNO_WOOD.get()), "_wood", "_log")));
//		simpleBlockItem(TechnologicaBlocks.SERENDIPITOUS_APOTHECARY_WOOD.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.SERENDIPITOUS_APOTHECARY_WOOD.get()), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.SERENDIPITOUS_APOTHECARY_WOOD.get()), "_wood", "_log"), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.SERENDIPITOUS_APOTHECARY_WOOD.get()), "_wood", "_log")));
//		simpleBlockItem(TechnologicaBlocks.BENEVOLENT_APOTHECARY_WOOD.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.BENEVOLENT_APOTHECARY_WOOD.get()), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.BENEVOLENT_APOTHECARY_WOOD.get()), "_wood", "_log"), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.BENEVOLENT_APOTHECARY_WOOD.get()), "_wood", "_log")));
//		simpleBlockItem(TechnologicaBlocks.MALEVOLENT_APOTHECARY_WOOD.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.MALEVOLENT_APOTHECARY_WOOD.get()), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.MALEVOLENT_APOTHECARY_WOOD.get()), "_wood", "_log"), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.MALEVOLENT_APOTHECARY_WOOD.get()), "_wood", "_log")));
	...
	//	simpleBlockItem(TechnologicaBlocks.STRIPPED_ANCIENT_AMBROSIA_WOOD.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.STRIPPED_ANCIENT_AMBROSIA_WOOD.get()), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.STRIPPED_ANCIENT_AMBROSIA_WOOD.get()), "_wood", "_log"), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.STRIPPED_ANCIENT_AMBROSIA_WOOD.get()), "_wood", "_log")));
	//	simpleBlockItem(TechnologicaBlocks.STRIPPED_CRYOGENIC_SPIRE_WOOD.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.STRIPPED_CRYOGENIC_SPIRE_WOOD.get()), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.STRIPPED_CRYOGENIC_SPIRE_WOOD.get()), "_wood", "_log"), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.STRIPPED_CRYOGENIC_SPIRE_WOOD.get()), "_wood", "_log")));
	//	simpleBlockItem(TechnologicaBlocks.STRIPPED_THUNDEROUS_CONDUCTOR_WOOD.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.STRIPPED_THUNDEROUS_CONDUCTOR_WOOD.get()), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.STRIPPED_THUNDEROUS_CONDUCTOR_WOOD.get()), "_wood", "_log"), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.STRIPPED_THUNDEROUS_CONDUCTOR_WOOD.get()), "_wood", "_log")));
	//	simpleBlockItem(TechnologicaBlocks.STRIPPED_TOWERING_INFERNO_WOOD.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.STRIPPED_TOWERING_INFERNO_WOOD.get()), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.STRIPPED_TOWERING_INFERNO_WOOD.get()), "_wood", "_log"), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.STRIPPED_TOWERING_INFERNO_WOOD.get()), "_wood", "_log")));
	//	simpleBlockItem(TechnologicaBlocks.STRIPPED_SERENDIPITOUS_APOTHECARY_WOOD.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.STRIPPED_SERENDIPITOUS_APOTHECARY_WOOD.get()), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.STRIPPED_SERENDIPITOUS_APOTHECARY_WOOD.get()), "_wood", "_log"), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.STRIPPED_SERENDIPITOUS_APOTHECARY_WOOD.get()), "_wood", "_log")));
	//	simpleBlockItem(TechnologicaBlocks.STRIPPED_BENEVOLENT_APOTHECARY_WOOD.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.STRIPPED_BENEVOLENT_APOTHECARY_WOOD.get()), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.STRIPPED_BENEVOLENT_APOTHECARY_WOOD.get()), "_wood", "_log"), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.STRIPPED_BENEVOLENT_APOTHECARY_WOOD.get()), "_wood", "_log")));
	//	simpleBlockItem(TechnologicaBlocks.STRIPPED_MALEVOLENT_APOTHECARY_WOOD.get(), models().cubeColumn(ResourceLocationHelper.getPath(TechnologicaBlocks.STRIPPED_MALEVOLENT_APOTHECARY_WOOD.get()), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.STRIPPED_MALEVOLENT_APOTHECARY_WOOD.get()), "_wood", "_log"), ResourceLocationHelper.replace(blockTexture(TechnologicaBlocks.STRIPPED_MALEVOLENT_APOTHECARY_WOOD.get()), "_wood", "_log")));
