...
//-------------------------------------------REGISTRY-OBJECT-------------------NAME-------------------------------------------------------------------ITEM-GROUP-----------------PROPERTIES------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    public static final RegistryObject<Item> ASTATINE_CHUNK = 	ITEMS.register("astatine_chunk", () -> 	new Item(new Item.Properties().group(ModItemGroup.TECHNOLOGICA_MINERAL)));
