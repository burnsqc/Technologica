...
public class ClientSetup {
	...
	private static void TechnologicaItemBlockRenderTypes() {
		...
		ItemBlockRenderTypes.setRenderLayer(TechnologicaBlocks.BLACKBERRY_BUSH.get(), RenderType.cutoutMipped());
		ItemBlockRenderTypes.setRenderLayer(TechnologicaBlocks.BLUEBERRY_BUSH.get(), RenderType.cutoutMipped());
		ItemBlockRenderTypes.setRenderLayer(TechnologicaBlocks.BROCCOLI.get(), RenderType.cutoutMipped());
		ItemBlockRenderTypes.setRenderLayer(TechnologicaBlocks.CELERY.get(), RenderType.cutoutMipped());
		...
		ItemBlockRenderTypes.setRenderLayer(TechnologicaBlocks.LETTUCE.get(), RenderType.cutoutMipped());
		ItemBlockRenderTypes.setRenderLayer(TechnologicaBlocks.MUSTARD_GREENS.get(), RenderType.cutoutMipped());
		ItemBlockRenderTypes.setRenderLayer(TechnologicaBlocks.OATS.get(), RenderType.cutoutMipped());
		ItemBlockRenderTypes.setRenderLayer(TechnologicaBlocks.ONIONS.get(), RenderType.cutoutMipped());
		ItemBlockRenderTypes.setRenderLayer(TechnologicaBlocks.PEAS.get(), RenderType.cutoutMipped());
		ItemBlockRenderTypes.setRenderLayer(TechnologicaBlocks.PEANUTS.get(), RenderType.cutoutMipped());
		ItemBlockRenderTypes.setRenderLayer(TechnologicaBlocks.PINEAPPLES.get(), RenderType.cutoutMipped());
		ItemBlockRenderTypes.setRenderLayer(TechnologicaBlocks.PURPLE_CABBAGE.get(), RenderType.cutoutMipped());
		ItemBlockRenderTypes.setRenderLayer(TechnologicaBlocks.RADISHES.get(), RenderType.cutoutMipped());
		ItemBlockRenderTypes.setRenderLayer(TechnologicaBlocks.RASPBERRY_BUSH.get(), RenderType.cutoutMipped());
		...
		ItemBlockRenderTypes.setRenderLayer(TechnologicaBlocks.DISPLAY_CASE.get(), RenderType.cutoutMipped());
