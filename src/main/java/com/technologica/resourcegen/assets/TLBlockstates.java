...
public class TLBlockstates extends TLReGenBlockstates {
	...
	protected void populate() {
		...
		getVariantBuilder(TechnologicaBlocks.SMALL_PULLEY.get()).partialState().setModels(new TLReGenConfiguredModel(withExistingParent(ResourceLocationHelper.getPath(TechnologicaBlocks.SMALL_PULLEY.get()), new TechnologicaLocation(ResourceLocationHelper.getPath(TechnologicaBlocks.SMALL_PULLEY.get()) + "_model")).texture("pulley", new TechnologicaLocation("block/pulley"))));
		getVariantBuilder(TechnologicaBlocks.MEDIUM_PULLEY.get()).partialState().setModels(new TLReGenConfiguredModel(withExistingParent(ResourceLocationHelper.getPath(TechnologicaBlocks.MEDIUM_PULLEY.get()), new TechnologicaLocation(ResourceLocationHelper.getPath(TechnologicaBlocks.MEDIUM_PULLEY.get()) + "_model")).texture("pulley", new TechnologicaLocation("block/pulley"))));
		getVariantBuilder(TechnologicaBlocks.LARGE_PULLEY.get()).partialState().setModels(new TLReGenConfiguredModel(withExistingParent(ResourceLocationHelper.getPath(TechnologicaBlocks.LARGE_PULLEY.get()), new TechnologicaLocation(ResourceLocationHelper.getPath(TechnologicaBlocks.LARGE_PULLEY.get()) + "_model")).texture("pulley", new TechnologicaLocation("block/pulley"))));
	...
	private void saplingBlocks() {
		simpleBlock(TechnologicaBlocks.APRICOT_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.APRICOT_SAPLING.get()), blockTexture(TechnologicaBlocks.APRICOT_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.ASPEN_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.ASPEN_SAPLING.get()), blockTexture(TechnologicaBlocks.ASPEN_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.AVOCADO_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.AVOCADO_SAPLING.get()), blockTexture(TechnologicaBlocks.AVOCADO_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.BANANA_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.BANANA_SAPLING.get()), blockTexture(TechnologicaBlocks.BANANA_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.CHERRY_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.CHERRY_SAPLING.get()), blockTexture(TechnologicaBlocks.CHERRY_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.CHESTNUT_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.CHESTNUT_SAPLING.get()), blockTexture(TechnologicaBlocks.CHESTNUT_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.CINNAMON_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.CINNAMON_SAPLING.get()), blockTexture(TechnologicaBlocks.CINNAMON_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.COCONUT_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.COCONUT_SAPLING.get()), blockTexture(TechnologicaBlocks.COCONUT_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.EBONY_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.EBONY_SAPLING.get()), blockTexture(TechnologicaBlocks.EBONY_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.KIWI_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.KIWI_SAPLING.get()), blockTexture(TechnologicaBlocks.KIWI_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.LEMON_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.LEMON_SAPLING.get()), blockTexture(TechnologicaBlocks.LEMON_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.LIME_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.LIME_SAPLING.get()), blockTexture(TechnologicaBlocks.LIME_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.MAHOGANY_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.MAHOGANY_SAPLING.get()), blockTexture(TechnologicaBlocks.MAHOGANY_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.MAPLE_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.MAPLE_SAPLING.get()), blockTexture(TechnologicaBlocks.MAPLE_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.OLIVE_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.OLIVE_SAPLING.get()), blockTexture(TechnologicaBlocks.OLIVE_SAPLING.get())));
		simpleBlock(TechnologicaBlocks.ORANGE_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.ORANGE_SAPLING.get()), blockTexture(TechnologicaBlocks.ORANGE_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.PEACH_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.PEACH_SAPLING.get()), blockTexture(TechnologicaBlocks.PEACH_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.PEAR_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.PEAR_SAPLING.get()), blockTexture(TechnologicaBlocks.PEAR_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.PLUM_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.PLUM_SAPLING.get()), blockTexture(TechnologicaBlocks.PLUM_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.REDWOOD_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.REDWOOD_SAPLING.get()), blockTexture(TechnologicaBlocks.REDWOOD_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.ROSEWOOD_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.ROSEWOOD_SAPLING.get()), blockTexture(TechnologicaBlocks.ROSEWOOD_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.RUBBER_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.RUBBER_SAPLING.get()), blockTexture(TechnologicaBlocks.RUBBER_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.TEAK_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.TEAK_SAPLING.get()), blockTexture(TechnologicaBlocks.TEAK_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.WALNUT_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.WALNUT_SAPLING.get()), blockTexture(TechnologicaBlocks.WALNUT_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.ZEBRAWOOD_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.ZEBRAWOOD_SAPLING.get()), blockTexture(TechnologicaBlocks.ZEBRAWOOD_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.ANCIENT_AMBROSIA_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.ANCIENT_AMBROSIA_SAPLING.get()), blockTexture(TechnologicaBlocks.ANCIENT_AMBROSIA_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.CRYOGENIC_SPIRE_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.CRYOGENIC_SPIRE_SAPLING.get()), blockTexture(TechnologicaBlocks.CRYOGENIC_SPIRE_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.THUNDEROUS_CONDUCTOR_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.THUNDEROUS_CONDUCTOR_SAPLING.get()), blockTexture(TechnologicaBlocks.THUNDEROUS_CONDUCTOR_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.TOWERING_INFERNO_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.TOWERING_INFERNO_SAPLING.get()), blockTexture(TechnologicaBlocks.TOWERING_INFERNO_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.SERENDIPITOUS_APOTHECARY_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.SERENDIPITOUS_APOTHECARY_SAPLING.get()), blockTexture(TechnologicaBlocks.SERENDIPITOUS_APOTHECARY_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.BENEVOLENT_APOTHECARY_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.BENEVOLENT_APOTHECARY_SAPLING.get()), blockTexture(TechnologicaBlocks.BENEVOLENT_APOTHECARY_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.MALEVOLENT_APOTHECARY_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.MALEVOLENT_APOTHECARY_SAPLING.get()), blockTexture(TechnologicaBlocks.MALEVOLENT_APOTHECARY_SAPLING.get())).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.NECROTIC_SAPLING.get(), cross(ResourceLocationHelper.getPath(TechnologicaBlocks.NECROTIC_SAPLING.get()), blockTexture(TechnologicaBlocks.NECROTIC_SAPLING.get())).renderType("cutout_mipped"));
	}

	private void pottedSaplingBlocks() {
		simpleBlock(TechnologicaBlocks.POTTED_APRICOT_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_APRICOT_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_APRICOT_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_ASPEN_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_ASPEN_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_ASPEN_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_AVOCADO_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_AVOCADO_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_AVOCADO_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_BANANA_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_BANANA_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_BANANA_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_CHERRY_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_CHERRY_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_CHERRY_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_CHESTNUT_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_CHESTNUT_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_CHESTNUT_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_CINNAMON_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_CINNAMON_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_CINNAMON_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_COCONUT_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_COCONUT_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_COCONUT_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_EBONY_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_EBONY_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_EBONY_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_KIWI_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_KIWI_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_KIWI_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_LEMON_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_LEMON_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_LEMON_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_LIME_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_LIME_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_LIME_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_MAHOGANY_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_MAHOGANY_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_MAHOGANY_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_MAPLE_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_MAPLE_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_MAPLE_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_OLIVE_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_OLIVE_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_OLIVE_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_ORANGE_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_ORANGE_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_ORANGE_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_PEACH_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_PEACH_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_PEACH_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_PEAR_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_PEAR_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_PEAR_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_PLUM_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_PLUM_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_PLUM_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_REDWOOD_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_REDWOOD_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_REDWOOD_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_ROSEWOOD_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_ROSEWOOD_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_ROSEWOOD_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_RUBBER_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_RUBBER_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_RUBBER_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_TEAK_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_TEAK_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_TEAK_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_WALNUT_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_WALNUT_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_WALNUT_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_ZEBRAWOOD_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_ZEBRAWOOD_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_ZEBRAWOOD_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_ANCIENT_AMBROSIA_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_ANCIENT_AMBROSIA_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_ANCIENT_AMBROSIA_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_CRYOGENIC_SPIRE_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_CRYOGENIC_SPIRE_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_CRYOGENIC_SPIRE_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_THUNDEROUS_CONDUCTOR_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_THUNDEROUS_CONDUCTOR_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_THUNDEROUS_CONDUCTOR_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_TOWERING_INFERNO_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_TOWERING_INFERNO_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_TOWERING_INFERNO_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_SERENDIPITOUS_APOTHECARY_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_SERENDIPITOUS_APOTHECARY_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_SERENDIPITOUS_APOTHECARY_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_BENEVOLENT_APOTHECARY_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_BENEVOLENT_APOTHECARY_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_BENEVOLENT_APOTHECARY_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_MALEVOLENT_APOTHECARY_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_MALEVOLENT_APOTHECARY_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_MALEVOLENT_APOTHECARY_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
		simpleBlock(TechnologicaBlocks.POTTED_NECROTIC_SAPLING.get(), singleTexture(ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_NECROTIC_SAPLING.get()), new ResourceLocation("flower_pot_cross"), "plant", new TechnologicaLocation("block/" + ResourceLocationHelper.getPath(TechnologicaBlocks.POTTED_NECROTIC_SAPLING.get()).replaceAll("potted_", ""))).renderType("cutout_mipped"));
	}
	...
	private void bookshelfBlocks() {
		simpleBlock(TechnologicaBlocks.ACACIA_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.ACACIA_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.ACACIA_BOOKSHELF.get()), blockTexture(Blocks.ACACIA_PLANKS)).renderType("solid"));
		simpleBlock(TechnologicaBlocks.APRICOT_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.APRICOT_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.APRICOT_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.APRICOT_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.ASPEN_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.ASPEN_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.ASPEN_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.ASPEN_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.AVOCADO_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.AVOCADO_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.AVOCADO_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.AVOCADO_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.BANANA_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.BANANA_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.BANANA_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.BANANA_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.BIRCH_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.BIRCH_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.BIRCH_BOOKSHELF.get()), blockTexture(Blocks.BIRCH_PLANKS)).renderType("solid"));
		simpleBlock(TechnologicaBlocks.CHERRY_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.CHERRY_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.CHERRY_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.CHERRY_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.CHESTNUT_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.CHESTNUT_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.CHESTNUT_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.CHESTNUT_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.CINNAMON_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.CINNAMON_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.CINNAMON_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.CINNAMON_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.COCONUT_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.COCONUT_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.COCONUT_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.COCONUT_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.CRIMSON_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.CRIMSON_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.CRIMSON_BOOKSHELF.get()), blockTexture(Blocks.CRIMSON_PLANKS)).renderType("solid"));
		simpleBlock(TechnologicaBlocks.DARK_OAK_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.DARK_OAK_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.DARK_OAK_BOOKSHELF.get()), blockTexture(Blocks.DARK_OAK_PLANKS)).renderType("solid"));
		simpleBlock(TechnologicaBlocks.EBONY_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.EBONY_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.EBONY_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.EBONY_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.JUNGLE_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.JUNGLE_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.JUNGLE_BOOKSHELF.get()), blockTexture(Blocks.JUNGLE_PLANKS)).renderType("solid"));
		simpleBlock(TechnologicaBlocks.KIWI_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.KIWI_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.KIWI_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.KIWI_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.LEMON_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.LEMON_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.LEMON_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.LEMON_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.LIME_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.LIME_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.LIME_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.LIME_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.MAHOGANY_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.MAHOGANY_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.MAHOGANY_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.MAHOGANY_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.MAPLE_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.MAPLE_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.MAPLE_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.MAPLE_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.OLIVE_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.OLIVE_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.OLIVE_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.OLIVE_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.ORANGE_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.ORANGE_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.ORANGE_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.ORANGE_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.PEACH_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.PEACH_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.PEACH_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.PEACH_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.PEAR_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.PEAR_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.PEAR_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.PEAR_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.PLUM_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.PLUM_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.PLUM_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.PLUM_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.REDWOOD_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.REDWOOD_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.REDWOOD_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.REDWOOD_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.ROSEWOOD_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.ROSEWOOD_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.ROSEWOOD_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.ROSEWOOD_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.RUBBER_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.RUBBER_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.RUBBER_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.RUBBER_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.SPRUCE_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.SPRUCE_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.SPRUCE_BOOKSHELF.get()), blockTexture(Blocks.SPRUCE_PLANKS)).renderType("solid"));
		simpleBlock(TechnologicaBlocks.TEAK_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.TEAK_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.TEAK_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.TEAK_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.WALNUT_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.WALNUT_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.WALNUT_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.WALNUT_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.WARPED_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.WARPED_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.WARPED_BOOKSHELF.get()), blockTexture(Blocks.WARPED_PLANKS)).renderType("solid"));
		simpleBlock(TechnologicaBlocks.ZEBRAWOOD_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.ZEBRAWOOD_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.ZEBRAWOOD_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.ZEBRAWOOD_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.FRUITFUL_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.FRUITFUL_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.FRUITFUL_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.FRUITFUL_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.FROSTBITTEN_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.FROSTBITTEN_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.FROSTBITTEN_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.FROSTBITTEN_PLANKS.get())).renderType("translucent"));
		simpleBlock(TechnologicaBlocks.CONDUCTIVE_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.CONDUCTIVE_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.CONDUCTIVE_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.CONDUCTIVE_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.ALCHEMICAL_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.ALCHEMICAL_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.ALCHEMICAL_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.ALCHEMICAL_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.BENEVOLENT_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.BENEVOLENT_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.BENEVOLENT_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.BENEVOLENT_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.MALEVOLENT_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.MALEVOLENT_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.MALEVOLENT_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.MALEVOLENT_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.INFERNAL_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.INFERNAL_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.INFERNAL_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.INFERNAL_PLANKS.get())).renderType("solid"));
		simpleBlock(TechnologicaBlocks.NECROTIC_BOOKSHELF.get(), cubeColumn(name(TechnologicaBlocks.NECROTIC_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.NECROTIC_BOOKSHELF.get()), blockTexture(TechnologicaBlocks.NECROTIC_PLANKS.get())).renderType("solid"));
	}
	...
	public ModelFile fluid(Block block) {
		ResourceLocation location = ForgeRegistries.BLOCKS.getKey(block);
		return getBuilder(location.getPath()).texture("particle", "minecraft:block/water_still");
	}

	public ModelFile skull() {
	...
	private void simpleBlockWithRenderType(Block block, String renderType) {
		simpleBlock(block, cubeAll(name(block), blockTexture(block)).renderType(renderType));
	}
	...
	private void slabBlockWithRenderType(SlabBlock block, ResourceLocation doubleslab, ResourceLocation side, ResourceLocation bottom, ResourceLocation top, String renderType) {
		slabBlock(block, slab(name(block), side, bottom, top).renderType(renderType), slabTop(name(block) + "_top", side, bottom, top).renderType(renderType), getExistingFile(doubleslab));
	}
	...
	public void buttonBlockWithRenderType(ButtonBlock block, ResourceLocation texture, String renderType) {
		ModelFile button = button(name(block), texture).renderType(renderType);
		ModelFile buttonPressed = buttonPressed(name(block) + "_pressed", texture).renderType(renderType);
	...
	public void signBlockWithRenderType(StandingSignBlock signBlock, WallSignBlock wallSignBlock, ResourceLocation texture, String renderType) {
		ModelFile sign = sign(name(signBlock), texture).renderType(renderType);
		signBlock(signBlock, wallSignBlock, sign);
	}

	public void grainCropBlock(Block block) {
		getVariantBuilder(block).partialState().with(CropBlock.AGE, 0).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_stage0", ResourceLocationHelper.extend(blockTexture(block), "_stage0")).renderType("cutout")).addModel().partialState().with(CropBlock.AGE, 1).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_stage1", ResourceLocationHelper.extend(blockTexture(block), "_stage1")).renderType("cutout")).addModel().partialState().with(CropBlock.AGE, 2).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_stage2", ResourceLocationHelper.extend(blockTexture(block), "_stage2")).renderType("cutout")).addModel().partialState().with(CropBlock.AGE, 3).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_stage3", ResourceLocationHelper.extend(blockTexture(block), "_stage3")).renderType("cutout")).addModel().partialState().with(CropBlock.AGE, 4).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_stage4", ResourceLocationHelper.extend(blockTexture(block), "_stage4")).renderType("cutout")).addModel().partialState().with(CropBlock.AGE, 5).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_stage5", ResourceLocationHelper.extend(blockTexture(block), "_stage5")).renderType("cutout")).addModel().partialState().with(CropBlock.AGE, 6).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_stage6", ResourceLocationHelper.extend(blockTexture(block), "_stage6")).renderType("cutout")).addModel().partialState().with(CropBlock.AGE, 7).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_stage7", ResourceLocationHelper.extend(blockTexture(block), "_stage7")).renderType("cutout")).addModel();
	}

	public void replantableCropBlock(Block block) {
		getVariantBuilder(block).partialState().with(PotatoBlock.AGE, 0).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_stage0", ResourceLocationHelper.extend(blockTexture(block), "_stage0")).renderType("cutout")).addModel().partialState().with(PotatoBlock.AGE, 1).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_stage0", ResourceLocationHelper.extend(blockTexture(block), "_stage0")).renderType("cutout")).addModel().partialState().with(PotatoBlock.AGE, 2).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_stage1", ResourceLocationHelper.extend(blockTexture(block), "_stage1")).renderType("cutout")).addModel().partialState().with(PotatoBlock.AGE, 3).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_stage1", ResourceLocationHelper.extend(blockTexture(block), "_stage1")).renderType("cutout")).addModel().partialState().with(PotatoBlock.AGE, 4).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_stage2", ResourceLocationHelper.extend(blockTexture(block), "_stage2")).renderType("cutout")).addModel().partialState().with(PotatoBlock.AGE, 5).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_stage2", ResourceLocationHelper.extend(blockTexture(block), "_stage2")).renderType("cutout")).addModel().partialState().with(PotatoBlock.AGE, 6).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_stage2", ResourceLocationHelper.extend(blockTexture(block), "_stage2")).renderType("cutout")).addModel().partialState().with(PotatoBlock.AGE, 7).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_stage3", ResourceLocationHelper.extend(blockTexture(block), "_stage3")).renderType("cutout")).addModel();
	}

	public void seededCropBlock(Block block) {
		getVariantBuilder(block).partialState().with(BeetrootBlock.AGE, 0).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_stage0", ResourceLocationHelper.extend(blockTexture(block), "_stage0")).renderType("cutout")).addModel().partialState().with(BeetrootBlock.AGE, 1).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_stage1", ResourceLocationHelper.extend(blockTexture(block), "_stage1")).renderType("cutout")).addModel().partialState().with(BeetrootBlock.AGE, 2).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_stage2", ResourceLocationHelper.extend(blockTexture(block), "_stage2")).renderType("cutout")).addModel().partialState().with(BeetrootBlock.AGE, 3).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_stage3", ResourceLocationHelper.extend(blockTexture(block), "_stage3")).renderType("cutout")).addModel();
	}

	public void berryBushBlock(Block block) {
		getVariantBuilder(block).partialState().with(SweetBerryBushBlock.AGE, 0).modelForState().modelFile(cross(ResourceLocationHelper.getPath(block) + "_stage0", ResourceLocationHelper.extend(blockTexture(block), "_stage0")).renderType("cutout_mipped")).addModel().partialState().with(SweetBerryBushBlock.AGE, 1).modelForState().modelFile(cross(ResourceLocationHelper.getPath(block) + "_stage1", ResourceLocationHelper.extend(blockTexture(block), "_stage1")).renderType("cutout_mipped")).addModel().partialState().with(SweetBerryBushBlock.AGE, 2).modelForState().modelFile(cross(ResourceLocationHelper.getPath(block) + "_stage2", ResourceLocationHelper.extend(blockTexture(block), "_stage2")).renderType("cutout_mipped")).addModel().partialState().with(SweetBerryBushBlock.AGE, 3).modelForState().modelFile(cross(ResourceLocationHelper.getPath(block) + "_stage3", ResourceLocationHelper.extend(blockTexture(block), "_stage3")).renderType("cutout_mipped")).addModel();
	}

	public void tallCropBlock(Block block) {
		getVariantBuilder(block).partialState().with(TallCropBlock.HALF, DoubleBlockHalf.LOWER).with(CropBlock.AGE, 0).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_bottom_stage0", ResourceLocationHelper.extend(blockTexture(block), "_bottom_stage0")).renderType("cutout")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.LOWER).with(CropBlock.AGE, 1).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_bottom_stage1", ResourceLocationHelper.extend(blockTexture(block), "_bottom_stage1")).renderType("cutout")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.LOWER).with(CropBlock.AGE, 2).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_bottom_stage2", ResourceLocationHelper.extend(blockTexture(block), "_bottom_stage2")).renderType("cutout")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.LOWER).with(CropBlock.AGE, 3).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_bottom_stage3", ResourceLocationHelper.extend(blockTexture(block), "_bottom_stage3")).renderType("cutout")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.LOWER).with(CropBlock.AGE, 4).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_bottom_stage4", ResourceLocationHelper.extend(blockTexture(block), "_bottom_stage4")).renderType("cutout")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.LOWER).with(CropBlock.AGE, 5).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_bottom_stage5", ResourceLocationHelper.extend(blockTexture(block), "_bottom_stage5")).renderType("cutout")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.LOWER).with(CropBlock.AGE, 6).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_bottom_stage6", ResourceLocationHelper.extend(blockTexture(block), "_bottom_stage6")).renderType("cutout")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.LOWER).with(CropBlock.AGE, 7).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_bottom_stage7", ResourceLocationHelper.extend(blockTexture(block), "_bottom_stage7")).renderType("cutout")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.UPPER).with(CropBlock.AGE, 0).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_top_stage0", ResourceLocationHelper.extend(blockTexture(block), "_top_stage0")).renderType("cutout")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.UPPER).with(CropBlock.AGE, 1).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_top_stage1", ResourceLocationHelper.extend(blockTexture(block), "_top_stage1")).renderType("cutout")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.UPPER).with(CropBlock.AGE, 2).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_top_stage2", ResourceLocationHelper.extend(blockTexture(block), "_top_stage2")).renderType("cutout")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.UPPER).with(CropBlock.AGE, 3).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_top_stage3", ResourceLocationHelper.extend(blockTexture(block), "_top_stage3")).renderType("cutout")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.UPPER).with(CropBlock.AGE, 4).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_top_stage4", ResourceLocationHelper.extend(blockTexture(block), "_top_stage4")).renderType("cutout")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.UPPER).with(CropBlock.AGE, 5).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_top_stage5", ResourceLocationHelper.extend(blockTexture(block), "_top_stage5")).renderType("cutout")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.UPPER).with(CropBlock.AGE, 6).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_top_stage6", ResourceLocationHelper.extend(blockTexture(block), "_top_stage6")).renderType("cutout")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.UPPER).with(CropBlock.AGE, 7).modelForState().modelFile(crop(ResourceLocationHelper.getPath(block) + "_top_stage7", ResourceLocationHelper.extend(blockTexture(block), "_top_stage7")).renderType("cutout")).addModel();
	}

	public void tallBushCropBlock(Block block) {
		getVariantBuilder(block).partialState().with(TallCropBlock.HALF, DoubleBlockHalf.LOWER).with(CropBlock.AGE, 0).modelForState().modelFile(cross(ResourceLocationHelper.getPath(block) + "_bottom_stage0", ResourceLocationHelper.extend(blockTexture(block), "_bottom_stage0")).renderType("cutout_mipped")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.LOWER).with(CropBlock.AGE, 1).modelForState().modelFile(cross(ResourceLocationHelper.getPath(block) + "_bottom_stage1", ResourceLocationHelper.extend(blockTexture(block), "_bottom_stage1")).renderType("cutout_mipped")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.LOWER).with(CropBlock.AGE, 2).modelForState().modelFile(cross(ResourceLocationHelper.getPath(block) + "_bottom_stage2", ResourceLocationHelper.extend(blockTexture(block), "_bottom_stage2")).renderType("cutout_mipped")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.LOWER).with(CropBlock.AGE, 3).modelForState().modelFile(cross(ResourceLocationHelper.getPath(block) + "_bottom_stage3", ResourceLocationHelper.extend(blockTexture(block), "_bottom_stage3")).renderType("cutout_mipped")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.LOWER).with(CropBlock.AGE, 4).modelForState().modelFile(cross(ResourceLocationHelper.getPath(block) + "_bottom_stage4", ResourceLocationHelper.extend(blockTexture(block), "_bottom_stage4")).renderType("cutout_mipped")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.LOWER).with(CropBlock.AGE, 5).modelForState().modelFile(cross(ResourceLocationHelper.getPath(block) + "_bottom_stage5", ResourceLocationHelper.extend(blockTexture(block), "_bottom_stage5")).renderType("cutout_mipped")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.LOWER).with(CropBlock.AGE, 6).modelForState().modelFile(cross(ResourceLocationHelper.getPath(block) + "_bottom_stage6", ResourceLocationHelper.extend(blockTexture(block), "_bottom_stage6")).renderType("cutout_mipped")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.LOWER).with(CropBlock.AGE, 7).modelForState().modelFile(cross(ResourceLocationHelper.getPath(block) + "_bottom_stage7", ResourceLocationHelper.extend(blockTexture(block), "_bottom_stage7")).renderType("cutout_mipped")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.UPPER).with(CropBlock.AGE, 0).modelForState().modelFile(cross(ResourceLocationHelper.getPath(block) + "_top_stage0", ResourceLocationHelper.extend(blockTexture(block), "_top_stage0")).renderType("cutout_mipped")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.UPPER).with(CropBlock.AGE, 1).modelForState().modelFile(cross(ResourceLocationHelper.getPath(block) + "_top_stage1", ResourceLocationHelper.extend(blockTexture(block), "_top_stage1")).renderType("cutout_mipped")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.UPPER).with(CropBlock.AGE, 2).modelForState().modelFile(cross(ResourceLocationHelper.getPath(block) + "_top_stage2", ResourceLocationHelper.extend(blockTexture(block), "_top_stage2")).renderType("cutout_mipped")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.UPPER).with(CropBlock.AGE, 3).modelForState().modelFile(cross(ResourceLocationHelper.getPath(block) + "_top_stage3", ResourceLocationHelper.extend(blockTexture(block), "_top_stage3")).renderType("cutout_mipped")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.UPPER).with(CropBlock.AGE, 4).modelForState().modelFile(cross(ResourceLocationHelper.getPath(block) + "_top_stage4", ResourceLocationHelper.extend(blockTexture(block), "_top_stage4")).renderType("cutout_mipped")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.UPPER).with(CropBlock.AGE, 5).modelForState().modelFile(cross(ResourceLocationHelper.getPath(block) + "_top_stage5", ResourceLocationHelper.extend(blockTexture(block), "_top_stage5")).renderType("cutout_mipped")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.UPPER).with(CropBlock.AGE, 6).modelForState().modelFile(cross(ResourceLocationHelper.getPath(block) + "_top_stage6", ResourceLocationHelper.extend(blockTexture(block), "_top_stage6")).renderType("cutout_mipped")).addModel().partialState().with(TallCropBlock.HALF, DoubleBlockHalf.UPPER).with(CropBlock.AGE, 7).modelForState().modelFile(cross(ResourceLocationHelper.getPath(block) + "_top_stage7", ResourceLocationHelper.extend(blockTexture(block), "_top_stage7")).renderType("cutout_mipped")).addModel();
	}
	...
	public void vineCropBlock(Block block) {
		getMultipartBuilder(block).part().modelFile(trellis(TechnologicaBlocks.TRELLIS.get(), blockTexture(TechnologicaBlocks.TRELLIS.get()))).addModel().condition(VineCropBlock.TRELLIS, true).end().part().modelFile(crop(ResourceLocationHelper.getPath(block) + "_bottom_stage0", ResourceLocationHelper.extend(blockTexture(block), "_bottom_stage0")).renderType("cutout")).addModel().condition(VineCropBlock.HALF, DoubleBlockHalf.LOWER).condition(VineCropBlock.AGE, 0).end().part().modelFile(crop(ResourceLocationHelper.getPath(block) + "_bottom_stage1", ResourceLocationHelper.extend(blockTexture(block), "_bottom_stage1")).renderType("cutout")).addModel().condition(VineCropBlock.HALF, DoubleBlockHalf.LOWER).condition(VineCropBlock.AGE, 1).end().part().modelFile(crop(ResourceLocationHelper.getPath(block) + "_bottom_stage2", ResourceLocationHelper.extend(blockTexture(block), "_bottom_stage2")).renderType("cutout")).addModel().condition(VineCropBlock.HALF, DoubleBlockHalf.LOWER).condition(VineCropBlock.AGE, 2).end().part().modelFile(crop(ResourceLocationHelper.getPath(block) + "_bottom_stage3", ResourceLocationHelper.extend(blockTexture(block), "_bottom_stage3")).renderType("cutout")).addModel().condition(VineCropBlock.HALF, DoubleBlockHalf.LOWER).condition(VineCropBlock.AGE, 3).end().part().modelFile(crop(ResourceLocationHelper.getPath(block) + "_bottom_stage4", ResourceLocationHelper.extend(blockTexture(block), "_bottom_stage4")).renderType("cutout")).addModel().condition(VineCropBlock.HALF, DoubleBlockHalf.LOWER).condition(VineCropBlock.AGE, 4).end().part().modelFile(crop(ResourceLocationHelper.getPath(block) + "_bottom_stage5", ResourceLocationHelper.extend(blockTexture(block), "_bottom_stage5")).renderType("cutout")).addModel().condition(VineCropBlock.HALF, DoubleBlockHalf.LOWER).condition(VineCropBlock.AGE, 5).end().part().modelFile(crop(ResourceLocationHelper.getPath(block) + "_bottom_stage6", ResourceLocationHelper.extend(blockTexture(block), "_bottom_stage6")).renderType("cutout")).addModel().condition(VineCropBlock.HALF, DoubleBlockHalf.LOWER).condition(VineCropBlock.AGE, 6).end().part().modelFile(crop(ResourceLocationHelper.getPath(block) + "_bottom_stage7", ResourceLocationHelper.extend(blockTexture(block), "_bottom_stage7")).renderType("cutout")).addModel().condition(VineCropBlock.HALF, DoubleBlockHalf.LOWER).condition(VineCropBlock.AGE, 7).end().part().modelFile(crop(ResourceLocationHelper.getPath(block) + "_top_stage0", ResourceLocationHelper.extend(blockTexture(block), "_top_stage0")).renderType("cutout")).addModel().condition(VineCropBlock.HALF, DoubleBlockHalf.UPPER).condition(VineCropBlock.AGE, 0).end().part().modelFile(crop(ResourceLocationHelper.getPath(block) + "_top_stage1", ResourceLocationHelper.extend(blockTexture(block), "_top_stage1")).renderType("cutout")).addModel().condition(VineCropBlock.HALF, DoubleBlockHalf.UPPER).condition(VineCropBlock.AGE, 1).end().part().modelFile(crop(ResourceLocationHelper.getPath(block) + "_top_stage2", ResourceLocationHelper.extend(blockTexture(block), "_top_stage2")).renderType("cutout")).addModel().condition(VineCropBlock.HALF, DoubleBlockHalf.UPPER).condition(VineCropBlock.AGE, 2).end().part().modelFile(crop(ResourceLocationHelper.getPath(block) + "_top_stage3", ResourceLocationHelper.extend(blockTexture(block), "_top_stage3")).renderType("cutout")).addModel().condition(VineCropBlock.HALF, DoubleBlockHalf.UPPER).condition(VineCropBlock.AGE, 3).end().part().modelFile(crop(ResourceLocationHelper.getPath(block) + "_top_stage4", ResourceLocationHelper.extend(blockTexture(block), "_top_stage4")).renderType("cutout")).addModel().condition(VineCropBlock.HALF, DoubleBlockHalf.UPPER).condition(VineCropBlock.AGE, 4).end().part().modelFile(crop(ResourceLocationHelper.getPath(block) + "_top_stage5", ResourceLocationHelper.extend(blockTexture(block), "_top_stage5")).renderType("cutout")).addModel().condition(VineCropBlock.HALF, DoubleBlockHalf.UPPER).condition(VineCropBlock.AGE, 5).end().part().modelFile(crop(ResourceLocationHelper.getPath(block) + "_top_stage6", ResourceLocationHelper.extend(blockTexture(block), "_top_stage6")).renderType("cutout")).addModel().condition(VineCropBlock.HALF, DoubleBlockHalf.UPPER).condition(VineCropBlock.AGE, 6).end().part().modelFile(crop(ResourceLocationHelper.getPath(block) + "_top_stage7", ResourceLocationHelper.extend(blockTexture(block), "_top_stage7")).renderType("cutout")).addModel().condition(VineCropBlock.HALF, DoubleBlockHalf.UPPER).condition(VineCropBlock.AGE, 7).end();
	}
