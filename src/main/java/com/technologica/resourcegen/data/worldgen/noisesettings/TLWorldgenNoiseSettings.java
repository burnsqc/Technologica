...
public class TLWorldgenNoiseSettings extends TLReGenWorldgenNoiseSettings {
	public static void bootstrap(BootstapContext<NoiseGeneratorSettings> noiseSettings) {
		noiseSettings.register(TechnologicaNoiseGeneratorSettings.MOON, noiseSettings(false, TechnologicaBlocks.MOON_ROCK.get().defaultBlockState(), Blocks.WATER.defaultBlockState(), false, false, noise(384, -64, 1, 2), NoiseRouterData.moon(noiseSettings.lookup(Registries.DENSITY_FUNCTION), noiseSettings.lookup(Registries.NOISE), true, true), false, -64, List.of(),

			TechnologicaSurfaceRuleData.moon()

		));
		noiseSettings.register(TechnologicaNoiseGeneratorSettings.CHALLENGER_DEEP, noiseSettings(false, Blocks.STONE.defaultBlockState(), Blocks.WATER.defaultBlockState(), false, false, noise(384, -64, 1, 2), NoiseRouterData.challengerDeep(noiseSettings.lookup(Registries.DENSITY_FUNCTION), noiseSettings.lookup(Registries.NOISE)), false, 384, List.of(), TechnologicaSurfaceRuleData.challengerDeep()));
		noiseSettings.register(TechnologicaNoiseGeneratorSettings.OVERGROWTH, noiseSettings(false, Blocks.DIRT.defaultBlockState(), Blocks.WATER.defaultBlockState(), false, false, noise(128, 0, 1, 2), NoiseRouterData.challengerDeep(noiseSettings.lookup(Registries.DENSITY_FUNCTION), noiseSettings.lookup(Registries.NOISE)), false, 32, List.of(), TechnologicaSurfaceRuleData.overgrowth()));
	}
