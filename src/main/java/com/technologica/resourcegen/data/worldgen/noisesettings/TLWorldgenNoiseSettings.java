...
public class TLWorldgenNoiseSettings extends TLReGenWorldgenNoiseSettings {
	...
	private class TLSurfaceRuleData {
		...
		private static final SurfaceRules.RuleSource CHALLENGER_DEEP = SurfaceRules.sequence(
			BEDROCK_FLOOR, 
			BEDROCK_ROOF, 
			SurfaceRules.ifTrue(
