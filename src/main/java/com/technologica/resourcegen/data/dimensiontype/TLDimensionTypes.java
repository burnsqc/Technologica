...
public final class TLDimensionTypes extends TLReGenDimensionType {
	...
	protected void populate() {
		...
		dimensionType(TechnologicaDimensionTypes.CHALLENGER_DEEP, dimensionType(0.0F, true, 1.0D, BuiltinDimensionTypes.NETHER_EFFECTS, OptionalLong.empty(), true, false, false, 256, BlockTags.INFINIBURN_OVERWORLD, 256, 0, 0, UniformInt.of(0, 7), true, false, false, false));
