...
public final class TLLootTablesBlocksGenerator extends BlockLootSubProvider {
	private static final float[] DEFAULT_SAPLING_DROP_RATES = new float[] { 0.05F, 0.0625F, 0.083333336F, 0.1F };
	private static final Set<Item> EXPLOSION_RESISTANT = Stream.of(TechnologicaBlocks.BEEPER_HEAD.get(), TechnologicaBlocks.PEEPER_HEAD.get(), TechnologicaBlocks.SLEEPER_HEAD.get(), TechnologicaBlocks.SWEEPER_HEAD.get(), TechnologicaBlocks.WEEPER_HEAD.get()).map(ItemLike::asItem).collect(Collectors.toSet());

	public TLLootTablesBlocksGenerator() {
