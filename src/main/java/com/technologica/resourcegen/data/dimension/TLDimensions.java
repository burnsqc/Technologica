...
public final class TLDimensions extends TLReGenDimension {
	public static void bootstrap(final BootstapContext<LevelStem> dimension) {
		...
		dimension.register(TechnologicaDimensions.CHALLENGER_DEEP_STEM, 
			dimension(
				TechnologicaDimensionTypes.CHALLENGER_DEEP, 
				chunkGenerator(
					"noise", 
					new BiomeSourceBuilder("multi_noise")
					.add(biome(TechnologicaBiomes.RUSTING_GROUNDS, parameters(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F))).build(), TechnologicaNoiseGeneratorSettings.CHALLENGER_DEEP)));
