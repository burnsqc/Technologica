...
public class TLAdvancements extends ForgeAdvancementProvider {
	private static final List<AdvancementGenerator> SUB_GENERATORS = List.of(new StoneAgeAdvancementDataGenerator(), new BronzeAgeAdvancementDataGenerator());

	public TLAdvancements() {
