package com.technologica.resourcegen.data.advancements.technology;
...
public class TechnologyAdvancementDataProvider implements AdvancementGenerator {
	public TechnologyAdvancementDataProvider() {
	}
