...
public class TLRecipesGenerator extends TLRGRecipeGenerator {
	...
	private static void armorRecipes(Consumer<FinishedRecipe> consumer) {
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TechnologicaItems.STEEL_HELMET.get()).define('B', TechnologicaItems.STEEL_INGOT.get()).pattern("BBB").pattern("B B").unlockedBy("has_brass_ingot", has(TechnologicaItems.STEEL_INGOT.get())).save(consumer, new TechnologicaLocation("brass_helmet"));
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TechnologicaItems.STEEL_CHESTPLATE.get()).define('B', TechnologicaItems.STEEL_INGOT.get()).pattern("B B").pattern("BBB").pattern("BBB").unlockedBy("has_brass_ingot", has(TechnologicaItems.STEEL_INGOT.get())).save(consumer, new TechnologicaLocation("brass_chestplate"));
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TechnologicaItems.STEEL_LEGGINGS.get()).define('B', TechnologicaItems.STEEL_INGOT.get()).pattern("BBB").pattern("B B").pattern("B B").unlockedBy("has_brass_ingot", has(TechnologicaItems.STEEL_INGOT.get())).save(consumer, new TechnologicaLocation("brass_leggings"));
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TechnologicaItems.STEEL_BOOTS.get()).define('B', TechnologicaItems.STEEL_INGOT.get()).pattern("B B").pattern("B B").unlockedBy("has_brass_ingot", has(TechnologicaItems.STEEL_INGOT.get())).save(consumer, new TechnologicaLocation("brass_boots"));
