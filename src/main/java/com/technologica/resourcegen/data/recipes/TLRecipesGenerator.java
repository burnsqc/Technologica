...
public class TLRecipesGenerator extends TLRGRecipeGenerator {
	...
	private static void armorRecipes(Consumer<FinishedRecipe> consumer) {
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TechnologicaItems.CANVAS_TUNIC.get()).define('C', TechnologicaItems.CANVAS.get()).pattern("C C").pattern("CCC").pattern("CCC").unlockedBy("has_canvas", has(TechnologicaItems.CANVAS.get())).save(consumer, new TechnologicaLocation("canvas_tunic"));
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TechnologicaItems.CANVAS_PANTS.get()).define('C', TechnologicaItems.CANVAS.get()).pattern("CCC").pattern("C C").pattern("C C").unlockedBy("has_canvas", has(TechnologicaItems.CANVAS.get())).save(consumer, new TechnologicaLocation("canvas_pants"));

		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TechnologicaItems.BRONZE_HELMET.get()).define('B', TechnologicaItems.BRONZE_INGOT.get()).pattern("BBB").pattern("B B").unlockedBy("has_bronze_ingot", has(TechnologicaItems.BRONZE_INGOT.get())).save(consumer, new TechnologicaLocation("bronze_helmet"));
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TechnologicaItems.BRONZE_CHESTPLATE.get()).define('B', TechnologicaItems.BRONZE_INGOT.get()).pattern("B B").pattern("BBB").pattern("BBB").unlockedBy("has_bronze_ingot", has(TechnologicaItems.BRONZE_INGOT.get())).save(consumer, new TechnologicaLocation("bronze_chestplate"));
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TechnologicaItems.BRONZE_LEGGINGS.get()).define('B', TechnologicaItems.BRONZE_INGOT.get()).pattern("BBB").pattern("B B").pattern("B B").unlockedBy("has_bronze_ingot", has(TechnologicaItems.BRONZE_INGOT.get())).save(consumer, new TechnologicaLocation("bronze_leggings"));
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TechnologicaItems.BRONZE_BOOTS.get()).define('B', TechnologicaItems.BRONZE_INGOT.get()).pattern("B B").pattern("B B").unlockedBy("has_bronze_ingot", has(TechnologicaItems.BRONZE_INGOT.get())).save(consumer, new TechnologicaLocation("bronze_boots"));

		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TechnologicaItems.BRASS_HELMET.get()).define('B', TechnologicaItems.BRASS_INGOT.get()).pattern("BBB").pattern("B B").unlockedBy("has_brass_ingot", has(TechnologicaItems.BRASS_INGOT.get())).save(consumer, new TechnologicaLocation("brass_helmet"));
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TechnologicaItems.BRASS_CHESTPLATE.get()).define('B', TechnologicaItems.BRASS_INGOT.get()).pattern("B B").pattern("BBB").pattern("BBB").unlockedBy("has_brass_ingot", has(TechnologicaItems.BRASS_INGOT.get())).save(consumer, new TechnologicaLocation("brass_chestplate"));
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TechnologicaItems.BRASS_LEGGINGS.get()).define('B', TechnologicaItems.BRASS_INGOT.get()).pattern("BBB").pattern("B B").pattern("B B").unlockedBy("has_brass_ingot", has(TechnologicaItems.BRASS_INGOT.get())).save(consumer, new TechnologicaLocation("brass_leggings"));
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TechnologicaItems.BRASS_BOOTS.get()).define('B', TechnologicaItems.BRASS_INGOT.get()).pattern("B B").pattern("B B").unlockedBy("has_brass_ingot", has(TechnologicaItems.BRASS_INGOT.get())).save(consumer, new TechnologicaLocation("brass_boots"));

		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TechnologicaItems.STEEL_HELMET.get()).define('B', TechnologicaItems.STEEL_INGOT.get()).pattern("BBB").pattern("B B").unlockedBy("has_brass_ingot", has(TechnologicaItems.STEEL_INGOT.get())).save(consumer, new TechnologicaLocation("steel_helmet"));
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TechnologicaItems.STEEL_CHESTPLATE.get()).define('B', TechnologicaItems.STEEL_INGOT.get()).pattern("B B").pattern("BBB").pattern("BBB").unlockedBy("has_brass_ingot", has(TechnologicaItems.STEEL_INGOT.get())).save(consumer, new TechnologicaLocation("steel_chestplate"));
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TechnologicaItems.STEEL_LEGGINGS.get()).define('B', TechnologicaItems.STEEL_INGOT.get()).pattern("BBB").pattern("B B").pattern("B B").unlockedBy("has_brass_ingot", has(TechnologicaItems.STEEL_INGOT.get())).save(consumer, new TechnologicaLocation("steel_leggings"));
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TechnologicaItems.STEEL_BOOTS.get()).define('B', TechnologicaItems.STEEL_INGOT.get()).pattern("B B").pattern("B B").unlockedBy("has_brass_ingot", has(TechnologicaItems.STEEL_INGOT.get())).save(consumer, new TechnologicaLocation("steel_boots"));

		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TechnologicaItems.DIVE_HELMET.get()).define('H', TechnologicaItems.BRASS_HELMET.get()).define('B', TechnologicaItems.BRASS_INGOT.get()).define('G', Items.GLASS_PANE).pattern("BGB").pattern("GHG").pattern("BGB").unlockedBy("has_brass_helmet", has(TechnologicaItems.BRASS_HELMET.get())).save(consumer, new TechnologicaLocation("dive_helmet"));
