package com.technologica.resourcegen.data.lootmodifiers.chests;
...
public class ChestLootModifierDataGenerator extends GlobalLootModifierProvider {
	...
	protected void start() {
		...
		add("chests/skeleton_key", new SkeletonKeyLootModifier(new LootItemCondition[] { LootTableIdCondition.builder(new ResourceLocation("chests/buried_treasure")).build() }));
	}

	@Override
	public String getName() {
		return "Global Loot Modifiers - Chests: " + Technologica.MOD_ID;
	}
}
