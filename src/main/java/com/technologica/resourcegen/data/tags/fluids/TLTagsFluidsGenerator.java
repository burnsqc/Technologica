...
import com.technologica.api.tlregen.resourcegen.data.tags.TLReGenTagsFluids;
import com.technologica.registration.deferred.TechnologicaFluids;

import net.minecraft.core.HolderLookup;
import net.minecraft.tags.FluidTags;

public final class TLTagsFluidsGenerator extends TLReGenTagsFluids {
	@Override
	protected void populate(HolderLookup.Provider p_256366_) {
		...
		tag(FluidTags.LAVA).add(TechnologicaFluids.MOLTEN_CORE.get(), TechnologicaFluids.FLOWING_MOLTEN_CORE.get());
	}
