...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> AVOCADO_LEAVES = BLOCKS.register("avocado_leaves", () -> new FruitingLeavesBlock(() -> ModItems.AVOCADO.get()));
    ...
    public static final RegistryObject<Block> AVOCADO_LOG = BLOCKS.register("avocado_log", ModLogBlock::new);  
	...
	public static final RegistryObject<Block> AVOCADO_WOOD = BLOCKS.register("avocado_wood", ModLogBlock::new);  
	...
	public static final RegistryObject<Block> ROSEWOOD_WOOD = BLOCKS.register("rosewood_wood", ModLogBlock::new);
    ...
    public static final RegistryObject<Block> AVOCADO_SLAB = BLOCKS.register("avocado_slab", ModSlabBlock::new);
    ...
    public static final RegistryObject<Block> CHESTNUT_SLAB = BLOCKS.register("chestnut_slab", ModSlabBlock::new);
    public static final RegistryObject<Block> COCONUT_SLAB = BLOCKS.register("coconut_slab", ModSlabBlock::new);
    public static final RegistryObject<Block> EBONY_SLAB = BLOCKS.register("ebony_slab", ModSlabBlock::new);
    ...
    public static final RegistryObject<Block> MAHOGANY_SLAB = BLOCKS.register("mahogany_slab", ModSlabBlock::new);
    public static final RegistryObject<Block> MAPLE_SLAB = BLOCKS.register("maple_slab", ModSlabBlock::new);
    ...
    public static final RegistryObject<Block> PLUM_SLAB = BLOCKS.register("plum_slab", ModSlabBlock::new);
    public static final RegistryObject<Block> REDWOOD_SLAB = BLOCKS.register("redwood_slab", ModSlabBlock::new);
    public static final RegistryObject<Block> ROSEWOOD_SLAB = BLOCKS.register("rosewood_slab", ModSlabBlock::new);
    public static final RegistryObject<Block> RUBBER_SLAB = BLOCKS.register("rubber_slab", ModSlabBlock::new);
    public static final RegistryObject<Block> TEAK_SLAB = BLOCKS.register("teak_slab", ModSlabBlock::new);
    public static final RegistryObject<Block> WALNUT_SLAB = BLOCKS.register("walnut_slab", ModSlabBlock::new);
    public static final RegistryObject<Block> ZEBRAWOOD_SLAB = BLOCKS.register("zebrawood_slab", ModSlabBlock::new);
    public static final RegistryObject<Block> ALCHEMICAL_SLAB = BLOCKS.register("alchemical_slab", ModSlabBlock::new);
    public static final RegistryObject<Block> BENEVOLENT_SLAB = BLOCKS.register("benevolent_slab", ModSlabBlock::new);
    public static final RegistryObject<Block> CONDUCTIVE_SLAB = BLOCKS.register("conductive_slab", ModSlabBlock::new);
    public static final RegistryObject<Block> FROSTBITTEN_SLAB = BLOCKS.register("frostbitten_slab", ModSlabBlock::new);
    public static final RegistryObject<Block> FRUITFUL_SLAB = BLOCKS.register("fruitful_slab", ModSlabBlock::new);
    public static final RegistryObject<Block> INFERNAL_SLAB = BLOCKS.register("infernal_slab", ModSlabBlock::new);
    public static final RegistryObject<Block> MALEVOLENT_SLAB = BLOCKS.register("malevolent_slab", ModSlabBlock::new);
    
    public static final RegistryObject<Block> APRICOT_STAIRS = BLOCKS.register("apricot_stairs", () -> new ModStairsBlock(() -> APRICOT_PLANKS.get().getDefaultState()));
    public static final RegistryObject<Block> ASPEN_STAIRS = BLOCKS.register("aspen_stairs", () -> new ModStairsBlock(() -> ASPEN_PLANKS.get().getDefaultState()));
    public static final RegistryObject<Block> AVOCADO_STAIRS = BLOCKS.register("avocado_stairs", () -> new ModStairsBlock(() -> AVOCADO_PLANKS.get().getDefaultState()));
    ...
    public static final RegistryObject<Block> CHESTNUT_STAIRS = BLOCKS.register("chestnut_stairs", () -> new ModStairsBlock(() -> CHESTNUT_PLANKS.get().getDefaultState()));
    ...
    public static final RegistryObject<Block> EBONY_STAIRS = BLOCKS.register("ebony_stairs", () -> new ModStairsBlock(() -> EBONY_PLANKS.get().getDefaultState()));
    ...
    public static final RegistryObject<Block> MAHOGANY_STAIRS = BLOCKS.register("mahogany_stairs", () -> new ModStairsBlock(() -> MAHOGANY_PLANKS.get().getDefaultState()));
    public static final RegistryObject<Block> MAPLE_STAIRS = BLOCKS.register("maple_stairs", () -> new ModStairsBlock(() -> MAPLE_PLANKS.get().getDefaultState()));
    ...
    public static final RegistryObject<Block> PLUM_STAIRS = BLOCKS.register("plum_stairs", () -> new ModStairsBlock(() -> PLUM_PLANKS.get().getDefaultState()));
    public static final RegistryObject<Block> REDWOOD_STAIRS = BLOCKS.register("redwood_stairs", () -> new ModStairsBlock(() -> REDWOOD_PLANKS.get().getDefaultState()));
    public static final RegistryObject<Block> ROSEWOOD_STAIRS = BLOCKS.register("rosewood_stairs", () -> new ModStairsBlock(() -> ROSEWOOD_PLANKS.get().getDefaultState()));
    public static final RegistryObject<Block> RUBBER_STAIRS = BLOCKS.register("rubber_stairs", () -> new ModStairsBlock(() -> RUBBER_PLANKS.get().getDefaultState()));
    public static final RegistryObject<Block> TEAK_STAIRS = BLOCKS.register("teak_stairs", () -> new ModStairsBlock(() -> TEAK_PLANKS.get().getDefaultState()));
    public static final RegistryObject<Block> WALNUT_STAIRS = BLOCKS.register("walnut_stairs", () -> new ModStairsBlock(() -> WALNUT_PLANKS.get().getDefaultState()));
    public static final RegistryObject<Block> ZEBRAWOOD_STAIRS = BLOCKS.register("zebrawood_stairs", () -> new ModStairsBlock(() -> ZEBRAWOOD_PLANKS.get().getDefaultState()));
    public static final RegistryObject<Block> ALCHEMICAL_STAIRS = BLOCKS.register("alchemical_stairs", () -> new ModStairsBlock(() -> ALCHEMICAL_PLANKS.get().getDefaultState()));
    public static final RegistryObject<Block> BENEVOLENT_STAIRS = BLOCKS.register("benevolent_stairs", () -> new ModStairsBlock(() -> BENEVOLENT_PLANKS.get().getDefaultState()));
    public static final RegistryObject<Block> CONDUCTIVE_STAIRS = BLOCKS.register("conductive_stairs", () -> new ModStairsBlock(() -> CONDUCTIVE_PLANKS.get().getDefaultState()));
    public static final RegistryObject<Block> FROSTBITTEN_STAIRS = BLOCKS.register("frostbitten_stairs", () -> new ModStairsBlock(() -> FROSTBITTEN_PLANKS.get().getDefaultState()));
    public static final RegistryObject<Block> FRUITFUL_STAIRS = BLOCKS.register("fruitful_stairs", () -> new ModStairsBlock(() -> FRUITFUL_PLANKS.get().getDefaultState()));
    public static final RegistryObject<Block> INFERNAL_STAIRS = BLOCKS.register("infernal_stairs", () -> new ModStairsBlock(() -> INFERNAL_PLANKS.get().getDefaultState()));
    public static final RegistryObject<Block> MALEVOLENT_STAIRS = BLOCKS.register("malevolent_stairs", () -> new ModStairsBlock(() -> MALEVOLENT_PLANKS.get().getDefaultState()));
    ...
    public static final RegistryObject<Block> APRICOT_BOOKSHELF = BLOCKS.register("apricot_bookshelf", ModBookshelfBlock::new);
    public static final RegistryObject<Block> ASPEN_BOOKSHELF = BLOCKS.register("aspen_bookshelf", ModBookshelfBlock::new);
    public static final RegistryObject<Block> AVOCADO_BOOKSHELF = BLOCKS.register("avocado_bookshelf", ModBookshelfBlock::new);
    ...
    public static final RegistryObject<Block> CHESTNUT_BOOKSHELF = BLOCKS.register("chestnut_bookshelf", ModBookshelfBlock::new);
    public static final RegistryObject<Block> COCONUT_BOOKSHELF = BLOCKS.register("coconut_bookshelf", ModBookshelfBlock::new);
    public static final RegistryObject<Block> EBONY_BOOKSHELF = BLOCKS.register("ebony_bookshelf", ModBookshelfBlock::new);
    ...
    public static final RegistryObject<Block> MAHOGANY_BOOKSHELF = BLOCKS.register("mahogany_bookshelf", ModBookshelfBlock::new);
    public static final RegistryObject<Block> MAPLE_BOOKSHELF = BLOCKS.register("maple_bookshelf", ModBookshelfBlock::new);
    ...
    public static final RegistryObject<Block> PLUM_BOOKSHELF = BLOCKS.register("plum_bookshelf", ModBookshelfBlock::new);
    public static final RegistryObject<Block> REDWOOD_BOOKSHELF = BLOCKS.register("redwood_bookshelf", ModBookshelfBlock::new);
    public static final RegistryObject<Block> ROSEWOOD_BOOKSHELF = BLOCKS.register("rosewood_bookshelf", ModBookshelfBlock::new);
    public static final RegistryObject<Block> RUBBER_BOOKSHELF = BLOCKS.register("rubber_bookshelf", ModBookshelfBlock::new);
    public static final RegistryObject<Block> TEAK_BOOKSHELF = BLOCKS.register("teak_bookshelf", ModBookshelfBlock::new);
    public static final RegistryObject<Block> WALNUT_BOOKSHELF = BLOCKS.register("walnut_bookshelf", ModBookshelfBlock::new);
    public static final RegistryObject<Block> ZEBRAWOOD_BOOKSHELF = BLOCKS.register("zebrawood_bookshelf", ModBookshelfBlock::new);
    public static final RegistryObject<Block> ALCHEMICAL_BOOKSHELF = BLOCKS.register("alchemical_bookshelf", ModBookshelfBlock::new);
    public static final RegistryObject<Block> BENEVOLENT_BOOKSHELF = BLOCKS.register("benevolent_bookshelf", ModBookshelfBlock::new);
    public static final RegistryObject<Block> CONDUCTIVE_BOOKSHELF = BLOCKS.register("conductive_bookshelf", ModBookshelfBlock::new);
    public static final RegistryObject<Block> FROSTBITTEN_BOOKSHELF = BLOCKS.register("frostbitten_bookshelf", ModBookshelfBlock::new);
    public static final RegistryObject<Block> FRUITFUL_BOOKSHELF = BLOCKS.register("fruitful_bookshelf", ModBookshelfBlock::new);
    public static final RegistryObject<Block> INFERNAL_BOOKSHELF = BLOCKS.register("infernal_bookshelf", ModBookshelfBlock::new);
    public static final RegistryObject<Block> MALEVOLENT_BOOKSHELF = BLOCKS.register("malevolent_bookshelf", ModBookshelfBlock::new);
    
    public static final RegistryObject<Block> APRICOT_FENCE = BLOCKS.register("apricot_fence", ModFenceBlock::new);
    public static final RegistryObject<Block> ASPEN_FENCE = BLOCKS.register("aspen_fence", ModFenceBlock::new);
    public static final RegistryObject<Block> AVOCADO_FENCE = BLOCKS.register("avocado_fence", ModFenceBlock::new);
    ...
    public static final RegistryObject<Block> CHESTNUT_FENCE = BLOCKS.register("chestnut_fence", ModFenceBlock::new);
    public static final RegistryObject<Block> COCONUT_FENCE = BLOCKS.register("coconut_fence", ModFenceBlock::new);
    public static final RegistryObject<Block> EBONY_FENCE = BLOCKS.register("ebony_fence", ModFenceBlock::new);
    ...
    public static final RegistryObject<Block> MAHOGANY_FENCE = BLOCKS.register("mahogany_fence", ModFenceBlock::new);
    public static final RegistryObject<Block> MAPLE_FENCE = BLOCKS.register("maple_fence", ModFenceBlock::new);
    ...
    public static final RegistryObject<Block> PLUM_FENCE = BLOCKS.register("plum_fence", ModFenceBlock::new);
    public static final RegistryObject<Block> REDWOOD_FENCE = BLOCKS.register("redwood_fence", ModFenceBlock::new);
    public static final RegistryObject<Block> ROSEWOOD_FENCE = BLOCKS.register("rosewood_fence", ModFenceBlock::new);
    public static final RegistryObject<Block> RUBBER_FENCE = BLOCKS.register("rubber_fence", ModFenceBlock::new);
    public static final RegistryObject<Block> TEAK_FENCE = BLOCKS.register("teak_fence", ModFenceBlock::new);
    public static final RegistryObject<Block> WALNUT_FENCE = BLOCKS.register("walnut_fence", ModFenceBlock::new);
    public static final RegistryObject<Block> ZEBRAWOOD_FENCE = BLOCKS.register("zebrawood_fence", ModFenceBlock::new);
    public static final RegistryObject<Block> ALCHEMICAL_FENCE = BLOCKS.register("alchemical_fence", ModFenceBlock::new);
    public static final RegistryObject<Block> BENEVOLENT_FENCE = BLOCKS.register("benevolent_fence", ModFenceBlock::new);
    public static final RegistryObject<Block> CONDUCTIVE_FENCE = BLOCKS.register("conductive_fence", ModFenceBlock::new);
    public static final RegistryObject<Block> FROSTBITTEN_FENCE = BLOCKS.register("frostbitten_fence", ModFenceBlock::new);
    public static final RegistryObject<Block> FRUITFUL_FENCE = BLOCKS.register("fruitful_fence", ModFenceBlock::new);
    public static final RegistryObject<Block> INFERNAL_FENCE = BLOCKS.register("infernal_fence", ModFenceBlock::new);
    public static final RegistryObject<Block> MALEVOLENT_FENCE = BLOCKS.register("malevolent_fence", ModFenceBlock::new);
    
    public static final RegistryObject<Block> APRICOT_FENCE_GATE = BLOCKS.register("apricot_fence_gate", ModFenceGateBlock::new);
    public static final RegistryObject<Block> ASPEN_FENCE_GATE = BLOCKS.register("aspen_fence_gate", ModFenceGateBlock::new);
    public static final RegistryObject<Block> AVOCADO_FENCE_GATE = BLOCKS.register("avocado_fence_gate", ModFenceGateBlock::new);
    ...
    public static final RegistryObject<Block> CHESTNUT_FENCE_GATE = BLOCKS.register("chestnut_fence_gate", ModFenceGateBlock::new);
    public static final RegistryObject<Block> COCONUT_FENCE_GATE = BLOCKS.register("coconut_fence_gate", ModFenceGateBlock::new);
    public static final RegistryObject<Block> EBONY_FENCE_GATE = BLOCKS.register("ebony_fence_gate", ModFenceGateBlock::new);
    ...
    public static final RegistryObject<Block> MAHOGANY_FENCE_GATE = BLOCKS.register("mahogany_fence_gate", ModFenceGateBlock::new);
    public static final RegistryObject<Block> MAPLE_FENCE_GATE = BLOCKS.register("maple_fence_gate", ModFenceGateBlock::new);
    ...
    public static final RegistryObject<Block> PLUM_FENCE_GATE = BLOCKS.register("plum_fence_gate", ModFenceGateBlock::new);
    public static final RegistryObject<Block> REDWOOD_FENCE_GATE = BLOCKS.register("redwood_fence_gate", ModFenceGateBlock::new);
    public static final RegistryObject<Block> ROSEWOOD_FENCE_GATE = BLOCKS.register("rosewood_fence_gate", ModFenceGateBlock::new);
    public static final RegistryObject<Block> RUBBER_FENCE_GATE = BLOCKS.register("rubber_fence_gate", ModFenceGateBlock::new);
    public static final RegistryObject<Block> TEAK_FENCE_GATE = BLOCKS.register("teak_fence_gate", ModFenceGateBlock::new);
    public static final RegistryObject<Block> WALNUT_FENCE_GATE = BLOCKS.register("walnut_fence_gate", ModFenceGateBlock::new);
    public static final RegistryObject<Block> ZEBRAWOOD_FENCE_GATE = BLOCKS.register("zebrawood_fence_gate", ModFenceGateBlock::new);
    public static final RegistryObject<Block> ALCHEMICAL_FENCE_GATE = BLOCKS.register("alchemical_fence_gate", ModFenceGateBlock::new);
    public static final RegistryObject<Block> BENEVOLENT_FENCE_GATE = BLOCKS.register("benevolent_fence_gate", ModFenceGateBlock::new);
    public static final RegistryObject<Block> CONDUCTIVE_FENCE_GATE = BLOCKS.register("conductive_fence_gate", ModFenceGateBlock::new);
    public static final RegistryObject<Block> FROSTBITTEN_FENCE_GATE = BLOCKS.register("frostbitten_fence_gate", ModFenceGateBlock::new);
    public static final RegistryObject<Block> FRUITFUL_FENCE_GATE = BLOCKS.register("fruitful_fence_gate", ModFenceGateBlock::new);
    public static final RegistryObject<Block> INFERNAL_FENCE_GATE = BLOCKS.register("infernal_fence_gate", ModFenceGateBlock::new);
    public static final RegistryObject<Block> MALEVOLENT_FENCE_GATE = BLOCKS.register("malevolent_fence_gate", ModFenceGateBlock::new);
