...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> BROCOLLI_CROP = BLOCKS.register("brocolli_crop", () -> new CropsBlock(AbstractBlock.Properties.create(Material.PLANTS).doesNotBlockMovement().tickRandomly().zeroHardnessAndResistance().sound(SoundType.CROP)));
    ...
    public static final RegistryObject<Block> OAT_CROP = BLOCKS.register("oat_crop", () -> new CropsBlock(AbstractBlock.Properties.create(Material.PLANTS).doesNotBlockMovement().tickRandomly().zeroHardnessAndResistance().sound(SoundType.CROP)));
