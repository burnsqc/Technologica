package com.technologica.datagen.data.loottables;

import java.util.List;
import java.util.Map;
import java.util.Set;

import com.technologica.datagen.data.loottables.blocks.BlockLootDataGenerator;
import com.technologica.datagen.data.loottables.entities.EntityLootDataGenerator;
