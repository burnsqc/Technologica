...
public class TechnologicaOreFeatures {
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_SPODUMENE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_spodumene"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_BORAX = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_borax"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_MAGNESITE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_magnesite"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_BAUXITE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_bauxite"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_APATITE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_apatite"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_PHOSPHORITE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_phosphorite"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_GADOLINITE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_gadolinite"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_ILMENITE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_ilmenite"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_PATRONITE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_patronite"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_CHROMITE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_chromite"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_PYROLUSITE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_pyrolusite"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_COBALTITE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_cobaltite"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_GARNIERITE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_garnierite"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_ARSENOPYRITE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_arsenopyrite"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_CROOKESITE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_crookesite"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_LEPIDOLITE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_lepidolite"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_BASTNAESITE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_bastnaesite"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_TANTALITE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_tantalite"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_MOLYBDENITE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_molybdenite"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_PENTLANDITE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_pentlandite"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_ARGENTITE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_argentite"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_GALENA = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_galena"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_SYLVANITE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_sylvanite"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_CASSITERITE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_cassiterite"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_WOLFRAMITE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_wolframite"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_OSMIRIDIUM = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_osmiridium"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_PLATINUM = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_platinum"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_CINNABAR = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_cinnabar"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_THORIANITE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_thorianite"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_URANINITE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_uraninite"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_EMERALD = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_emerald"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_RUBY = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_ruby"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_SAPPHIRE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_sapphire"));
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_TOPAZ = ResourceKey.create(Registries.CONFIGURED_FEATURE, new TechnologicaLocation("ore_topaz"));
