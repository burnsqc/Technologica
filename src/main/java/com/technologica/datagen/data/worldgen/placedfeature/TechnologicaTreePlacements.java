...
public class TechnologicaTreePlacements {
	public static final ResourceKey<PlacedFeature> APRICOT_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("apricot_checked"));
	public static final ResourceKey<PlacedFeature> ASPEN_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("aspen_checked"));
	public static final ResourceKey<PlacedFeature> AVOCADO_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("avocado_checked"));
	public static final ResourceKey<PlacedFeature> BANANA_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("banana_checked"));
	public static final ResourceKey<PlacedFeature> CHERRY_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("cherry_checked"));
	public static final ResourceKey<PlacedFeature> CHESTNUT_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("chestnut_checked"));
	public static final ResourceKey<PlacedFeature> CINNAMON_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("cinnamon_checked"));
	public static final ResourceKey<PlacedFeature> COCONUT_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("coconut_checked"));
	public static final ResourceKey<PlacedFeature> EBONY_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ebony_checked"));
	public static final ResourceKey<PlacedFeature> KIWI_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("kiwi_checked"));
	public static final ResourceKey<PlacedFeature> LEMON_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("lemon_checked"));
	public static final ResourceKey<PlacedFeature> LIME_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("lime_checked"));
	public static final ResourceKey<PlacedFeature> MAHOGANY_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("mahogany_checked"));
	public static final ResourceKey<PlacedFeature> MAPLE_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("maple_checked"));
	public static final ResourceKey<PlacedFeature> OLIVE_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("olive_checked"));
	public static final ResourceKey<PlacedFeature> ORANGE_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("orange_checked"));
	public static final ResourceKey<PlacedFeature> PEACH_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("peach_checked"));
	public static final ResourceKey<PlacedFeature> PEAR_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("pear_checked"));
	public static final ResourceKey<PlacedFeature> PLUM_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("pulm_checked"));
	public static final ResourceKey<PlacedFeature> REDWOOD_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("redwood_checked"));
	public static final ResourceKey<PlacedFeature> ROSEWOOD_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("rosewood_checked"));
	public static final ResourceKey<PlacedFeature> RUBBER_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("rubber_checked"));
	public static final ResourceKey<PlacedFeature> TEAK_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("teak_checked"));
	public static final ResourceKey<PlacedFeature> WALNUT_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("walnut_checked"));
	public static final ResourceKey<PlacedFeature> ZEBRAWOOD_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("zebrawood_checked"));
	public static final ResourceKey<PlacedFeature> ANCIENT_AMBROSIA_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ancient_ambrosia_checked"));
	public static final ResourceKey<PlacedFeature> BENEVOLENT_APOTHECARY_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("benevolent_apothecary_checked"));
	public static final ResourceKey<PlacedFeature> CRYOGENIC_SPIRE_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("cryogenic_spire_checked"));
	public static final ResourceKey<PlacedFeature> MALEVOLENT_APOTHECARY_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("malevolent_apothecary_checked"));
	public static final ResourceKey<PlacedFeature> NECROTIC_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("necrotic_checked"));
	public static final ResourceKey<PlacedFeature> SERENDIPITOUS_APOTHECARY_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("serendipitous_apothecary_checked"));
	public static final ResourceKey<PlacedFeature> THUNDEROUS_CONDUCTOR_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("thunderous_conductor_checked"));
	public static final ResourceKey<PlacedFeature> TOWERING_INFERNO_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("towering_inferno_checked"));
	public static final ResourceKey<PlacedFeature> OVERGROWTH_CHECKED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("overgrowth_checked"));
