...
import com.technologica.datagen.data.worldgen.configuredfeature.TechnologicaOreFeatures;
...
public class TechnologicaOrePlacements {
	public static final ResourceKey<PlacedFeature> ORE_SPODUMENE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_spodumene"));
	public static final ResourceKey<PlacedFeature> ORE_BORAX_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_borax"));
	public static final ResourceKey<PlacedFeature> ORE_MAGNESITE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_magnesite"));
	public static final ResourceKey<PlacedFeature> ORE_BAUXITE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_bauxite"));
	public static final ResourceKey<PlacedFeature> ORE_APATITE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_apatite"));
	public static final ResourceKey<PlacedFeature> ORE_PHOSPHORITE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_phosphorite"));
	public static final ResourceKey<PlacedFeature> ORE_GADOLINITE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_gadolinite"));
	public static final ResourceKey<PlacedFeature> ORE_ILMENITE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_ilmenite"));
	public static final ResourceKey<PlacedFeature> ORE_PATRONITE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_patronite"));
	public static final ResourceKey<PlacedFeature> ORE_CHROMITE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_chromite"));
	public static final ResourceKey<PlacedFeature> ORE_PYROLUSITE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_pyrolusite"));
	public static final ResourceKey<PlacedFeature> ORE_COBALTITE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_cobaltite"));
	public static final ResourceKey<PlacedFeature> ORE_GARNIERITE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_garnierite"));
	public static final ResourceKey<PlacedFeature> ORE_ARSENOPYRITE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_arsenopyrite"));
	public static final ResourceKey<PlacedFeature> ORE_CROOKESITE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_crookesite"));
	public static final ResourceKey<PlacedFeature> ORE_LEPIDOLITE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_lepidolite"));
	public static final ResourceKey<PlacedFeature> ORE_BASTNAESITE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_bastnaesite"));
	public static final ResourceKey<PlacedFeature> ORE_TANTALITE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_tantalite"));
	public static final ResourceKey<PlacedFeature> ORE_MOLYBDENITE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_molybdenite"));
	public static final ResourceKey<PlacedFeature> ORE_PENTLANDITE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_pentlandite"));
	public static final ResourceKey<PlacedFeature> ORE_ARGENTITE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_argentite"));
	public static final ResourceKey<PlacedFeature> ORE_GALENA_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_galena"));
	public static final ResourceKey<PlacedFeature> ORE_SYLVANITE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_sylvanite"));
	public static final ResourceKey<PlacedFeature> ORE_CASSITERITE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_cassiterite"));
	public static final ResourceKey<PlacedFeature> ORE_WOLFRAMITE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_wolframite"));
	public static final ResourceKey<PlacedFeature> ORE_OSMIRIDIUM_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_osmiridium"));
	public static final ResourceKey<PlacedFeature> ORE_PLATINUM_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_platinum"));
	public static final ResourceKey<PlacedFeature> ORE_CINNABAR_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_cinnabar"));
	public static final ResourceKey<PlacedFeature> ORE_THORIANITE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_thorianite"));
	public static final ResourceKey<PlacedFeature> ORE_URANINITE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_uraninite"));
	public static final ResourceKey<PlacedFeature> ORE_EMERALD_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_emerald"));
	public static final ResourceKey<PlacedFeature> ORE_RUBY_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_ruby"));
	public static final ResourceKey<PlacedFeature> ORE_SAPPHIRE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_sapphire"));
	public static final ResourceKey<PlacedFeature> ORE_TOPAZ_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new TechnologicaLocation("ore_topaz"));
