...
public class StructureDataGenerator {
	public static void bootstrap(BootstapContext<Structure> boostrapContextIn) {
		...
		boostrapContextIn.register(TechnologicaBuiltinStructures.EL_DORADO, new NetherFortressStructure(new Structure.StructureSettings(biomes.getOrThrow(TechnologicaBiomeTags.HAS_EL_DORADO), Map.of(MobCategory.MONSTER, new StructureSpawnOverride(StructureSpawnOverride.BoundingBoxType.PIECE, NetherFortressStructure.FORTRESS_ENEMIES)), GenerationStep.Decoration.UNDERGROUND_DECORATION, TerrainAdjustment.NONE)));
	}
}