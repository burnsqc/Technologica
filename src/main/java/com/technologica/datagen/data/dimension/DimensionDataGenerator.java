package com.technologica.datagen.data.dimension;
...
public class DimensionDataGenerator {
	...
	public static void bootstrap(BootstapContext<LevelStem> bootstrapContextIn) {
		...
		bootstrapContext.register(TechnologicaLevelStem.MOON_STEM, moon());
		bootstrapContext.register(TechnologicaLevelStem.CHALLENGER_DEEP_STEM, challengerDeep());
		bootstrapContext.register(TechnologicaLevelStem.OVERGROWTH_STEM, overgrowth());
	}

	private static LevelStem moon() {
		return dimension(TechnologicaBuiltinDimensionTypes.MOON, chunkGenerator("noise", new BiomeSourceBuilder("multi_noise").add(biome(TechnologicaBiomes.SILENT_EXPANSES, parameters(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F))).add(biome(TechnologicaBiomes.CRATER_FIELDS, parameters(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F))).add(biome(TechnologicaBiomes.SHATTERED_CORRIDORS, parameters(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F))).build(), TechnologicaNoiseGeneratorSettings.MOON));
	}

	private static LevelStem challengerDeep() {
		return dimension(TechnologicaBuiltinDimensionTypes.CHALLENGER_DEEP, chunkGenerator("noise", new BiomeSourceBuilder("multi_noise").add(biome(TechnologicaBiomes.MISTY_MIRE, parameters(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F))).add(biome(TechnologicaBiomes.CRATER_FIELDS, parameters(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F))).build(), TechnologicaNoiseGeneratorSettings.CHALLENGER_DEEP));
	}

	private static LevelStem overgrowth() {
		return dimension(TechnologicaBuiltinDimensionTypes.OVERGROWTH, chunkGenerator("noise", new BiomeSourceBuilder("multi_noise").add(biome(TechnologicaBiomes.MISTY_MIRE, parameters(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F))).add(biome(TechnologicaBiomes.BRAMBLE, parameters(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F))).build(), TechnologicaNoiseGeneratorSettings.OVERGROWTH));
	}
