...
public class ModTileEntities {
	...
	public static final RegistryObject<TileEntityType<SignTileEntity>> SIGN = TILEENTITIES.register("sign", () -> TileEntityType.Builder.create(SignTileEntity::new, ModBlocks.BANANA_SIGN.get(), ModBlocks.CHERRY_SIGN.get(), ModBlocks.COCONUT_SIGN.get(), ModBlocks.KIWI_SIGN.get(), ModBlocks.LEMON_SIGN.get(), ModBlocks.LIME_SIGN.get(), ModBlocks.ORANGE_SIGN.get(), ModBlocks.PEACH_SIGN.get(), ModBlocks.PEAR_SIGN.get(), ModBlocks.BANANA_WALL_SIGN.get(), ModBlocks.CHERRY_WALL_SIGN.get(), ModBlocks.COCONUT_WALL_SIGN.get(), ModBlocks.KIWI_WALL_SIGN.get(), ModBlocks.LEMON_WALL_SIGN.get(), ModBlocks.LIME_WALL_SIGN.get(), ModBlocks.ORANGE_WALL_SIGN.get(), ModBlocks.PEACH_WALL_SIGN.get(), ModBlocks.PEAR_WALL_SIGN.get()).build(null));
