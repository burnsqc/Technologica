...
public class ModTileEntities {
	...
	public static final RegistryObject<TileEntityType<FruitTileEntity>> FRUIT_CROP = TILEENTITIES.register("fruit_crop",
			() -> TileEntityType.Builder.create(FruitTileEntity::new, ModBlocks.BANANA_LEAVES.get(),
					ModBlocks.CHERRY_LEAVES.get(), ModBlocks.COCONUT_LEAVES.get(), ModBlocks.KIWI_LEAVES.get(),
					ModBlocks.LEMON_LEAVES.get(), ModBlocks.LIME_LEAVES.get(), ModBlocks.ORANGE_LEAVES.get(),
					ModBlocks.PEACH_LEAVES.get(), ModBlocks.PEAR_LEAVES.get(), ModBlocks.FRUITFUL_LEAVES.get(),
