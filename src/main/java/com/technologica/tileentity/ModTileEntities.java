...
public class ModTileEntities {
    ...
    public static final RegistryObject<TileEntityType<DriveShaftTileEntity>> DRIVE_SHAFT_TILE = TILEENTITIES.register("drive_shaft_tile", () -> TileEntityType.Builder.create(DriveShaftTileEntity::new, ModBlocks.DRIVE_SHAFT.get()).build(null));
