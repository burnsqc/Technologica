...
public class ModEntities {
	...
	public static final RegistryObject<EntityType<ModBoatEntity>> MOD_BOAT = ENTITIES.register("mod_boat", () -> EntityType.Builder.<ModBoatEntity>create(ModBoatEntity::new, EntityClassification.MISC).size(1.375F, 0.5625F).setCustomClientFactory((spawnEntity, world) -> new ModBoatEntity(world, 0, 0, 0)).trackingRange(10).build("mod_boat"));
    ...
    public static final RegistryObject<EntityType<ScorpionEntity>> SCORPION = ENTITIES.register("scorpion", () -> EntityType.Builder.<ScorpionEntity>create(ScorpionEntity::new, EntityClassification.CREATURE).size(0.9F, 0.6F).trackingRange(10).build("scorpion"));
