...
public class BeaverEntity extends AnimalEntity {
   ...
   public static boolean func_223321_c(EntityType<BeaverEntity> p_223321_0_, IWorld p_223321_1_, SpawnReason reason, BlockPos p_223321_3_, Random p_223321_4_) {
   ...
   static class AvoidEntityGoal<T extends LivingEntity> extends net.minecraft.entity.ai.goal.AvoidEntityGoal<T> {
      ...
      public AvoidEntityGoal(BeaverEntity rabbit, Class<T> p_i46403_2_, float p_i46403_3_, double p_i46403_4_, double p_i46403_6_) {
