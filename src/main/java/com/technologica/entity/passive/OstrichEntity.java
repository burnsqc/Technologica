...
//      if (otherAnimal == this) {
//         return false;
//      } else if (!(otherAnimal instanceof DonkeyEntity) && !(otherAnimal instanceof OstrichEntity)) {
//         return false;
...
//   }
   ...
   public AgeableEntity createChild(ServerWorld world, AgeableEntity mate) {
      ...
      if (mate instanceof DonkeyEntity) {
         ...
         OstrichEntity horseentity = (OstrichEntity)mate;
         ...
         ((OstrichEntity)abstracthorseentity).func_234238_a_(coatcolors, coattypes);
      }
   ...
   public ILivingEntityData onInitialSpawn(IServerWorld worldIn, DifficultyInstance difficultyIn, SpawnReason reason, @Nullable ILivingEntityData spawnDataIn, @Nullable CompoundNBT dataTag) {
      CoatColors coatcolors;
      if (spawnDataIn instanceof OstrichEntity.HorseData) {
         coatcolors = ((OstrichEntity.HorseData)spawnDataIn).variant;
      } else {
         coatcolors = Util.getRandomObject(CoatColors.values(), this.rand);
         spawnDataIn = new OstrichEntity.HorseData(coatcolors);
      }
