...
public class TechnologicaEntityType {
	...
	public static final RegistryObject<EntityType<GiraffeEntity>> GIRAFFE = ENTITIES.register("giraffe", () -> EntityType.Builder.<GiraffeEntity>create(GiraffeEntity::new, EntityClassification.CREATURE).size(1.4F, 3.0F).trackingRange(20).build("giraffe"));
	...
	public static final RegistryObject<EntityType<OstrichEntity>> OSTRICH = ENTITIES.register("ostrich", () -> EntityType.Builder.<OstrichEntity>create(OstrichEntity::new, EntityClassification.CREATURE).size(1.0F, 1.8F).trackingRange(10).build("ostrich"));
	...
	public static final RegistryObject<EntityType<PiranhaEntity>> PIRANHA = ENTITIES.register("piranha", () -> EntityType.Builder.<PiranhaEntity>create(PiranhaEntity::new, EntityClassification.WATER_AMBIENT).size(0.5F, 0.4F).trackingRange(10).build("piranha"));
	...
	public static final RegistryObject<EntityType<RaccoonEntity>> RACCOON = ENTITIES.register("raccoon", () -> EntityType.Builder.<RaccoonEntity>create(RaccoonEntity::new, EntityClassification.CREATURE).size(0.8F, 0.8F).trackingRange(10).build("raccoon"));
