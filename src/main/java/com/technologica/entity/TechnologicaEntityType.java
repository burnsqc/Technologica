...
public class TechnologicaEntityType {
	...
	public static final RegistryObject<EntityType<CamelEntity>> CAMEL = ENTITIES.register("camel", () -> EntityType.Builder.<CamelEntity>create(CamelEntity::new, EntityClassification.CREATURE).size(1.3964844F, 2.9F).trackingRange(10).build("camel"));
	...
	public static final RegistryObject<EntityType<PenguinEntity>> PENGUIN = ENTITIES.register("penguin", () -> EntityType.Builder.<PenguinEntity>create(PenguinEntity::new, EntityClassification.CREATURE).size(1.3964844F, 1.6F).trackingRange(10).build("penguin"));
