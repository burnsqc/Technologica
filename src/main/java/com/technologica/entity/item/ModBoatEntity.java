...
public class ModBoatEntity extends Entity {
	private static final DataParameter<Integer> TIME_SINCE_HIT = EntityDataManager.createKey(ModBoatEntity.class,
			DataSerializers.VARINT);
	private static final DataParameter<Integer> FORWARD_DIRECTION = EntityDataManager.createKey(ModBoatEntity.class,
			DataSerializers.VARINT);
	private static final DataParameter<Float> DAMAGE_TAKEN = EntityDataManager.createKey(ModBoatEntity.class,
			DataSerializers.FLOAT);
	private static final DataParameter<Integer> BOAT_TYPE = EntityDataManager.createKey(ModBoatEntity.class,
			DataSerializers.VARINT);
	private static final DataParameter<Boolean> LEFT_PADDLE = EntityDataManager.createKey(ModBoatEntity.class,
			DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> RIGHT_PADDLE = EntityDataManager.createKey(ModBoatEntity.class,
			DataSerializers.BOOLEAN);
	private static final DataParameter<Integer> ROCKING_TICKS = EntityDataManager.createKey(ModBoatEntity.class,
			DataSerializers.VARINT);
	...
	public void tick() {
		...
		if (this.status != ModBoatEntity.Status.UNDER_WATER
				&& this.status != ModBoatEntity.Status.UNDER_FLOWING_WATER) {
	...
	private void updateMotion() {
		...
		double d2 = 0.0D;
		this.momentum = 0.05F;
		if (this.previousStatus == ModBoatEntity.Status.IN_AIR && this.status != ModBoatEntity.Status.IN_AIR
				&& this.status != ModBoatEntity.Status.ON_LAND) {
	...
	public boolean canSwim() {
		return this.status == ModBoatEntity.Status.UNDER_WATER
				|| this.status == ModBoatEntity.Status.UNDER_FLOWING_WATER;
	}
	...
	public static enum Type {
		...
		AVOCADO(ModBlocks.AVOCADO_PLANKS.get(), "avocado"), 
		...
		KIWI(ModBlocks.KIWI_PLANKS.get(), "kiwi"),
		...
		ROSEWOOD(ModBlocks.ROSEWOOD_PLANKS.get(), "rosewood"),
		RUBBER(ModBlocks.RUBBER_PLANKS.get(), "rubber"),
		TEAK(ModBlocks.TEAK_PLANKS.get(), "teak"),
		WALNUT(ModBlocks.WALNUT_PLANKS.get(), "walnut"),
		ZEBRAWOOD(ModBlocks.ZEBRAWOOD_PLANKS.get(), "zebrawood"),
		ALCHEMICAL(ModBlocks.ALCHEMICAL_PLANKS.get(), "alchemical"),
		BENEVOLENT(ModBlocks.BENEVOLENT_PLANKS.get(), "benevolent"),
		CONDUCTIVE(ModBlocks.CONDUCTIVE_PLANKS.get(), "conductive"),
		FROSTBITTEN(ModBlocks.FROSTBITTEN_PLANKS.get(), "frostbitten"),
		FRUITFUL(ModBlocks.FRUITFUL_PLANKS.get(), "fruitful"),
		INFERNAL(ModBlocks.INFERNAL_PLANKS.get(), "infernal"),
		MALEVOLENT(ModBlocks.MALEVOLENT_PLANKS.get(), "malevolent");
