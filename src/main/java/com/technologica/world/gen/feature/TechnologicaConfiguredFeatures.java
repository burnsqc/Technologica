...
public class TechnologicaConfiguredFeatures {
	...
	public static final ConfiguredFeature<?, ?> CRATER_FEATURE = register("crater_feature", TechnologicaFeatures.CRATER.get().withConfiguration(new BlockStateFeatureConfig(Blocks.AIR.getDefaultState())).withPlacement(Placement.WATER_LAKE.configure(new ChanceConfig(2))));
