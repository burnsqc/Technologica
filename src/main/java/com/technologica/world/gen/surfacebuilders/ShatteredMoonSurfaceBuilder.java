...
public class ShatteredMoonSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {
   public ShatteredMoonSurfaceBuilder(Codec<SurfaceBuilderConfig> codec) {
      super(codec);
   }
