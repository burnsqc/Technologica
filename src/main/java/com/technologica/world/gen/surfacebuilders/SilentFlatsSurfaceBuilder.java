...
public class SilentFlatsSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {
   ...
   public void apply(Random random, IChunk chunkIn, Biome biomeIn, int x, int z, int startHeight, double noise, BlockState defaultBlock, BlockState defaultFluid, int seaLevel, long seed, SurfaceBuilderConfig config) {
	   ...
	   SurfaceBuilderConfig config1 = new SurfaceBuilderConfig(TechnologicaBlocks.MOON_DUST.get().defaultBlockState(), TechnologicaBlocks.MOON_DUST.get().defaultBlockState(), TechnologicaBlocks.MOON_DUST.get().defaultBlockState());
