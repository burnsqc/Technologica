...
public class ElDoradoStructure extends Structure {
	...
	public static final Codec<ElDoradoStructure> CODEC = simpleCodec(ElDoradoStructure::new);

	public ElDoradoStructure(Structure.StructureSettings p_228521_) {
		super(p_228521_);
	}
	...
	private static void generatePieces(StructurePiecesBuilder p_228528_, Structure.GenerationContext p_228529_) {
		ElDoradoPieces.StartPiece netherfortresspieces$startpiece = new ElDoradoPieces.StartPiece(p_228529_.random(), p_228529_.chunkPos().getBlockX(2), p_228529_.chunkPos().getBlockZ(2));
