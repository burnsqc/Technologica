...
public class NavalMineEntity extends Entity {
	private static final EntityDataAccessor<Integer> FUSE = SynchedEntityData.defineId(NavalMineEntity.class, EntityDataSerializers.INT);
	private static final EntityDataAccessor<Boolean> DETONATE = SynchedEntityData.defineId(NavalMineEntity.class, EntityDataSerializers.BOOLEAN);
	private static final EntityDataAccessor<Integer> CHAINS = SynchedEntityData.defineId(NavalMineEntity.class, EntityDataSerializers.INT);
	private int armingFuse = 100;
	private boolean detonate = false;
	private int chains = 10;

	public NavalMineEntity(EntityType<? extends NavalMineEntity> type, Level worldIn) {
		super(type, worldIn);
		this.blocksBuilding = true;
	}

	public NavalMineEntity(Level worldIn, double x, double y, double z) {
