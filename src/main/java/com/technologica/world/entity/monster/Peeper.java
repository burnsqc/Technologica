...
public class Peeper extends Monster implements PowerableMob {
	private static final EntityDataAccessor<Integer> STATE = SynchedEntityData.defineId(Peeper.class, EntityDataSerializers.INT);
	private static final EntityDataAccessor<Boolean> POWERED = SynchedEntityData.defineId(Peeper.class, EntityDataSerializers.BOOLEAN);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		if (entity != this && entity instanceof Peeper) {
			Peeper creeperentity = (Peeper) entity;
