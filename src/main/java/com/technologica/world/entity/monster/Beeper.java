...
public class Beeper extends Monster implements PowerableMob {
	private static final EntityDataAccessor<Integer> STATE = SynchedEntityData.defineId(Beeper.class, EntityDataSerializers.INT);
	private static final EntityDataAccessor<Boolean> POWERED = SynchedEntityData.defineId(Beeper.class, EntityDataSerializers.BOOLEAN);
	private int droppedSkulls;

	public Beeper(EntityType<? extends Beeper> type, Level worldIn) {
		super(type, worldIn);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		if (entity != this && entity instanceof Beeper) {
			Beeper creeperentity = (Beeper) entity;
