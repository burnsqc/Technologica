...
public class PeeperEntity extends Monster implements PowerableMob {
	private static final EntityDataAccessor<Integer> STATE = SynchedEntityData.defineId(PeeperEntity.class, EntityDataSerializers.INT);
	private static final EntityDataAccessor<Boolean> POWERED = SynchedEntityData.defineId(PeeperEntity.class, EntityDataSerializers.BOOLEAN);
	private int droppedSkulls;

	public PeeperEntity(EntityType<? extends PeeperEntity> type, Level worldIn) {
		super(type, worldIn);
	}
