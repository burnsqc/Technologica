...
import com.technologica.world.entity.ai.goal.TechnologicaSwellGoal;
...
public class AtomicCreeper extends Monster implements PowerableMob {
	private static final EntityDataAccessor<Integer> DATA_SWELL_DIR = SynchedEntityData.defineId(AtomicCreeper.class, EntityDataSerializers.INT);
	private static final EntityDataAccessor<Boolean> DATA_IS_POWERED = SynchedEntityData.defineId(AtomicCreeper.class, EntityDataSerializers.BOOLEAN);
	private static final EntityDataAccessor<Boolean> DATA_IS_IGNITED = SynchedEntityData.defineId(AtomicCreeper.class, EntityDataSerializers.BOOLEAN);
	private int oldSwell;
	private int swell;
	private int maxSwell = 200;
	private int explosionRadius = 3;
	private int droppedSkulls;

	public AtomicCreeper(EntityType<? extends AtomicCreeper> p_32278_, Level p_32279_) {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new TechnologicaSwellGoal(this));
	...
	protected void dropCustomDeathLoot(DamageSource p_32292_, int p_32293_, boolean p_32294_) {
		...
		if (entity != this && entity instanceof AtomicCreeper creeper) {
