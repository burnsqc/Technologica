...
import com.technologica.world.entity.ai.PickupItemGoal;
...
public class SweeperEntity extends Monster {
	private static final EntityDataAccessor<Integer> STATE = SynchedEntityData.defineId(SweeperEntity.class, EntityDataSerializers.INT);
	private static final EntityDataAccessor<Boolean> POWERED = SynchedEntityData.defineId(SweeperEntity.class, EntityDataSerializers.BOOLEAN);
	private static final EntityDataAccessor<Boolean> IGNITED = SynchedEntityData.defineId(SweeperEntity.class, EntityDataSerializers.BOOLEAN);

	private int droppedSkulls;

	public SweeperEntity(EntityType<? extends SweeperEntity> type, Level worldIn) {
		super(type, worldIn);
	}
