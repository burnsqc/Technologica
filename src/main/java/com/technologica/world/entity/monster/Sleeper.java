...
public class Sleeper extends Monster implements PowerableMob {
	private static final EntityDataAccessor<Integer> STATE = SynchedEntityData.defineId(Sleeper.class, EntityDataSerializers.INT);
	private static final EntityDataAccessor<Boolean> POWERED = SynchedEntityData.defineId(Sleeper.class, EntityDataSerializers.BOOLEAN);
	private int droppedSkulls;

	public Sleeper(EntityType<? extends Sleeper> type, Level worldIn) {
		super(type, worldIn);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		if (entity != this && entity instanceof Sleeper) {
			Sleeper creeperentity = (Sleeper) entity;
