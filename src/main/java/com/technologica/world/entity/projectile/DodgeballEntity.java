...
public class DodgeballEntity extends ThrowableItemProjectile {
	private String message = "";
	
	public DodgeballEntity(EntityType<? extends DodgeballEntity> p_i50159_1_, Level p_i50159_2_) {
		super(p_i50159_1_, p_i50159_2_);
	}

	public DodgeballEntity(Level worldIn, LivingEntity throwerIn) {
		super(TechnologicaEntityType.DODGEBALL.get(), throwerIn, worldIn);
	}

	public DodgeballEntity(Level worldIn, double x, double y, double z) {
