...
public class CoconutEntity extends ThrowableItemProjectile {
	...
	public CoconutEntity(EntityType<? extends CoconutEntity> p_i50159_1_, Level p_i50159_2_) {
		super(p_i50159_1_, p_i50159_2_);
	}

	public CoconutEntity(Level worldIn, LivingEntity throwerIn) {
		super(TechnologicaEntityType.COCONUT.get(), throwerIn, worldIn);
	}

	public CoconutEntity(Level worldIn, double x, double y, double z) {
