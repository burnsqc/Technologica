...
public class TechnologicaEntityType {
	...
	public static final RegistryObject<EntityType<Buffalo>> BUFFALO = ENTITY_TYPES.register("buffalo", () -> EntityType.Builder.<Buffalo>of(Buffalo::new, MobCategory.CREATURE).sized(0.4F, 0.7F).clientTrackingRange(10).build("buffalo"));
	public static final RegistryObject<EntityType<Camel>> CAMEL = ENTITY_TYPES.register("camel", () -> EntityType.Builder.<Camel>of(Camel::new, MobCategory.CREATURE).sized(1.3964844F, 2.0F).clientTrackingRange(10).build("camel"));
	public static final RegistryObject<EntityType<Cobra>> COBRA = ENTITY_TYPES.register("cobra", () -> EntityType.Builder.<Cobra>of(Cobra::new, MobCategory.CREATURE).sized(0.4F, 0.7F).clientTrackingRange(10).build("cobra"));
	public static final RegistryObject<EntityType<Cottonmouth>> COTTONMOUTH = ENTITY_TYPES.register("cottonmouth", () -> EntityType.Builder.<Cottonmouth>of(Cottonmouth::new, MobCategory.CREATURE).sized(0.4F, 0.7F).clientTrackingRange(10).build("cottonmouth"));
	public static final RegistryObject<EntityType<Coyote>> COYOTE = ENTITY_TYPES.register("coyote", () -> EntityType.Builder.<Coyote>of(Coyote::new, MobCategory.CREATURE).sized(0.4F, 0.7F).clientTrackingRange(10).build("coyote"));
	public static final RegistryObject<EntityType<Crab>> CRAB = ENTITY_TYPES.register("crab", () -> EntityType.Builder.<Crab>of(Crab::new, MobCategory.CREATURE).sized(0.4F, 0.7F).clientTrackingRange(10).build("crab"));
	public static final RegistryObject<EntityType<Deer>> DEER = ENTITY_TYPES.register("deer", () -> EntityType.Builder.<Deer>of(Deer::new, MobCategory.CREATURE).sized(0.4F, 0.7F).clientTrackingRange(10).build("deer"));
	...
	public static final RegistryObject<EntityType<Jaguar>> JAGUAR = ENTITY_TYPES.register("jaguar", () -> EntityType.Builder.<Jaguar>of(Jaguar::new, MobCategory.CREATURE).sized(0.4F, 0.7F).clientTrackingRange(10).build("jaguar"));
	public static final RegistryObject<EntityType<KingCrab>> KING_CRAB = ENTITY_TYPES.register("king_crab", () -> EntityType.Builder.<KingCrab>of(KingCrab::new, MobCategory.CREATURE).sized(0.4F, 0.7F).clientTrackingRange(10).build("king_crab"));
	public static final RegistryObject<EntityType<LeopardSeal>> LEOPARD_SEAL = ENTITY_TYPES.register("leopard_seal", () -> EntityType.Builder.<LeopardSeal>of(LeopardSeal::new, MobCategory.CREATURE).sized(0.4F, 0.7F).clientTrackingRange(10).build("leopard_seal"));
	public static final RegistryObject<EntityType<Lion>> LION = ENTITY_TYPES.register("lion", () -> EntityType.Builder.<Lion>of(Lion::new, MobCategory.CREATURE).sized(0.4F, 0.7F).clientTrackingRange(10).build("lion"));
	public static final RegistryObject<EntityType<Lizard>> LIZARD = ENTITY_TYPES.register("lizard", () -> EntityType.Builder.<Lizard>of(Lizard::new, MobCategory.CREATURE).sized(0.4F, 0.7F).clientTrackingRange(10).build("lizard"));
	public static final RegistryObject<EntityType<Moose>> MOOSE = ENTITY_TYPES.register("moose", () -> EntityType.Builder.<Moose>of(Moose::new, MobCategory.CREATURE).sized(0.4F, 0.7F).clientTrackingRange(10).build("moose"));
	public static final RegistryObject<EntityType<Narwhal>> NARWHAL = ENTITY_TYPES.register("narwhal", () -> EntityType.Builder.<Narwhal>of(Narwhal::new, MobCategory.CREATURE).sized(0.4F, 0.7F).clientTrackingRange(10).build("narwhal"));
	public static final RegistryObject<EntityType<Octopus>> OCTOPUS = ENTITY_TYPES.register("octopus", () -> EntityType.Builder.<Octopus>of(Octopus::new, MobCategory.CREATURE).sized(0.4F, 0.7F).clientTrackingRange(10).build("octopus"));
	public static final RegistryObject<EntityType<Ostrich>> OSTRICH = ENTITY_TYPES.register("ostrich", () -> EntityType.Builder.<Ostrich>of(Ostrich::new, MobCategory.CREATURE).sized(1.0F, 1.8F).clientTrackingRange(10).build("ostrich"));
	...
	public static final RegistryObject<EntityType<Penguin>> PENGUIN = ENTITY_TYPES.register("penguin", () -> EntityType.Builder.<Penguin>of(Penguin::new, MobCategory.CREATURE).sized(1.0F, 1.625F).clientTrackingRange(10).build("penguin"));
	public static final RegistryObject<EntityType<Piranha>> PIRANHA = ENTITY_TYPES.register("piranha", () -> EntityType.Builder.<Piranha>of(Piranha::new, MobCategory.WATER_AMBIENT).sized(0.5F, 0.4F).clientTrackingRange(10).build("piranha"));
	public static final RegistryObject<EntityType<PoisonDartFrog>> POISON_DART_FROG = ENTITY_TYPES.register("poison_dart_frog", () -> EntityType.Builder.<PoisonDartFrog>of(PoisonDartFrog::new, MobCategory.CREATURE).sized(0.4F, 0.7F).clientTrackingRange(10).build("poison_dart_frog"));
	public static final RegistryObject<EntityType<Raccoon>> RACCOON = ENTITY_TYPES.register("raccoon", () -> EntityType.Builder.<Raccoon>of(Raccoon::new, MobCategory.CREATURE).sized(0.8F, 0.8F).clientTrackingRange(10).build("raccoon"));
	public static final RegistryObject<EntityType<Scorpion>> SCORPION = ENTITY_TYPES.register("scorpion", () -> EntityType.Builder.<Scorpion>of(Scorpion::new, MobCategory.CREATURE).sized(0.9F, 1.0F).clientTrackingRange(10).build("scorpion"));
	public static final RegistryObject<EntityType<Shark>> SHARK = ENTITY_TYPES.register("shark", () -> EntityType.Builder.<Shark>of(Shark::new, MobCategory.CREATURE).sized(0.9F, 0.6F).clientTrackingRange(10).build("shark"));
	public static final RegistryObject<EntityType<Sloth>> SLOTH = ENTITY_TYPES.register("sloth", () -> EntityType.Builder.<Sloth>of(Sloth::new, MobCategory.CREATURE).sized(0.4F, 0.7F).clientTrackingRange(10).build("sloth"));
	public static final RegistryObject<EntityType<Stingray>> STINGRAY = ENTITY_TYPES.register("stingray", () -> EntityType.Builder.<Stingray>of(Stingray::new, MobCategory.CREATURE).sized(0.4F, 0.7F).clientTrackingRange(10).build("stingray"));
	public static final RegistryObject<EntityType<Turkey>> TURKEY = ENTITY_TYPES.register("turkey", () -> EntityType.Builder.<Turkey>of(Turkey::new, MobCategory.CREATURE).sized(0.4F, 0.7F).clientTrackingRange(10).build("turkey"));
