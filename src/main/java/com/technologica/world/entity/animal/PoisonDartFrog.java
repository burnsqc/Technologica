...
public class PoisonDartFrog extends Animal implements VariantHolder<FrogVariant> {
	public static final Ingredient TEMPTATION_ITEM = Ingredient.of(Items.SLIME_BALL);
	protected static final ImmutableList<SensorType<? extends Sensor<? super PoisonDartFrog>>> SENSOR_TYPES = ImmutableList.of(SensorType.NEAREST_LIVING_ENTITIES, SensorType.HURT_BY, SensorType.FROG_ATTACKABLES, SensorType.FROG_TEMPTATIONS, SensorType.IS_IN_WATER);
	...
	private static final EntityDataAccessor<FrogVariant> DATA_VARIANT_ID = SynchedEntityData.defineId(PoisonDartFrog.class, EntityDataSerializers.FROG_VARIANT);
	private static final EntityDataAccessor<OptionalInt> DATA_TONGUE_TARGET_ID = SynchedEntityData.defineId(PoisonDartFrog.class, EntityDataSerializers.OPTIONAL_UNSIGNED_INT);
	...
	public PoisonDartFrog(EntityType<? extends Animal> p_218470_, Level p_218471_) {
		super(p_218470_, p_218471_);
		this.lookControl = new PoisonDartFrog.FrogLookControl(this);
	...
	@Override
	protected Brain.Provider<PoisonDartFrog> brainProvider() {
		return Brain.provider(MEMORY_TYPES, SENSOR_TYPES);
	}

	@Override
	protected Brain<?> makeBrain(Dynamic<?> p_218494_) {
		return PoisonDartFrogAi.makeBrain(this.brainProvider().makeBrain(p_218494_));
	}

	@SuppressWarnings("unchecked")
	@Override
	public Brain<PoisonDartFrog> getBrain() {
		return (Brain<PoisonDartFrog>) super.getBrain();
	}
	...
	protected void customServerAiStep() {
		...
		PoisonDartFrogAi.updateActivity(this);
		this.level().getProfiler().pop();
	...
	public void tick() {
		...
		for (Entity entry : list) {
			if (entry instanceof LivingEntity livingEntity) {
				MobEffect mobeffect = TechnologicaMobEffects.HALLUCINIATION.get();
				MobEffectInstance instance = new MobEffectInstance(mobeffect, 200, 0);
	...
	public AgeableMob getBreedOffspring(ServerLevel p_218476_, AgeableMob p_218477_) {
		PoisonDartFrog frog = TechnologicaEntityTypes.POISON_DART_FROG.get().create(p_218476_);
		if (frog != null) {
			PoisonDartFrogAi.initMemories(frog, p_218476_.getRandom());
		}
	...
	protected PathNavigation createNavigation(Level p_218486_) {
		return new PoisonDartFrog.FrogPathNavigation(this, p_218486_);
	}
	...
	class FrogLookControl extends LookControl {
		...
		protected boolean resetXRotOnTick() {
			return PoisonDartFrog.this.getTongueTarget().isEmpty();
		}
	}
	...
	static class FrogPathNavigation extends AmphibiousPathNavigation {
		FrogPathNavigation(PoisonDartFrog p_218556_, Level p_218557_) {
		...
		protected PathFinder createPathFinder(int p_218559_) {
			this.nodeEvaluator = new PoisonDartFrog.FrogNodeEvaluator(true);
