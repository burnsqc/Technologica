...
public class Stingray extends WaterAnimal implements NeutralMob {
	private static final EntityDataAccessor<Integer> MOISTNESS = SynchedEntityData.defineId(Stingray.class, EntityDataSerializers.INT);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new Stingray.AttackGoal());
	...
	class AttackGoal extends net.minecraft.world.entity.ai.goal.MeleeAttackGoal {
		public AttackGoal() {
			super(Stingray.this, 1.50D, true);
		}
