...
public class Elephant extends AbstractPackAnimal {
	public int tailCounter;
	public int earCounter;

	public Elephant(EntityType<? extends Elephant> entity, Level level) {
		super(entity, level);
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(1, new Elephant.ElephantHurtByTargetGoal());
	}
	...
	class ElephantHurtByTargetGoal extends HurtByTargetGoal {
		...
		protected void alertOther(Mob mob, LivingEntity p_29581_) {
			if (mob instanceof Elephant && !mob.isBaby()) {
