...
public class GrizzlyBearEntity extends PolarBear implements NeutralMob {
	private static final Ingredient TEMPTATION_ITEMS = Ingredient.of(Items.SALMON);
	private static final EntityDataAccessor<Boolean> IS_STANDING = SynchedEntityData.defineId(GrizzlyBearEntity.class, EntityDataSerializers.BOOLEAN);
	...
	public GrizzlyBearEntity(EntityType<GrizzlyBearEntity> type, Level worldIn) {
		super(type, worldIn);
	}
