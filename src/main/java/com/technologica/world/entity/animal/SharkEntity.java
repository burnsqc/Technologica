...
public class SharkEntity extends WaterAnimal implements NeutralMob {
	private static final EntityDataAccessor<Integer> MOISTNESS = SynchedEntityData.defineId(SharkEntity.class, EntityDataSerializers.INT);
	...
	public static boolean checkDolphinSpawnRules(EntityType<SharkEntity> p_223364_0_, Level p_223364_1_,
