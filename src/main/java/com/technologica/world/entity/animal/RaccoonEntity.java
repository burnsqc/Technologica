...
public class RaccoonEntity extends Animal {
	private static final EntityDataAccessor<Boolean> BEGGING = SynchedEntityData.defineId(RaccoonEntity.class, EntityDataSerializers.BOOLEAN);

	public RaccoonEntity(EntityType<? extends RaccoonEntity> type, Level worldIn) {
		super(type, worldIn);
