...
public class KingCrabEntity extends Animal {

	public KingCrabEntity(EntityType<? extends KingCrabEntity> type, Level worldIn) {
		super(type, worldIn);
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor worldIn, DifficultyInstance difficultyIn, MobSpawnType reason,
		...
		if (spawnDataIn instanceof ScorpionEntity.GroupData) {
			MobEffect effect = ((ScorpionEntity.GroupData) spawnDataIn).effect;
			if (effect != null) {
