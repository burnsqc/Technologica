	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		consumer.accept(new IClientItemExtensions() {
			...
			public BlockEntityWithoutLevelRenderer getCustomRenderer() {
				return new MultiGlintRenderer(Minecraft.getInstance().getBlockEntityRenderDispatcher(), Minecraft.getInstance().getEntityModels(), BASE_MODEL_LOCATION, TechnologicaRenderType.SUBMERSION);
			}
		});
	}
