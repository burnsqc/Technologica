...
import com.technologica.client.renderer.blockentity.SubmersionRenderer;
...
public class Submersion extends Item {
	private ResourceLocation BASE_MODEL_LOCATION;

	public Submersion(Properties properties, String name) {
		super(properties);
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		consumer.accept(new IClientItemExtensions() {
			...
			public BlockEntityWithoutLevelRenderer getCustomRenderer() {
				return new SubmersionRenderer(Minecraft.getInstance().getBlockEntityRenderDispatcher(), Minecraft.getInstance().getEntityModels(), BASE_MODEL_LOCATION);
			}
		});
	}
