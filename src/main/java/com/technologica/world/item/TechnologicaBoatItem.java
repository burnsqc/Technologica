...
public class TechnologicaBoatItem extends Item {
	private static final Predicate<Entity> ENTITY_PREDICATE = EntitySelector.NO_SPECTATORS.and(Entity::isPickable);
	private final TechnologicaBoat.Type type;
	private final boolean hasChest;

	public TechnologicaBoatItem(boolean p_220013_, TechnologicaBoat.Type p_220014_, Item.Properties p_220015_) {
		super(p_220015_);
	...
	public InteractionResultHolder<ItemStack> use(Level p_40622_, Player p_40623_, InteractionHand p_40624_) {
		...
		if (hitresult.getType() == HitResult.Type.MISS) {
			...
			if (hitresult.getType() == HitResult.Type.BLOCK) {
				...
				if (boat instanceof TechnologicaBoat technologicaBoat) {
					technologicaBoat.setVariant(this.type);
				}
	...
	private Boat getBoat(Level p_220017_, HitResult p_220018_) {
		return this.hasChest ? new TechnologicaBoat(p_220017_, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z) : new TechnologicaBoat(p_220017_, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z);
	}
}