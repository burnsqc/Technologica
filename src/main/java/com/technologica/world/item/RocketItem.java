...
public class RocketItem extends Item {
	...
	private final Rocket.Type type;

	public RocketItem(Rocket.Type typeIn, Item.Properties properties) {
		super(properties);
		this.type = typeIn;
	}
	...
	public InteractionResultHolder<ItemStack> use(Level worldIn, Player playerIn, InteractionHand handIn) {
		...
		if (raytraceresult.getType() == HitResult.Type.MISS) {
			...
			if (raytraceresult.getType() == HitResult.Type.BLOCK) {
				Rocket modBoatEntity = new Rocket(worldIn, raytraceresult.getLocation().x, raytraceresult.getLocation().y, raytraceresult.getLocation().z);
