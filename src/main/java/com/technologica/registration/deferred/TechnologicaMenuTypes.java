...
public final class TechnologicaMenuTypes {
	...
	public static final RegistryObject<MenuType<DraftFurnaceMenu>> DRAFT_FURNACE = Technologica.MENU_TYPES.register("draft_furnace", () -> IForgeMenuType.create((windowId, inv, data) -> new DraftFurnaceMenu(windowId, inv.player.getCommandSenderWorld(), data.readBlockPos(), inv)));
}
