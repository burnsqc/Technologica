...
public final class TechnologicaEntityTypes extends MasterDeferredRegistrar {
	...
	public static final RegistryObject<EntityType<Narwhal>> NARWHAL = ENTITY_TYPES.register("narwhal", () -> EntityType.Builder.<Narwhal>of(Narwhal::new, MobCategory.WATER_CREATURE).sized(1.5F, 0.5F).clientTrackingRange(10).build("narwhal"));
	...
	public static final RegistryObject<EntityType<Shark>> SHARK = ENTITY_TYPES.register("shark", () -> EntityType.Builder.<Shark>of(Shark::new, TechnologicaMobCategory.SHARK).sized(2.0F, 0.8F).clientTrackingRange(10).build("shark"));
	...
	public static final RegistryObject<EntityType<NavalMine>> NAVAL_MINE = ENTITY_TYPES.register("naval_mine", () -> EntityType.Builder.<NavalMine>of(NavalMine::new, MobCategory.MISC).sized(2.0F, 2.0F).setCustomClientFactory((spawnEntity, world) -> new NavalMine(world, 0, 0, 0, 8)).clientTrackingRange(10).build("naval_mine_entity"));
