...
public final class TechnologicaDimensionTypes {
	...
	public static final ResourceKey<DimensionType> ABYSS = Technologica.DIMENSION_TYPES.register("abyss", () -> dimensionType(0.0F, true, 8.0D, TechnologicaDimensionTypes.ABYSS_EFFECTS, OptionalLong.of(18000L), true, false, false, 256, BlockTags.INFINIBURN_OVERWORLD, 128, 0, 0, UniformInt.of(0, 7), true, false, true, false));
