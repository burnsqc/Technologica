...
public final class TechnologicaDimensionTypes {
	...
	public static final ResourceKey<DimensionType> CHALLENGER_DEEP = Technologica.DIMENSION_TYPES.register("challenger_deep", () -> dimensionType(0.0F, true, 1.0D, TechnologicaDimensionTypes.CHALLENGER_DEEP_EFFECTS, OptionalLong.empty(), true, false, false, 256, BlockTags.INFINIBURN_OVERWORLD, 256, 0, 0, UniformInt.of(0, 7), true, false, false, false));
