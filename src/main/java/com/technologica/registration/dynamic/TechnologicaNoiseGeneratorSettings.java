...
public final class TechnologicaNoiseGeneratorSettings {
	...
	public static final ResourceKey<NoiseGeneratorSettings> ABYSS = Technologica.NOISE_GENERATOR_SETTINGS.register("abyss", () -> noiseSettings(
			false, 
			...
			TLNoiseRouterData.noiseRouter(
					...
					DensityFunctions.zero(), 
					new DensityFunctions.HolderHolder(TLReGenWorldgenNoiseSettings.bootstrapContext.lookup(Registries.DENSITY_FUNCTION).getOrThrow(TechnologicaDensityFunctions.CHALLENGER_DEEP_DEPTH)), 
					DensityFunctions.zero(), 
					DensityFunctions.mul(DensityFunctions.interpolated(DensityFunctions.blendDensity(DensityFunctions.lerp(DensityFunctions.yClampedGradient(0, 12, 0.0D, 1.0D), 2.5D, DensityFunctions.lerp(DensityFunctions.yClampedGradient(114, 128, 1.0D, 0.0D), 0.9375D, new DensityFunctions.HolderHolder(TLReGenWorldgenNoiseSettings.bootstrapContext.lookup(Registries.DENSITY_FUNCTION).getOrThrow(TLNoiseRouterData.BASE_3D_NOISE_NETHER)))))), DensityFunctions.constant(0.64D)).squeeze(), 
					DensityFunctions.zero(), 
					DensityFunctions.zero(), 
					DensityFunctions.zero(), 
					DensityFunctions.zero(), 
					DensityFunctions.zero(), 
					DensityFunctions.shiftedNoise2d(new DensityFunctions.HolderHolder(TLReGenWorldgenNoiseSettings.bootstrapContext.lookup(Registries.DENSITY_FUNCTION).getOrThrow(TLNoiseRouterData.SHIFT_X)), new DensityFunctions.HolderHolder(TLReGenWorldgenNoiseSettings.bootstrapContext.lookup(Registries.DENSITY_FUNCTION).getOrThrow(TLNoiseRouterData.SHIFT_Z)), 0.25D, TLReGenWorldgenNoiseSettings.bootstrapContext.lookup(Registries.NOISE).getOrThrow(Noises.TEMPERATURE)), 
					DensityFunctions.shiftedNoise2d(new DensityFunctions.HolderHolder(TLReGenWorldgenNoiseSettings.bootstrapContext.lookup(Registries.DENSITY_FUNCTION).getOrThrow(TLNoiseRouterData.SHIFT_X)), new DensityFunctions.HolderHolder(TLReGenWorldgenNoiseSettings.bootstrapContext.lookup(Registries.DENSITY_FUNCTION).getOrThrow(TLNoiseRouterData.SHIFT_Z)), 0.25D, TLReGenWorldgenNoiseSettings.bootstrapContext.lookup(Registries.NOISE).getOrThrow(Noises.VEGETATION)), 
					DensityFunctions.zero(), 
					DensityFunctions.zero(), 
					DensityFunctions.zero()), 
			false, 
