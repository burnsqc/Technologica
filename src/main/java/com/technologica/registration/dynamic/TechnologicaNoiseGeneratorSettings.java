...
public final class TechnologicaNoiseGeneratorSettings {
	public static final ResourceKey<NoiseGeneratorSettings> MOON = Technologica.NOISE_GENERATOR_SETTINGS.register("moon", () -> noiseSettings(false, TechnologicaBlocks.MOON_ROCK.get().defaultBlockState(), Blocks.WATER.defaultBlockState(), false, false, noise(384, -64, 1, 2), TLNoiseRouterData.moon(TLReGenWorldgenNoiseSettings.bootstrapContext.lookup(Registries.DENSITY_FUNCTION), TLReGenWorldgenNoiseSettings.bootstrapContext.lookup(Registries.NOISE), true, true), false, -64, List.of(), TLSurfaceRuleData.MOON));
	public static final ResourceKey<NoiseGeneratorSettings> CHALLENGER_DEEP = Technologica.NOISE_GENERATOR_SETTINGS.register("challenger_deep", () -> noiseSettings(false, Blocks.STONE.defaultBlockState(), Blocks.WATER.defaultBlockState(), false, false, noise(256, 0, 1, 2), TLNoiseRouterData.noiseRouter(DensityFunctions.zero(), DensityFunctions.zero(), new DensityFunctions.HolderHolder(TLReGenWorldgenNoiseSettings.bootstrapContext.lookup(Registries.DENSITY_FUNCTION).getOrThrow(TechnologicaDensityFunctions.CHALLENGER_DEEP_DEPTH)), DensityFunctions.zero(), DensityFunctions.mul(DensityFunctions.interpolated(DensityFunctions.blendDensity(DensityFunctions.lerp(DensityFunctions.yClampedGradient(0, 12, 0.0D, 1.0D), 2.5D, DensityFunctions.lerp(DensityFunctions.yClampedGradient(242, 256, 1.0D, 0.0D), 0.9375D, new DensityFunctions.HolderHolder(TLReGenWorldgenNoiseSettings.bootstrapContext.lookup(Registries.DENSITY_FUNCTION).getOrThrow(TLNoiseRouterData.BASE_3D_NOISE_NETHER)))))), DensityFunctions.constant(0.64D)).squeeze(), DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.shiftedNoise2d(new DensityFunctions.HolderHolder(TLReGenWorldgenNoiseSettings.bootstrapContext.lookup(Registries.DENSITY_FUNCTION).getOrThrow(TLNoiseRouterData.SHIFT_X)), new DensityFunctions.HolderHolder(TLReGenWorldgenNoiseSettings.bootstrapContext.lookup(Registries.DENSITY_FUNCTION).getOrThrow(TLNoiseRouterData.SHIFT_Z)), 0.25D, TLReGenWorldgenNoiseSettings.bootstrapContext.lookup(Registries.NOISE).getOrThrow(Noises.TEMPERATURE)), DensityFunctions.shiftedNoise2d(new DensityFunctions.HolderHolder(TLReGenWorldgenNoiseSettings.bootstrapContext.lookup(Registries.DENSITY_FUNCTION).getOrThrow(TLNoiseRouterData.SHIFT_X)), new DensityFunctions.HolderHolder(TLReGenWorldgenNoiseSettings.bootstrapContext.lookup(Registries.DENSITY_FUNCTION).getOrThrow(TLNoiseRouterData.SHIFT_Z)), 0.25D, TLReGenWorldgenNoiseSettings.bootstrapContext.lookup(Registries.NOISE).getOrThrow(Noises.VEGETATION)), DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero()), false, 256, List.of(), TLSurfaceRuleData.CHALLENGER_DEEP));
	public static final ResourceKey<NoiseGeneratorSettings> OVERGROWTH = Technologica.NOISE_GENERATOR_SETTINGS.register("overgrowth", () -> noiseSettings(false, Blocks.DIRT.defaultBlockState(), Blocks.WATER.defaultBlockState(), false, false, noise(128, 0, 1, 2), TLNoiseRouterData.noiseRouter(DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.mul(DensityFunctions.interpolated(DensityFunctions.blendDensity(DensityFunctions.lerp(DensityFunctions.yClampedGradient(0 + -8, 0 + 24, 0.0D, 1.0D), 2.5D, DensityFunctions.lerp(DensityFunctions.yClampedGradient(0 + 128 - 24, 0 + 128 - 0, 1.0D, 0.0D), 0.9375D, new DensityFunctions.HolderHolder(TLReGenWorldgenNoiseSettings.bootstrapContext.lookup(Registries.DENSITY_FUNCTION).getOrThrow(TLNoiseRouterData.BASE_3D_NOISE_NETHER)))))), DensityFunctions.constant(0.64D)).squeeze(), DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.shiftedNoise2d(new DensityFunctions.HolderHolder(TLReGenWorldgenNoiseSettings.bootstrapContext.lookup(Registries.DENSITY_FUNCTION).getOrThrow(TLNoiseRouterData.SHIFT_X)), new DensityFunctions.HolderHolder(TLReGenWorldgenNoiseSettings.bootstrapContext.lookup(Registries.DENSITY_FUNCTION).getOrThrow(TLNoiseRouterData.SHIFT_Z)), 0.25D, TLReGenWorldgenNoiseSettings.bootstrapContext.lookup(Registries.NOISE).getOrThrow(Noises.TEMPERATURE)), DensityFunctions.shiftedNoise2d(new DensityFunctions.HolderHolder(TLReGenWorldgenNoiseSettings.bootstrapContext.lookup(Registries.DENSITY_FUNCTION).getOrThrow(TLNoiseRouterData.SHIFT_X)), new DensityFunctions.HolderHolder(TLReGenWorldgenNoiseSettings.bootstrapContext.lookup(Registries.DENSITY_FUNCTION).getOrThrow(TLNoiseRouterData.SHIFT_Z)), 0.25D, TLReGenWorldgenNoiseSettings.bootstrapContext.lookup(Registries.NOISE).getOrThrow(Noises.VEGETATION)), DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero()), false, 32, List.of(), TLSurfaceRuleData.OVERGROWTH));
	...
	private class TLSurfaceRuleData {
		private static final SurfaceRules.RuleSource BEDROCK_FLOOR = SurfaceRules.ifTrue(verticalGradient(VerticalAnchor.aboveBottom(5), "bedrock_floor", VerticalAnchor.bottom()), SurfaceRules.state(Blocks.BEDROCK.defaultBlockState()));
		private static final SurfaceRules.RuleSource BEDROCK_ROOF = SurfaceRules.ifTrue(SurfaceRules.not(verticalGradient(VerticalAnchor.top(), "bedrock_roof", VerticalAnchor.belowTop(5))), SurfaceRules.state(Blocks.BEDROCK.defaultBlockState()));
		...
		private static final SurfaceRules.RuleSource CHALLENGER_DEEP = SurfaceRules.sequence(BEDROCK_FLOOR, BEDROCK_ROOF, SurfaceRules.ifTrue(SurfaceRules.yBlockCheck(VerticalAnchor.belowTop(5), 0), STONE), SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR, SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.not(SurfaceRules.yBlockCheck(VerticalAnchor.absolute(32), 0)), SurfaceRules.ifTrue(SurfaceRules.hole(), STONE)))), SurfaceRules.ifTrue(SurfaceRules.isBiome(TechnologicaBiomes.SUNKEN_FOREST, TechnologicaBiomes.FORGOTTEN_REEF), SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.UNDER_CEILING, SurfaceRules.sequence(STONE)), SurfaceRules.ifTrue(SurfaceRules.UNDER_FLOOR, SurfaceRules.sequence(STONE)), SAND)), STONE);
