...
public final class TechnologicaStructures {
	public static final ResourceKey<Structure> EL_DORADO = Technologica.STRUCTURES.register("el_dorado", () -> new ElDoradoStructure(new Structure.StructureSettings(HolderSet.direct(Technologica.STRUCTURES.bootstrapContext.lookup(Registries.BIOME).getOrThrow(TechnologicaBiomes.MISTY_MIRE)), Map.of(), GenerationStep.Decoration.UNDERGROUND_DECORATION, TerrainAdjustment.NONE)));
	public static final ResourceKey<Structure> DOME = Technologica.STRUCTURES.register("dome", () -> new JigsawStructure(new Structure.StructureSettings(Technologica.STRUCTURES.bootstrapContext.lookup(Registries.BIOME).getOrThrow(TechnologicaBiomeTags.HAS_DOME), Map.of(), GenerationStep.Decoration.SURFACE_STRUCTURES, TerrainAdjustment.BEARD_THIN), Technologica.STRUCTURES.bootstrapContext.lookup(Registries.TEMPLATE_POOL).getOrThrow(TechnologicaStructureTemplatePools.DOME), 6, ConstantHeight.of(VerticalAnchor.absolute(0)), false, Heightmap.Types.WORLD_SURFACE_WG));
	public static final ResourceKey<Structure> WHALE_CARCASS = Technologica.STRUCTURES.register("whale_carcass", () -> new DeepSeaStructure(new Structure.StructureSettings(Technologica.STRUCTURES.bootstrapContext.lookup(Registries.BIOME).getOrThrow(TechnologicaBiomeTags.HAS_WHALE_CARCASS), Map.of(), GenerationStep.Decoration.SURFACE_STRUCTURES, TerrainAdjustment.NONE), UniformHeight.of(VerticalAnchor.absolute(6), VerticalAnchor.absolute(32))));
}
