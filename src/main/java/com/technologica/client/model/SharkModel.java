...
public class SharkModel<T extends Entity> extends ListModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = root.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(-7.0F, -6.0F, -10.0F, 14.0F, 12.0F, 20.0F), PartPose.offset(0.0F, 18.0F, 0.0F));
		PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 32).addBox(-6.0F, -5.01F, -8.0F, 12.0F, 5.98F, 8.0F).texOffs(32, 32).addBox(-6.0F, 1.0F, -4.0F, 12.0F, 3.0F, 4.0F).texOffs(68, 37).addBox(-5.5F, 1.0F, -8.0F, 11.0F, 1.0F, 4.0F), PartPose.offset(0.0F, 0.0F, -10.0F));
		...
		PartDefinition jaw = head.addOrReplaceChild("jaw", CubeListBuilder.create().texOffs(40, 40).addBox(-6.0F, 0.01F, -4.0F, 12.0F, 1.98F, 4.0F).texOffs(64, 32).addBox(-5.5F, -1.0F, -4.0F, 11.0F, 1.0F, 4.0F), PartPose.offset(0.0F, 2.0F, -4.0F));
		jaw.addOrReplaceChild("jaw2", CubeListBuilder.create().texOffs(44, 46).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 1.0F, 8.0F).texOffs(96, 19).addBox(-3.5F, -1.0F, -3.5F, 7.0F, 1.0F, 7.0F), PartPose.offsetAndRotation(0.0F, 0.0F, -4.0F, 0, ((float) Math.PI / 4F), 0));
