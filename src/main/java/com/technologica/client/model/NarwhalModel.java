...
public class NarwhalModel<T extends Entity> extends ListModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		head.addOrReplaceChild("spear", CubeListBuilder.create().texOffs(28, 12).addBox(-0.5F, 0.0F, -16.0F, 1.0F, 1.0F, 16.0F), PartPose.offset(0.0F, -1.0F, -6.0F));
		body.addOrReplaceChild("flipper_left", CubeListBuilder.create().texOffs(0, 22).mirror().addBox(0.0F, 0.0F, 0.0F, 8.0F, 1.0F, 4.0F), PartPose.offset(4.0F, 2.0F, -4.0F));
		body.addOrReplaceChild("flipper_right", CubeListBuilder.create().texOffs(0, 22).addBox(-8.0F, 0.0F, 0.0F, 8.0F, 1.0F, 4.0F), PartPose.offset(-4.0F, 2.0F, -4.0F));
		PartDefinition tail = body.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(0, 27).addBox(-3.0F, -3.0F, 0.0F, 6.0F, 6.0F, 10.0F), PartPose.offset(0.0F, 0.0F, 7.0F));
		tail.addOrReplaceChild("tail_fin", CubeListBuilder.create().texOffs(0, 43).addBox(-8.0F, 0.0F, 0.0F, 	16.0F, 1.0F, 6.0F), PartPose.offset(0.0F, 0.0F, 8.0F));
