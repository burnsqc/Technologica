...
public class LizardModel<T extends Lizard> extends QuadrupedModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		root.addOrReplaceChild("head", CubeListBuilder.create().texOffs(14, 0).addBox(-1.5F, -1.0F, -1.5F, 3.0F, 2.0F, 3.0F), PartPose.offset(0.0F, 20.0F, -3.0F));
		body.addOrReplaceChild("frill_left", CubeListBuilder.create().texOffs(0, 9).mirror().addBox(0.0F, -4.0F, 0.0F, 4.0F, 4.0F, 1.0F), PartPose.offset(0.0F, -1.0F, -3.5F));
		body.addOrReplaceChild("frill_right", CubeListBuilder.create().texOffs(0, 9).addBox(-4.0F, -4.0F, 0.0F, 4.0F, 4.0F, 1.0F), PartPose.offset(0.0F, -1.0F, -3.5F));
		root.addOrReplaceChild("right_hind_leg", CubeListBuilder.create().texOffs(20, 5).addBox(0.0F, 0.0F, 0.0F, 2.0F, 3.0F, 2.0F), PartPose.offset(1.0F, 21.0F, 0.0F));
