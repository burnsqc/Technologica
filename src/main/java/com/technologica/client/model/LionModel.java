...
public class LionModel<T extends Lion> extends QuadrupedModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -5.0F, -10.0F, 10.0F, 10.0F, 20.0F).texOffs(0, 30).addBox(-6.0F, -7.0F, -12.0F, 12.0F, 12.0F, 3.0F).texOffs(28, 30).addBox(-6.5F, -8.0F, -11.0F, 13.0F, 14.0F, 4.0F).texOffs(0, 30).addBox(-6.0F, -6.0F, -9.0F, 12.0F, 12.0F, 4.0F), PartPose.offset(0.0F, 11.0F, 0.0F));
