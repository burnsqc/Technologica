...
public class BeaverModel<T extends Beaver> extends QuadrupedModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 14).addBox(-2.0F, -4.0F, -4.0F, 4.0F, 4.0F, 4.0F).texOffs(20, 0).addBox("left_tooth", 0.0F, -1.0F, -4.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.1F, 0.0F, -0.4F)).texOffs(20, 0).addBox("right_tooth", -1.0F, -1.0F, -4.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.1F, 0.0F, -0.4F)), PartPose.offset(0.0F, 21.0F, -4.0F));
		...
		partdefinition.addOrReplaceChild("left_hind_leg", CubeListBuilder.create().texOffs(20, 3).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.1F, 0.0F, -0.1F)).texOffs(12, 14).addBox("left_hind_foot", -1.5F, 1.0F, -3.0F, 3.0F, 1.0F, 3.0F), PartPose.offset(2.0F, 22.0F, 4.0F));
		partdefinition.addOrReplaceChild("right_hind_leg", CubeListBuilder.create().texOffs(20, 3).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.1F, 0.0F, -0.1F)).texOffs(12, 14).addBox("right_hind_foot", -1.5F, 1.0F, -3.0F, 3.0F, 1.0F, 3.0F), PartPose.offset(-2.0F, 22.0F, 4.0F));
