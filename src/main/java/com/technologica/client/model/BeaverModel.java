...
public class BeaverModel<T extends Beaver> extends QuadrupedModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		partdefinition.addOrReplaceChild("left_hind_leg", CubeListBuilder.create().texOffs(20, 0).addBox(-1.0F, -1.0F, -2.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.1F, 0.0F, -0.1F)).texOffs(16, 14).addBox("left_hind_foot", -1.5F, 1.0F, -4.0F, 3.0F, 1.0F, 4.0F), PartPose.offset(2.0F, 22.0F, 4.0F));
		partdefinition.addOrReplaceChild("right_hind_leg", CubeListBuilder.create().texOffs(20, 0).addBox(-1.0F, -1.0F, -2.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.1F, 0.0F, -0.1F)).texOffs(16, 14).addBox("right_hind_foot", -1.5F, 1.0F, -4.0F, 3.0F, 1.0F, 4.0F), PartPose.offset(-2.0F, 22.0F, 4.0F));
