...
public class ScorpionModel<T extends Entity> extends ListModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		partdefinition.addOrReplaceChild("leg1", CubeListBuilder.create().texOffs(0, 32).addBox(-15.0F, -1.0F, -1.0F, 16.0F, 2.0F, 2.0F), PartPose.offset(-4.0F, 15.0F, 2.0F));
		partdefinition.addOrReplaceChild("leg2", CubeListBuilder.create().texOffs(0, 32).addBox(-1.0F, -1.0F, -1.0F, 16.0F, 2.0F, 2.0F), PartPose.offset(4.0F, 15.0F, 2.0F));
		partdefinition.addOrReplaceChild("leg3", CubeListBuilder.create().texOffs(0, 32).addBox(-15.0F, -1.0F, -1.0F, 16.0F, 2.0F, 2.0F), PartPose.offset(-4.0F, 15.0F, 1.0F));
		partdefinition.addOrReplaceChild("leg4", CubeListBuilder.create().texOffs(0, 32).addBox(-1.0F, -1.0F, -1.0F, 16.0F, 2.0F, 2.0F), PartPose.offset(4.0F, 15.0F, 1.0F));
		partdefinition.addOrReplaceChild("leg5", CubeListBuilder.create().texOffs(0, 32).addBox(-15.0F, -1.0F, -1.0F, 16.0F, 2.0F, 2.0F), PartPose.offset(-4.0F, 15.0F, 0.0F));
		partdefinition.addOrReplaceChild("leg6", CubeListBuilder.create().texOffs(0, 32).addBox(-1.0F, -1.0F, -1.0F, 16.0F, 2.0F, 2.0F), PartPose.offset(4.0F, 15.0F, 0.0F));
		partdefinition.addOrReplaceChild("leg7", CubeListBuilder.create().texOffs(0, 32).addBox(-15.0F, -1.0F, -1.0F, 16.0F, 2.0F, 2.0F), PartPose.offset(-4.0F, 15.0F, -1.0F));
		partdefinition.addOrReplaceChild("leg8", CubeListBuilder.create().texOffs(0, 32).addBox(-1.0F, -1.0F, -1.0F, 16.0F, 2.0F, 2.0F), PartPose.offset(4.0F, 15.0F, -1.0F));
	...
	public void prepareMobModel(T entityIn, float limbSwing, float limbSwingAmount, float partialTick) {
		...
		if (clawsClicking || ((Scorpion) entityIn).isAggressive()) {
			this.pincherLeftOuter.yRot = (float) (0.25F * Math.cos((entityIn.tickCount + partialTick) / 2) * Math.cos((entityIn.tickCount + partialTick) / 2));
			this.pincherRightOuter.yRot = (float) (-0.25F * Math.cos((entityIn.tickCount + partialTick) / 2) * Math.cos((entityIn.tickCount + partialTick) / 2));
		} else {
		...
		if (((Scorpion) entityIn).isAggressive()) {
			this.armLeft.yRot += 0.25F * Math.cos((entityIn.tickCount + partialTick) / 2);
			...
			this.clawRight.yRot -= 0.25F * Math.cos((entityIn.tickCount + partialTick) / 2);
		}
	}
}