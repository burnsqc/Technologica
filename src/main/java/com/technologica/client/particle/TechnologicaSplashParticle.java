...
public class TechnologicaSplashParticle extends WaterDropParticle {
	public TechnologicaSplashParticle(ClientLevel clientLevel, double posX, double posY, double posZ, double speedX, double speedY, double speedZ) {
	...
	public static class BrineProvider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double posX, double posY, double posZ, double speedX, double speedY, double speedZ) {
			TechnologicaSplashParticle splashparticle = new TechnologicaSplashParticle(clientLevel, posX, posY, posZ, speedX, speedY, speedZ);
