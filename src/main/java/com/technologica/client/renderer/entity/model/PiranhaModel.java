...
public class PiranhaModel<T extends Entity> extends AbstractTropicalFishModel<T> {
	...
	public PiranhaModel() {
		...
		this.body.addBox(-1.0F, -2.0F, -3.0F, 2.0F, 4.0F, 6.0F);
		this.body.setRotationPoint(0.0F, 19.0F, 0.0F);
		
		this.tail = new ModelRenderer(this, 21, 16);
		this.tail.addBox(0.0F, -2.0F, 0.0F, 0.0F, 4.0F, 2.0F);
		...
		this.finLeft.setRotationPoint(1.0F, 20.0F, -2.0F);
		
		this.finRight = new ModelRenderer(this, 2, 16);
		this.finRight.addBox(-2.0F, 0.0F, 0.0F, 2.0F, 1.0F, 0.0F);
		this.finRight.setRotationPoint(-1.0F, 20.0F, -2.0F);
		
		this.finTop = new ModelRenderer(this, 20, 11);
		this.finTop.addBox(0.0F, -1.0F, 0.0F, 0.0F, 1.0F, 2.0F);
		this.finTop.setRotationPoint(0.0F, 17.0F, 0.0F);
		
		this.finBottom = new ModelRenderer(this, 20, 21);
		this.finBottom.addBox(0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 2.0F);
		this.finBottom.setRotationPoint(0.0F, 21.0F, 1.0F);
	}
