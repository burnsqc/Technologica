...
public class PenguinModel<T extends AnimalEntity> extends AgeableModel<T> {
	...
	public PenguinModel() {
		...
		this.head.addBox(-2.0F, -11.0F, 2.0F, 4.0F, 4.0F, 4.0F, 0.0F);
		this.head.setRotationPoint(0.0F, 15.0F, -4.0F);
		this.bill = new ModelRenderer(this, 14, 0);
		this.bill.addBox(-2.0F, -9.0F, 0.0F, 4.0F, 1.0F, 3.0F, 0.0F);
		this.bill.setRotationPoint(0.0F, 15.0F, -4.0F);
		this.chin = new ModelRenderer(this, 14, 4);
		this.chin.addBox(-1.0F, -8.0F, 1.0F, 1.0F, 1.0F, 4.0F, 0.0F);
		this.chin.setRotationPoint(0.0F, 15.0F, -4.0F);
		this.body = new ModelRenderer(this, 0, 9);
		this.body.addBox(-3.0F, -8.0F, -3.0F, 6.0F, 14.0F, 6.0F, 0.0F);
		...
		this.rightWing.addBox(0.0F, -3.0F, -1.0F, 1.0F, 8.0F, 3.0F);
		this.rightWing.setRotationPoint(-4.0F, 13.0F, 0.0F);
		this.leftWing = new ModelRenderer(this, 24, 13);
		this.leftWing.addBox(-1.0F, -3.0F, -1.0F, 1.0F, 8.0F, 3.0F);
