...
public class WalrusModel<T extends Entity> extends SegmentedModel<T> {
	...
	public WalrusModel() {
		...
		this.tail2 = new ModelRenderer(this, 0, 35);
		...
		this.flipperFrontLeft = new ModelRenderer(this, 48, 20);
		...
		this.flipperFrontRight = new ModelRenderer(this, 48, 20);
		...
		this.flipperBackLeft = new ModelRenderer(this, 30, 20);
		...
		this.flipperBackRight = new ModelRenderer(this, 13, 17);
