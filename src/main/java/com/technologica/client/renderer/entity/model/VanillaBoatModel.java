...
public class VanillaBoatModel extends SegmentedModel<VanillaBoatEntity> {
    ...
    */
   public void setRotationAngles(VanillaBoatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
   ...
   protected void func_228244_a_(VanillaBoatEntity p_228244_1_, int p_228244_2_, float p_228244_3_) {
