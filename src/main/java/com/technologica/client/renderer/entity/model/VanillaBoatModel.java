...
public class VanillaBoatModel extends SegmentedModel<VanillaBoatEntity> {
    ...
    */
   public void setupAnim(VanillaBoatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
   ...
   protected void animatePaddle(VanillaBoatEntity p_228244_1_, int p_228244_2_, float p_228244_3_) {
