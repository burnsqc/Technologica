...
public class ElephantModel<T extends ElephantEntity> extends QuadrupedModel<T> {
	...
	public ElephantModel() {
		...
		this.headModel.setTextureOffset(22, 0).addBox(-11.0F, 10.0F, -23.0F, 4.0F, 16.0F, 4.0F);
		this.headModel.setTextureOffset(22, 0).addBox(7.0F, 10.0F, -23.0F, 4.0F, 16.0F, 4.0F);
		
		this.trunk1 = new ModelRenderer(this, 0, 0);
		this.trunk1.addBox(-4.0F, 0.0F, -4.0F, 8.0F, 12.0F, 8.0F);
		this.trunk1.setRotationPoint(0.0F, 12.0F, -20.0F);
		this.headModel.addChild(this.trunk1);
		
		this.trunk2 = new ModelRenderer(this, 0, 0);
		this.trunk2.addBox(-4.0F, 0.0F, -4.0F, 8.0F, 12.0F, 8.0F);
		this.trunk2.setRotationPoint(0.0F, 12.0F, 0.0F);
		this.trunk1.addChild(this.trunk2);
		
		this.trunk3 = new ModelRenderer(this, 0, 0);
		this.trunk3.addBox(-4.0F, 0.0F, -4.0F, 8.0F, 12.0F, 8.0F);
		...
		this.earLeft.setRotationPoint(12.0F, -2.0F, -12.0F);
