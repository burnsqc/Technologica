package com.technologica.client.renderer.entity.magic;
...
public final class MagicLightningBoltRenderer extends EntityRenderer<MagicLightningBolt> {
	public MagicLightningBoltRenderer(Context context) {
		super(context);
	}

	@Override
	public void render(MagicLightningBolt lightningBolt, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight) {
	...
	@Override
	public ResourceLocation getTextureLocation(MagicLightningBolt magicLightningBolt) {
