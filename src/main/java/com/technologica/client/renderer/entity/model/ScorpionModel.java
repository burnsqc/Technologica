...
public class ScorpionModel<T extends Entity> extends SegmentedModel<T> {
	...
	public ScorpionModel() {
		...
		scorpionPincherRightOuter.setTextureOffset(19, 20).addBox(3.0F, -0.5F, -2.0F, 4.0F, 1.0F, 1.0F, 0.0F, false);
		...
		scorpionPincherLeftOuter.setTextureOffset(19, 20).addBox(3.0F, -0.5F, 1.0F, 4.0F, 1.0F, 1.0F, 0.0F, false);
