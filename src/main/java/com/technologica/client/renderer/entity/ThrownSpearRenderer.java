...
public class ThrownSpearRenderer<T extends AbstractArrow> extends EntityRenderer<T> {
	public static final ResourceLocation HARPOON = new TechnologicaLocation("textures/entity/projectiles/harpoon.png");

	public ThrownSpearRenderer(EntityRendererProvider.Context renderManagerIn) {
