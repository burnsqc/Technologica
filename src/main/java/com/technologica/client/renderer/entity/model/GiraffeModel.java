...
public class GiraffeModel<T extends AbstractHorseEntity> extends HorseModel<T> {
	...
	public GiraffeModel(float p_i51065_1_) {
		...
		this.body.addBox(-5.0F, -22.0F, -17.0F, 10.0F, 10.0F, 22.0F, 0.05F);
		this.body.setRotationPoint(0.0F, 11.0F, 5.0F);
		this.head = new ModelRenderer(this, 0, 35);
		this.head.addBox(-2.00F, -48.0F, 5.0F, 4.0F, 40.0F, 6.0F);
		this.head.rotateAngleX = ((float) Math.PI / 6F);
		ModelRenderer modelrenderer = new ModelRenderer(this, 0, 13);
		modelrenderer.addBox(-3.0F, -49.0F, -2.0F, 6.0F, 5.0F, 7.0F, p_i51065_1_);
		ModelRenderer modelrenderer1 = new ModelRenderer(this, 56, 36);
		modelrenderer1.addBox(-1.0F, -49.0F, 5.01F, 2.0F, 16.0F, 2.0F, p_i51065_1_);
		ModelRenderer modelrenderer2 = new ModelRenderer(this, 0, 25);
		modelrenderer2.addBox(-2.0F, -49.0F, -7.0F, 4.0F, 5.0F, 5.0F, p_i51065_1_);
		...
		this.field_228262_f_.addBox(-3.0F, -15.01F, -1.0F, 4.0F, 25.0F, 4.0F, p_i51065_1_);
		this.field_228262_f_.setRotationPoint(4.0F, 14.0F, 7.0F);
		this.field_228263_g_ = new ModelRenderer(this, 48, 21);
		this.field_228263_g_.addBox(-1.0F, -15.01F, -1.0F, 4.0F, 25.0F, 4.0F, p_i51065_1_);
		...
		this.field_228264_h_.addBox(-3.0F, -15.01F, -1.9F, 4.0F, 25.0F, 4.0F, p_i51065_1_);
		this.field_228264_h_.setRotationPoint(4.0F, 6.0F, -12.0F);
		this.field_228265_i_ = new ModelRenderer(this, 48, 21);
		this.field_228265_i_.addBox(-1.0F, -15.01F, -1.9F, 4.0F, 25.0F, 4.0F, p_i51065_1_);
		...
		this.field_228266_j_.addBox(-3.0F, -15.01F, -1.0F, 4.0F, 25.0F, 4.0F, p_i51065_1_, p_i51065_1_ + 5.5F, p_i51065_1_);
		this.field_228266_j_.setRotationPoint(4.0F, 14.0F, 7.0F);
		this.field_228267_k_ = new ModelRenderer(this, 48, 21);
		this.field_228267_k_.addBox(-1.0F, -15.01F, -1.0F, 4.0F, 25.0F, 4.0F, p_i51065_1_, p_i51065_1_ + 5.5F, p_i51065_1_);
		...
		this.field_228268_l_.addBox(-3.0F, -15.01F, -1.9F, 4.0F, 25.0F, 4.0F, p_i51065_1_, p_i51065_1_ + 5.5F, p_i51065_1_);
		this.field_228268_l_.setRotationPoint(4.0F, 6.0F, -12.0F);
		this.field_228269_m_ = new ModelRenderer(this, 48, 21);
		this.field_228269_m_.addBox(-1.0F, -15.01F, -1.9F, 4.0F, 25.0F, 4.0F, p_i51065_1_, p_i51065_1_ + 5.5F, p_i51065_1_);
	...
	protected Iterable<ModelRenderer> getBodyParts() {
		return ImmutableList.of(this.body, this.field_228262_f_, this.field_228263_g_, this.field_228264_h_,
				this.field_228265_i_, this.field_228266_j_, this.field_228267_k_, this.field_228268_l_,
				this.field_228269_m_);
	}
	...
	public void setLivingAnimations(T entityIn, float limbSwing, float limbSwingAmount, float partialTick) {
		...
		this.head.rotateAngleY = f6 * f3 * ((float) Math.PI / 180F)
