...
public class AnnunciatorScreen extends AbstractContainerScreen<AnnunciatorMenu> {
	...
	public void removed() {
		...
		if (clientplaynethandler != null) {
			Technologica.CHANNEL.sendToServer(new UpdateAnnunciator(this.tileEntity.getBlockPos(), this.multiLineText[0], this.multiLineText[1], this.multiLineText[2], this.multiLineText[3], this.multiLineText[4], this.multiLineText[5], this.multiLineText[6], this.multiLineText[7]));
		}
