...
public abstract class BromineFluid extends FlowingFluid {
	...
	public FluidAttributes createAttributes() {
		return FluidAttributes.builder(new ResourceLocation("block/water_still"), new ResourceLocation("block/water_flow")).color(-5621741).build(TechnologicaFluids.BROMINE.get());
	}
	...
	public IParticleData getDripParticle() {
		return DrippingLiquidParticleData.BROMINE;
	}
	...
	public BlockState createLegacyBlock(FluidState state) {
		return TechnologicaBlocks.BROMINE.get().defaultBlockState().setValue(FlowingFluidBlock.LEVEL, Integer.valueOf(getLegacyLevel(state)));
	}
