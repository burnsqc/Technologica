...
public abstract class HeliumFluid extends FlowingFluid {
	...
	public Fluid getFlowing() {
		return TechnologicaFluids.FLOWING_HELIUM.get();
	}

	@Override
	public Fluid getSource() {
		return TechnologicaFluids.HELIUM.get();
	}

	@Override
	public Item getBucket() {
		return TechnologicaItems.HELIUM_BUCKET.get();
	}
...
//	            worldIn.setBlockState(pos, Blocks.AIR.getDefaultState(), 3);
	...
	public FluidAttributes createAttributes() {
		return FluidAttributes.builder(new ResourceLocation("block/water_still"), new ResourceLocation("block/water_flow")).color(1687570373).build(TechnologicaFluids.HELIUM.get());
	}
	...
	public BlockState createLegacyBlock(FluidState state) {
		return TechnologicaBlocks.HELIUM.get().defaultBlockState().setValue(FlowingFluidBlock.LEVEL, Integer.valueOf(getLegacyLevel(state)));
	}
