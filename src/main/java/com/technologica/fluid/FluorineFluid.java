...
public abstract class FluorineFluid extends FlowingFluid {
	public Fluid getFlowing() {
		return TechnologicaFluids.FLOWING_FLUORINE.get();
	}

	public Fluid getSource() {
		return TechnologicaFluids.FLUORINE.get();
	}

	public Item getBucket() {
		return TechnologicaItems.FLUORINE_BUCKET.get();
	}

	@Override
	public FluidAttributes createAttributes() {
		return FluidAttributes.builder(new ResourceLocation("block/water_still"), new ResourceLocation("block/water_flow")).color(1692264576).build(TechnologicaFluids.FLUORINE.get());
	}
	...
	public BlockState createLegacyBlock(FluidState state) {
		return TechnologicaBlocks.FLUORINE.get().defaultBlockState().setValue(FlowingFluidBlock.LEVEL, Integer.valueOf(getLegacyLevel(state)));
	}

	@Override
	public boolean isSame(Fluid fluidIn) {
		return fluidIn == TechnologicaFluids.FLUORINE.get() || fluidIn == TechnologicaFluids.FLOWING_FLUORINE.get();
	}
	...
	public static class Flowing extends FluorineFluid {
		@Override
	...
	public static class Source extends FluorineFluid {
		public int getAmount(FluidState state) {
			return 8;
		}
