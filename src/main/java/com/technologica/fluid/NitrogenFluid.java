...
public abstract class NitrogenFluid extends FlowingFluid {

	@Override
	public Fluid getFlowing() {
		return TechnologicaFluids.FLOWING_NITROGEN.get();
	}

	@Override
	public Fluid getSource() {
		return TechnologicaFluids.NITROGEN.get();
	}

	@Override
	public Item getBucket() {
		return TechnologicaItems.NITROGEN_BUCKET.get();
	}
...
//	            worldIn.setBlockState(pos, Blocks.AIR.getDefaultState(), 3);
	...
	public FluidAttributes createAttributes() {
		return FluidAttributes.builder(new ResourceLocation("block/water_still"), new ResourceLocation("block/water_flow")).color(1692829175).build(TechnologicaFluids.NITROGEN.get());
	}
	...
	public BlockState createLegacyBlock(FluidState state) {
		return TechnologicaBlocks.NITROGEN.get().defaultBlockState().setValue(FlowingFluidBlock.LEVEL, Integer.valueOf(getLegacyLevel(state)));
	}

	@Override
	public boolean isSame(Fluid fluidIn) {
		return fluidIn == TechnologicaFluids.NITROGEN.get() || fluidIn == TechnologicaFluids.FLOWING_NITROGEN.get();
	}
