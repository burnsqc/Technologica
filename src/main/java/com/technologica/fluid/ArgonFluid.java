...
public abstract class ArgonFluid extends FlowingFluid {
	public Fluid getFlowing() {
		return TechnologicaFluids.FLOWING_ARGON.get();
	}

	public Fluid getSource() {
		return TechnologicaFluids.ARGON.get();
	}

	public Item getBucket() {
		return TechnologicaItems.ARGON_BUCKET.get();
	}

	@Override
	public FluidAttributes createAttributes() {
		return FluidAttributes.builder(new ResourceLocation("block/water_still"), new ResourceLocation("block/water_flow")).color(1692434893).build(TechnologicaFluids.ARGON.get());
	}
	...
	public BlockState createLegacyBlock(FluidState state) {
		return TechnologicaBlocks.ARGON.get().defaultBlockState().setValue(FlowingFluidBlock.LEVEL, Integer.valueOf(getLegacyLevel(state)));
	}

	@Override
	public boolean isSame(Fluid fluidIn) {
		return fluidIn == TechnologicaFluids.ARGON.get() || fluidIn == TechnologicaFluids.FLOWING_ARGON.get();
	}
	...
	public static class Flowing extends ArgonFluid {
		@Override
