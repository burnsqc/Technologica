...
public abstract class BrineFluid extends FlowingFluid {
   public Fluid getFlowingFluid() {
      return FluidRegistration.BRINE_FLOWING.get();
   }

   public Fluid getStillFluid() {
      return FluidRegistration.BRINE_SOURCE.get();
   }
   ...
   public BlockState getBlockState(FluidState state) {
      return Registration.BRINE.get().getDefaultState().with(FlowingFluidBlock.LEVEL, Integer.valueOf(getLevelFromState(state)));
   }

   public boolean isEquivalentTo(Fluid fluidIn) {
      return fluidIn == FluidRegistration.BRINE_SOURCE.get() || fluidIn == FluidRegistration.BRINE_FLOWING.get();
   }
