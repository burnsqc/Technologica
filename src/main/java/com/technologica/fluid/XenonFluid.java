...
public abstract class XenonFluid extends FlowingFluid {
	public Fluid getFlowing() {
		return TechnologicaFluids.FLOWING_XENON.get();
	}

	public Fluid getSource() {
		return TechnologicaFluids.XENON.get();
	}

	public Item getBucket() {
		return TechnologicaItems.XENON_BUCKET.get();
	}

	@Override
	public FluidAttributes createAttributes() {
		return FluidAttributes.builder(new ResourceLocation("block/water_still"), new ResourceLocation("block/water_flow")).color(1683921300).build(TechnologicaFluids.XENON.get());
	}
	...
	public BlockState createLegacyBlock(FluidState state) {
		return TechnologicaBlocks.XENON.get().defaultBlockState().setValue(FlowingFluidBlock.LEVEL, Integer.valueOf(getLegacyLevel(state)));
	}

	@Override
	public boolean isSame(Fluid fluidIn) {
		return fluidIn == TechnologicaFluids.XENON.get() || fluidIn == TechnologicaFluids.FLOWING_XENON.get();
	}
	...
	public static class Flowing extends XenonFluid {
		@Override
	...
	public static class Source extends XenonFluid {
		public int getAmount(FluidState state) {
			return 8;
		}
