...
public abstract class OilFluid extends FlowingFluid {
	...
	public IParticleData getDripParticle() {
		return DrippingLiquidParticleData.OIL;
	}
	...
	public BlockState createLegacyBlock(FluidState state) {
		return TechnologicaBlocks.OIL.get().defaultBlockState().setValue(FlowingFluidBlock.LEVEL, Integer.valueOf(getLegacyLevel(state)));
	}
