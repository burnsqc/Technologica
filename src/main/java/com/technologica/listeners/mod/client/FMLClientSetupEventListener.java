...
public final class FMLClientSetupEventListener {
	...
	public static final void onFMLClientSetupEvent(final FMLClientSetupEvent event) {
		event.enqueueWork(() -> {
			...
			TechnologicaSkullBlockRenderer.SKIN_BY_TYPE.forEach((k, v) -> SkullBlockRenderer.SKIN_BY_TYPE.put(k, v));
		});
	}
	...
	private static void addToMenuScreens() {
		...
		MenuScreens.register(TechnologicaMenuTypes.CARPENTRY_WORKBENCH.get(), CarpentryWorkbenchScreen::new);
