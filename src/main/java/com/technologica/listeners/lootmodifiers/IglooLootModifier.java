...
public class IglooLootModifier extends LootModifier {
	...
	public static final Supplier<Codec<IglooLootModifier>> CODEC = Suppliers.memoize(() -> RecordCodecBuilder.create(inst -> codecStart(inst).apply(inst, IglooLootModifier::new)));

	public IglooLootModifier(LootItemCondition[] conditionsIn) {
		super(conditionsIn);
	}
