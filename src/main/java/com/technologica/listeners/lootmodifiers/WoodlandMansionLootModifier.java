...
public class WoodlandMansionLootModifier extends LootModifier {
	...
	protected WoodlandMansionLootModifier(LootItemCondition[] conditionsIn, Item addition) {
		super(conditionsIn);
	...
	public static class Serializer extends GlobalLootModifierSerializer<WoodlandMansionLootModifier> {
		@Override
		public WoodlandMansionLootModifier read(ResourceLocation name, JsonObject object, LootItemCondition[] conditionsIn) {
			Item addition = ForgeRegistries.ITEMS.getValue(new ResourceLocation(GsonHelper.getAsString(object, "addition")));
			return new WoodlandMansionLootModifier(conditionsIn, addition);
		}

		@Override
		public JsonObject write(WoodlandMansionLootModifier instance) {
