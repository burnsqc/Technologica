...
public class IglooChestLootModifier extends LootModifier {
	...
	public static final Supplier<Codec<IglooChestLootModifier>> CODEC = Suppliers.memoize(() -> RecordCodecBuilder.create(inst -> codecStart(inst).apply(inst, IglooChestLootModifier::new)));

	protected IglooChestLootModifier(LootItemCondition[] conditionsIn) {
		super(conditionsIn);
	}
