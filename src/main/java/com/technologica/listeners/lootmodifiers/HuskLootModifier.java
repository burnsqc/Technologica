...
public class HuskLootModifier extends LootModifier {
	...
	protected HuskLootModifier(LootItemCondition[] conditionsIn, Item addition) {
		super(conditionsIn);
	...
	public static class Serializer extends GlobalLootModifierSerializer<HuskLootModifier> {
		@Override
		public HuskLootModifier read(ResourceLocation name, JsonObject object, LootItemCondition[] conditionsIn) {
			Item addition = ForgeRegistries.ITEMS.getValue(new ResourceLocation(GsonHelper.getAsString(object, "addition")));
			return new HuskLootModifier(conditionsIn, addition);
		}
