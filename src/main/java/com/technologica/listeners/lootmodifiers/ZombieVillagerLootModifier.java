...
public class ZombieVillagerLootModifier extends LootModifier {
	...
	protected ZombieVillagerLootModifier(LootItemCondition[] conditionsIn, Item addition) {
		super(conditionsIn);
	...
	public static class Serializer extends GlobalLootModifierSerializer<ZombieVillagerLootModifier> {
		@Override
		public ZombieVillagerLootModifier read(ResourceLocation name, JsonObject object, LootItemCondition[] conditionsIn) {
			Item addition = ForgeRegistries.ITEMS.getValue(new ResourceLocation(GsonHelper.getAsString(object, "addition")));
			return new ZombieVillagerLootModifier(conditionsIn, addition);
		}

		@Override
		public JsonObject write(ZombieVillagerLootModifier instance) {
