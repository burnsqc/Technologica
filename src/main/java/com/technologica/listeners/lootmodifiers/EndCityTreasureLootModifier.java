...
public class EndCityTreasureLootModifier extends LootModifier {
	...
	protected EndCityTreasureLootModifier(LootItemCondition[] conditionsIn, Item addition) {
		super(conditionsIn);
	...
	public static class Serializer extends GlobalLootModifierSerializer<EndCityTreasureLootModifier> {
		@Override
		public EndCityTreasureLootModifier read(ResourceLocation name, JsonObject object, LootItemCondition[] conditionsIn) {
			Item addition = ForgeRegistries.ITEMS.getValue(new ResourceLocation(GsonHelper.getAsString(object, "addition")));
			return new EndCityTreasureLootModifier(conditionsIn, addition);
		}

		@Override
		public JsonObject write(EndCityTreasureLootModifier instance) {
