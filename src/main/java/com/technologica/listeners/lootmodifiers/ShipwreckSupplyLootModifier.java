...
public class ShipwreckSupplyLootModifier extends LootModifier {
	...
	protected ShipwreckSupplyLootModifier(LootItemCondition[] conditionsIn, Item addition) {
		super(conditionsIn);
	...
	public static class Serializer extends GlobalLootModifierSerializer<ShipwreckSupplyLootModifier> {
		@Override
		public ShipwreckSupplyLootModifier read(ResourceLocation name, JsonObject object, LootItemCondition[] conditionsIn) {
			Item addition = ForgeRegistries.ITEMS.getValue(new ResourceLocation(GsonHelper.getAsString(object, "addition")));
			return new ShipwreckSupplyLootModifier(conditionsIn, addition);
		}

		@Override
		public JsonObject write(ShipwreckSupplyLootModifier instance) {
