...
public class UnderwaterRuinBigLootModifier extends LootModifier {
	...
	protected UnderwaterRuinBigLootModifier(LootItemCondition[] conditionsIn, Item addition) {
		super(conditionsIn);
	...
	public static class Serializer extends GlobalLootModifierSerializer<UnderwaterRuinBigLootModifier> {
		@Override
		public UnderwaterRuinBigLootModifier read(ResourceLocation name, JsonObject object, LootItemCondition[] conditionsIn) {
			Item addition = ForgeRegistries.ITEMS.getValue(new ResourceLocation(GsonHelper.getAsString(object, "addition")));
			return new UnderwaterRuinBigLootModifier(conditionsIn, addition);
		}

		@Override
		public JsonObject write(UnderwaterRuinBigLootModifier instance) {
