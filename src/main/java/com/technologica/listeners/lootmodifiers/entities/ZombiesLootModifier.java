...
public class ZombiesLootModifier extends LootModifier {
	...
	public static final Supplier<Codec<ZombiesLootModifier>> CODEC = Suppliers.memoize(() -> RecordCodecBuilder.create(inst -> codecStart(inst).apply(inst, ZombiesLootModifier::new)));

	public ZombiesLootModifier(LootItemCondition[] conditionsIn) {
		super(conditionsIn);
	}
